package Combat
{
   ...
   public class ActionsManager
   {
      ...
      public var specialclass_icon:MovieClip;
      ...
      {
         this.character_talent_skills_info = [];
         this.character_senjutsu_skills_info = [];
         this.loadeds = [];
         this.outfits = [];
         this.skill_icons = [];
         this.talent_icons = [];
      ...
      public function onChargeUsed(param1:MouseEvent = null, param2:Boolean = false, param3:Boolean = false) : *
      {
         ...
         if(_loc4_ && !this.beginActionSubmission())
         {
            return;
         }
         this.setActionBarVisible(false);
      ...
      public function getSenjutsuSkillAndLoad() : *
      {
         ...
         while(_loc6_ < _loc2_.length)
         {
            if(_loc2_[_loc6_] != null)
            {
               ...
               if((_loc8_ = SenjutsuSkillLevel.getSenjutsuSkillLevels(_loc7_[0],this.player_model.character_manager.getSenjutsuLevel(_loc7_[0]))) && _loc8_.cooldown == 0)
               {
                  _loc4_.push({
                     "item_id":_loc7_[0],
                     "item_level":_loc7_[1]
      ...
      public function canUseExceptionalSkill(param1:Object) : Boolean
      {
         ...
         if(this.player_team == "player" && this.player_number == 0)
         {
            ...
            else if(param1.character_manager.hasTalentSkill("skill_1059") && this.can_use_talent_skill)
            {
               _loc2_ = true;
            }
            else
      ...
      private function onKeyDown(param1:KeyboardEvent) : void
      {
         ...
         if(_loc2_ == 57)
         {
            if(this.action_bar && (this.action_bar["btn_senjutsu"].visible || this.action_bar["btn_ninjutsu"].visible))
            {
         ...
         var _loc4_:Boolean;
         if(_loc4_ = this.action_bar && this.action_bar["skill_0"] && this.action_bar["skill_0"].visible == false)
         {
         ...
         var _loc6_:*;
         var _loc7_:Boolean = (_loc6_ = this.player_model.effects_manager).hadEffect("restriction") || _loc6_.hadEffect("pet_restriction");
         var _loc8_:Boolean = _loc6_.hadEffect("ecstasy") || _loc6_.hadEffect("pet_ecstasy");
         ...
         if(_loc6_.hadEffect("chaos") || _loc6_.hadEffect("pet_chaos"))
         {
            BattleManager.showMessage("Cannot use any skill while under Chaos!");
            return;
         }
         var _loc9_:Boolean;
         if(_loc9_ = _loc6_.hadEffect("stun") || _loc6_.hadEffect("pet_stun") || _loc6_.hadEffect("locked") || _loc6_.hadEffect("pet_frozen") || _loc6_.hadEffect("sleep") || _loc6_.hadEffect("pet_sleep") || _loc6_.hadEffect("petrify") || _loc6_.hadEffect("toxic_tooth") || _loc6_.hadEffect("fear"))
         {
      ...
      private function toggleActionBarItem(param1:String, param2:Boolean, param3:Function = null) : void
      {
         ...
         var _loc5_:*;
         if((_loc5_ = this.action_bar[param1]) is MovieClip)
         {
      ...
      public function onSkillSWFLoaded(param1:Event) : *
      {
         ...
         var _loc4_:Object;
         (_loc4_ = SkillLibrary.getCopy(this.loading_skill_id)).skill_id = this.loading_skill_id;
      ...
      public function onClassSkillSWFLoaded(param1:Event) : *
      {
         ...
         if(param1.target.content[this.class_skill_id])
         {
            ...
            (_loc5_ = param1.target.content[this.class_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function onTalentSkillSWFLoaded(param1:Event) : *
      {
         ...
         (_loc6_ = TalentSkillLevel.getTalentSkillLevels(this.loading_skill_id,this.player_model.character_manager.getTalentLevel(this.loading_skill_id))).skill_id = this.loading_skill_id;
         if(param1.target.content[this.loading_skill_id])
         {
            (_loc13_ = param1.target.content[this.loading_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function onSenjutsuSkillSWFLoaded(param1:Event) : *
      {
         ...
         (_loc4_ = SenjutsuSkillLevel.getSenjutsuSkillLevels(this.loading_skill_id,this.player_model.character_manager.getSenjutsuLevel(this.loading_skill_id))).skill_id = this.loading_skill_id;
         _loc11_ = _loc4_.cooldown == 0;
         if(param1.target.content[this.loading_skill_id] && !_loc11_)
         {
            (_loc9_ = param1.target.content[this.loading_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function onUseClassSkill(param1:*) : *
      {
         ...
         if(this.player_model.IS_CHAOS && !_loc2_ && this.class_skill_id != "skill_4001")
         {
            this.handleChaos();
            return false;
         }
      ...
      public function onUseSkill(param1:*, param2:Boolean = false) : Boolean
      {
         ...
         if(param1 is MouseEvent)
         {
            ...
            _loc3_ = param1.currentTarget.name.replace("skill_","");
         }
         else
         {
            _loc3_ = param1;
         ...
         var _loc7_:Boolean = this.player_model.health_manager.hasEnoughCPForSkill(_loc4_.skill_info);
         if(_loc6_)
         {
            if(_loc7_)
            {
      ...
      {
         if(param1.isOutfitFilled() || Character.is_stickman)
         {
            return;
         }
      ...
      public function useTalentSkill(param1:*, param2:Boolean = false) : *
      {
         ...
         var _loc5_:SkillHandler;
         if((_loc6_ = (_loc5_ = _loc4_).skill_info.skill_id) == "skill_1029" && this.player_number > 0)
         {
            if(_loc3_)
            {
         ...
         if((_loc8_ = this.player_team == "player" ? Boolean(Boolean(BattleVars.CHARACTER_REVIVED[this.player_number])) : Boolean(Boolean(BattleVars.ENEMY_REVIVED[this.player_number]))) && _loc7_ >= 18 && _loc7_ <= 23)
         {
            if(_loc3_)
            {
         ...
         var _loc9_:Boolean = this.player_team == "player" ? Boolean(Boolean(BattleVars.CHARACTER_TEAM_REVIVED[this.player_number])) : Boolean(Boolean(BattleVars.ENEMY_TEAM_REVIVED[this.player_number]));
         var _loc10_:Boolean = this.isOneOrMoreTeammateDead();
         if((_loc11_ = this.player_team == "player" ? int(int(BattleManager.getBattle().character_team_players.length)) : int(int(BattleManager.getBattle().enemy_team_players.length))) == 1 && _loc7_ == 29)
         {
            if(_loc3_)
            {
      ...
      public function useSenjutsuSkill(param1:* = null, param2:* = null) : *
      {
         ...
         if(!(_loc5_ = Boolean(this.player_model.effects_manager.canPlayerUseSkill(this.player_team,this.player_number,_loc7_,param1))))
         {
            return false;
         }
      ...
      public function playTheTalentSkill(param1:*) : *
      {
         ...
         var _loc7_:*;
         (_loc7_ = TalentSkillLevel.getCopy(_loc6_,this.player_model.character_manager.getTalentLevel(_loc6_))).talent_skill_cp_cost = Math.round(_loc7_.talent_skill_cp_cost * this.player_model.character_manager.getLevel());
      ...
      public function setCooldown(param1:int, param2:String) : *
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            if((_loc6_ = SkillLibrary.getSkillInfo(_loc4_[_loc5_].skill_info.skill_id)).skill_id == param2)
            {
               _loc4_[_loc5_].setCurrentCooldown(int(_loc4_[_loc5_].getCurrentCooldown()) + param1);
            }
            _loc5_++;
      ...
      function removeEmptyIndices(param1:Array) : Array
      {
         var _loc3_:* = undefined;
         var _loc2_:Array = [];
         ...
         while(_loc7_ < _loc6_.length)
         {
            if(_loc6_[_loc7_] != null)
            {
               ...
               else
               {
                  ...
                  _loc5_ = Boolean(this.player_model.effects_manager.hadEffect("snake_mark")) && int(_loc4_.skill_type) == 9 || int(_loc4_.skill_type == 11) || _loc5_;
      ...
      public function updateTalentSkillsCooldownDisplay(param1:int = 1) : *
      {
         ...
         while(_loc2_ < this.character_talent_skills_info.length)
         {
            ...
            (_loc6_ = this.character_talent_skills_mc[_loc3_]).setCurrentCooldown(Math.max(0,int(this.character_talent_skills_mc[_loc3_].getCurrentCooldown()) - param1));
