package Combat
{
   ...
   public class BattleVars
   {
      ...
      public static function calculateDodge(param1:Object, param2:Object) : void
      {
         ...
         var _loc4_:int;
         var _loc5_:int = (_loc4_ = int(param1.getDodgeRate())) - _loc3_;
      ...
      public static function getCalculateDodge(param1:Object, param2:Object, param3:String) : Boolean
      {
         ...
         var _loc6_:int = param3 == "skill_3104" ? int(int(param2.effects_manager.getIgnoreDodgeBySenjutsu())) : 0;
         var _loc7_:int = SkillLibrary.getExtremeHitChance(param3);
         if(param3 == "skill_634")
         {
            if((_loc10_ = param2.effects_manager.dataBuff.length) > 0)
            {
               _loc4_ += _loc10_ * 20;
            }
         }
         ...
         var _loc8_:int = (_loc5_ -= _loc7_) - _loc4_;
