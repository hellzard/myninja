   ...
   public class Effects
   {
      ...
      public static function buffOverlay(param1:int = 0) : void
      {
         ...
         if(Effects.buff_overlay.length > 0)
         {
            ...
            _loc3_ = _loc2_.mc;
            _loc4_ = Effects.buff_overlay.length;
            if(_loc3_ == null)
            {
            ...
            if((_loc5_ = BattleManager.getBattle()) == null)
            {
      ...
      public static function showEffectAdded(param1:String, param2:int, param3:Object) : void
      {
         ...
         var holderMC:* = battle.getObjectHolder(team,num);
         if(holderMC == null)
         {
            return;
         }
         ...
         if(effects.hasOwnProperty("show_added_duration") && effects.show_added_duration && effects.hasOwnProperty("duration") && int(effects.duration) > 0)
         {
            effectName += " " + int(effects.duration);
         }
         var effectType:String = !!effects.hasOwnProperty("type") ? String(effects.type) : "Buff";
      ...
      public static function displayEffect(param1:Object, param2:Object) : void
      {
         ...
         var team:String = model.effects_manager.user_team;
         var num:int = model.effects_manager.user_number;
         ...
         var effectType:String = !!effects.hasOwnProperty("type") ? String(effects.type) : "";
         var battle:* = BattleManager.getBattle();
         if(battle == null)
         {
            return;
