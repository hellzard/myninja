   ...
   public class HealthManager
   {
      ...
      public function chargePlayer(param1:int = 25, param2:String = "Charge") : void
      {
         ...
         if(param2 == "Charge")
         {
            ...
            _loc4_ = (_loc4_ = (_loc4_ = (_loc4_ += _loc7_.getIncreaseChargeCPByTalent()) + _loc7_.getIncreaseChargeCPByEquippedSet()) + _loc7_.getIncreaseChargeCPByEffect()) - _loc7_.getDecreaseChargeCPByEffect();
      ...
      public function getSkillCpCost(param1:*) : void
      {
         ...
         var _loc4_:int;
         var _loc5_:int = _loc4_ = "skill_cp_cost" in param1 ? int(int(param1.skill_cp_cost)) : int(int(param1.talent_skill_cp_cost));
         ...
         var _loc9_:int;
         if((_loc9_ = _loc3_.getCpReductionBySenjutsu()) > 0)
         {
      ...
      public function getSkillCpAmount(param1:*, param2:Boolean = false) : int
      {
         ...
         var _loc5_:int;
         var _loc6_:int = _loc5_ = "skill_cp_cost" in param1 ? int(int(param1.skill_cp_cost)) : int(int(param1.talent_skill_cp_cost));
         ...
         var _loc10_:int;
         if((_loc10_ = _loc4_.getCpReductionBySenjutsu()) > 0)
         {
      ...
      public function getSkillSpAmount(param1:*, param2:Boolean = false) : int
      {
         ...
         if(_loc3_.effects_manager.hadEffect("sage_mode") || _loc3_.effects_manager.hadEffect("boundless"))
         {
            _loc4_ = 0;
         }
         if(_loc4_ < 0)
      ...
      public function checkReviveEOM() : Boolean
      {
         ...
         if(this.getCurrentHP() <= 0)
         {
            ...
            _loc4_ = !!_loc2_ ? Boolean(Boolean(BattleVars.CHARACTER_REVIVED[this.player_number])) : Boolean(Boolean(BattleVars.ENEMY_REVIVED[this.player_number]));
            if("effects" in _loc3_)
            {
               if(!_loc4_)
               {
      ...
      public function addHealth(param1:int, param2:String = "HP +") : void
      {
         ...
         var characterModel:* = this.getMovieClipHolder().charMc.character_model;
         if(amount < 0)
         {
            amount = ~amount + 1;
         }
         var effects:Array = ["internal_injury","pet_internal_injury","hanyaoni","suffocate","unyielding"];
         ...
         if(amount > 0 && !this.is_reversing_heal && action != "Revived HP +" && characterModel.effects_manager.hadEffect("reverse_healing"))
         {
         ...
         var displayText:String = action + amount.toString() + " HP";
      ...
      {
         var _loc3_:* = this.getMovieClipHolder().charMc.character_model;
         if(_loc3_.effects_manager.hadEffect("domain_expansion") || _loc3_.effects_manager.hadEffect("meridian_injury"))
         {
            return;
         }
         if(param1 < 0)
      ...
      {
         var _loc2_:Boolean = param1.effects_manager && param1.effects_manager.hadEffect("disable_passive_talent");
         var _loc3_:Object = null;
         if(_loc2_)
         {
      ...
      public function reduceHealth(param1:int, param2:String = "-") : void
      {
         ...
         if(param2 == "-")
         {
            ...
            {
               _loc6_ = _loc3_.effects_manager.calculateKnowledgeOfTime(param1);
         ...
         else if(Character.is_thanksgiving_event && _loc3_.player_identification == "ene_2074")
         {
            _loc7_ = BattleManager.getBattle()["enemyMc_1"].charMc.character_model;
            _loc8_ = BattleManager.getBattle()["enemyMc_2"].charMc.character_model;
            if(!_loc7_.isDead() || !_loc8_.isDead())
      ...
      public function reduceCP(param1:int, param2:String = "CP -") : void
      {
         ...
         var _loc5_:Object;
         var _loc4_:Object;
         var _loc6_:int = (_loc5_ = (_loc4_ = this.getMovieClipHolder().charMc.character_model).effects_manager).getUseChanceToUseSkillWithoutCP();
         ...
         this.no_cp_cost = param2 == "skill" && _loc5_.noCPCostFromTalent();
         param1 = !!this.no_cp_cost ? 0 : int(param1);
         if(param2 == "")
         {
            this.updateHealthBar();
            return;
      ...
      private function updateHpBarWithMaxHpLoss(param1:*) : void
      {
         ...
         var _loc2_:int = this.visual_original_max_hp > 0 ? int(this.visual_original_max_hp) : int(this.original_max_hp);
         var _loc3_:int = _loc2_ > this.max_hp ? int(_loc2_) : int(this.max_hp);
         if(_loc3_ <= 0)
         {
      ...
      {
         var _loc4_:Number = this.max_hp < param3 ? Number((param3 - this.max_hp) / param3) : Number(0);
