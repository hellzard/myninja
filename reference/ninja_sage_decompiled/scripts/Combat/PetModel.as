package Combat
{
   ...
   public class PetModel extends PetModelBase
   {
      ...
      public function targetIsSleeping() : *
      {
         ...
         try
         {
            target = this.pet_team == "player" ? int(BattleVars.PLAYER_TARGET) : int(BattleVars.ENEMY_TARGET);
      ...
      public function getAttack(param1:Boolean = true, param2:int = 0) : *
      {
         ...
         var _loc8_:Boolean;
         if(_loc8_ = !this.pet_info.hasOwnProperty("pet_ai") || Boolean(this.pet_info.pet_ai))
         {
         ...
         var _loc10_:*;
         if((_loc10_ = int(_loc9_.index)) < 0 || _loc10_ >= this.pet_info.attacks.length)
         {
            _loc10_ = 0;
         }
         ...
         var _loc21_:Boolean = "is_self_skill" in _loc11_ ? Boolean(Boolean(_loc11_.is_self_skill)) : false;
         var _loc22_:Boolean = "multi_hit" in _loc11_ ? Boolean(Boolean(_loc11_.multi_hit)) : false;
         if(_loc17_ && !_loc21_)
         {
      ...
      {
         return Number(Number(this.pet_info.pet_agility));
      }
      ...
      override public function destroy() : *
      {
         ...
         if(_loc1_ && this.pet_movieclip_holder + this.pet_number in _loc1_)
         {
            _loc2_ = _loc1_[this.pet_movieclip_holder + this.pet_number];
            if(this.object_mc != null && _loc2_.charMc.contains(this.object_mc))
            {
