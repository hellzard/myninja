   ...
   public class PreviewManager
   {
      ...
      private function setFrameScript() : void
      {
         ...
         if(this.preview_type == "skill")
         {
            ...
            {
               var createBunshinFrameScript:Function = function(param1:String):Function
               {
            ...
            {
               var createFrameScript:Function = function(param1:String, param2:String):Function
               {
      ...
      public function addFullScreen() : void
      {
         ...
         if(this.preview_type == "skill")
         {
            _loc1_ = this.preview_info.anims.hasOwnProperty("fullscreen") && "scale" in this.preview_info.anims.fullscreen ? int(this.preview_info.anims.fullscreen.scale) : 2;
         }
         else
         {
            _loc2_ = this.preview_mc.currentLabel;
            _loc3_ = int(_loc2_.replace("attack_","")) >= 10 ? int(int(_loc2_.replace("attack_",""))) : int(int(_loc2_.replace("attack_0","")));
            _loc4_ = int(_loc3_) - 1;
            _loc1_ = this.preview_info.attacks[_loc4_].anims.hasOwnProperty("fullscreen") && "scale" in this.preview_info.attacks[_loc4_].anims.fullscreen ? int(this.preview_info.attacks[_loc4_].anims.fullscreen.scale) : 2;
         }
