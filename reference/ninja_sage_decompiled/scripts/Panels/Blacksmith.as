package Panels
{
   ...
   public dynamic class Blacksmith extends MovieClip
   {
      ...
      var character_weapons_amount:Array;
      ...
      function getMaterial(param1:String) : *
      {
      ...
      function loadItems(param1:*, param2:*) : void
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:*;
         if((_loc8_ = int(this.itList.length / param2)) >= 3)
         {
            _loc8_ = 3;
         }
         else
         ...
         while(_loc7_ < 3)
         {
            ...
            if((_loc5_ = BlacksmithData.getForgeItems(_loc4_))["item_materials"] == null)
            {
      ...
      function getWeaponRequired(param1:String) : *
      {
         var _loc2_:* = undefined;
         var _loc3_:Array = [];
      ...
      function tooltipOnHover(param1:MouseEvent) : void
      {
