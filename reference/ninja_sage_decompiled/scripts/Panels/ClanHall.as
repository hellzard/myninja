package Panels
{
   ...
   public class ClanHall extends MovieClip
   {
      ...
      var historyScrollPane:HistoryScrollPane;
      ...
      public function displayMembers() : *
      {
         ...
         while(_loc2_ < 12)
         {
            ...
            if(this.members.length > _loc1_)
            {
               ...
               if(this.members[_loc1_].char_id == Character.char_id && this.membersMC["member_" + _loc2_].hasEventListener(MouseEvent.CLICK))
               {
      ...
      function getClanStatusReq(param1:MouseEvent) : *
      {
         this.main.loading(true);
      ...
      function closeOnigiri(param1:MouseEvent) : void
      {
         this.sendOnigiriMC.visible = false;
      }
