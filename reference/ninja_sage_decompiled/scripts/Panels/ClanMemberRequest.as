package Panels
{
   ...
   public class ClanMemberRequest extends MovieClip
   {
      ...
      public function searchCallback(param1:*) : *
      {
         ...
         this.main.loading(false);
         if(param1.status > 1 && param1.result)
         {
      ...
      public function addHairColor(param1:*) : *
      {
         ...
         var _loc5_:* = (_loc2_ = this.charSets.hair_color).split("|");
      ...
      function killEverythingInvite() : void
      {
      ...
      function closePanelInvite(param1:MouseEvent) : void
      {
