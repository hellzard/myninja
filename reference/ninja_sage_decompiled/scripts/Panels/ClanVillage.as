package Panels
{
   ...
   public class ClanVillage extends MovieClip
   {
      ...
      function openOnlineList(param1:MouseEvent) : *
      {
         if(this.onlinelist)
         {
      ...
      function openClanReward(param1:MouseEvent) : *
      {
         var _loc2_:* = this.loaderAsset.add("https://ninjasage.id/api/clan/rewards");
         if(_loc2_.isLoaded)
         {
      ...
      function openWallOfFame(param1:MouseEvent) : *
      {
         this.main.loadPanel("Panels.WallOfFame");
      }
      
      function openRepSim(param1:MouseEvent) : *
      {
         navigateToURL(new URLRequest("https://ninjasage.id/en/player/clan/simulator"));
      }
      
      function openClanWarLeaderboard(param1:MouseEvent) : *
      {
         this.main.loadPanel("Panels.ClanWarLeaderboard");
      }
      
      function onClanRewardLoaded(param1:*) : *
      {
         var link:* = undefined;
         var e:* = param1;
