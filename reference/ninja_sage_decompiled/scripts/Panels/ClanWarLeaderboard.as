package Panels
{
   ...
   public dynamic class ClanWarLeaderboard extends MovieClip
   {
      ...
      public function ClanWarLeaderboard(param1:*)
      {
         ...
         var _loc4_:*;
         var _loc5_:* = (_loc4_ = !!Character.web ? "http" : "ws") + "://ws-ldns.ninjasage.id";
      ...
      public function onData(param1:* = null, param2:* = null) : *
      {
         ...
         if(param2 != null && param2.hasOwnProperty("clans"))
         {
            this.respose = param2;
            if(this.oldR == null)
            {
            ...
            while(_loc3_ < param2.clans.length)
            {
               ...
               if((_loc4_ = param2.clans[_loc3_]).hasOwnProperty("reputation"))
               {
