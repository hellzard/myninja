package Panels
{
   ...
   public class NewVillage extends MovieClip
   {
      ...
      public function NewVillage(param1:*)
      {
         System.gc();
         ...
         this.seasonTxt.text = "Season " + Character.clan_season_number;
         this.seasonCrewTxt.text = "Season " + Character.crew_season_number;
         this.seasonSwTxt.text = "Season " + Character.sw_season_number;
      ...
      function openClan(param1:MouseEvent) : *
      {
         LinkMenu.open(LinkMenu.ClanWar);
      }
      
      function openCrew(param1:MouseEvent) : *
      {
      ...
      function huntingLock(param1:MouseEvent) : void
      {
      ...
      function openPopup(param1:MouseEvent) : void
      {
         var _loc2_:String = param1.currentTarget.name.replace("btn_","");
         ...
         this.main.loadPanel("Popups.New_" + _loc2_);
      }
