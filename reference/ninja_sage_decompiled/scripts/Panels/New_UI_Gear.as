package Panels
{
   ...
   public dynamic class New_UI_Gear extends MovieClip
   {
       
      
      public var btn_filter:MovieClip;
      
      public var btn_switch:SimpleButton;
      
      public var gridMC:MovieClip;
      ...
      public var mcFavorite:MovieClip;
      ...
      public var favoriteArray:Array;
      ...
      public var escapeKey:EscapeKeyManager;
      ...
      public var useItemPanel:ItemBuyConfirmation;
      
      public var useItemQuantity:int = 1;
      
      public var useItemMaxQuantity:int = 1;
      ...
      public var itemPerPage:int = 9;
      
      public var gridPerPage:int = 9;
      
      public var listPerPage:int = 7;
      
      public var listType:String = "grid";
      
      public var isDescription:Boolean = false;
      
      public var originalItemAnimation:Boolean;
      
      public function New_UI_Gear(param1:*)
      {
         this.outfits = [];
         this.iconMCArray = [];
         this.itemEquipMC = [];
         ...
         this.selectedSetMC = [];
         this.tempSetArray = [];
         this.tabButton = ["mcWeapon","mcSet","mcBackItem","mcAccessory","mcEssentials","mcMaterials","mcItems","mcHairstyle","mcFavorite"];
         ...
         this.favoriteArray = this.sortItems(Character.character_item_favorites.split(","));
         super();
         this.main = param1;
      ...
      public function initButton() : *
      {
         ...
         this.eventHandler.addListener(this.btn_switch,MouseEvent.CLICK,this.handleSwitchItemMode);
         this.escapeKey.addListener(this.btn_close,this.closePanel);
         this.escapeKey.addListener(this.presetMC,this.closePreset);
         ...
         this.sortMC.clickmask.visible = false;
         ...
         NinjaSage.showDynamicTooltip(this.btn_switch,"Switch to " + (this.listType == "grid" ? "List" : "Grid") + " view");
      }
      
      public function addItemFavorite(param1:MouseEvent) : void
      {
         var _loc2_:String = param1.currentTarget.metaData.id;
         this.main.loading(true);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.qmuUkGOUH6mu",[Character.char_id,Character.sessionkey,_loc2_],this.addFavoriteResponse);
      }
      
      public function removeItemFavorite(param1:MouseEvent) : void
      {
         var _loc2_:String = param1.currentTarget.metaData.id;
         this.main.loading(true);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.mj6LuFKeWbTn",[Character.char_id,Character.sessionkey,_loc2_],this.removeFavoriteResponse);
      }
      
      public function addFavoriteResponse(param1:Object) : void
      {
         this.main.loading(false);
         if(param1.status == 1)
         {
            this.setFavoriteData(param1.data);
            this.main.showMessage("Item added to favorites");
         }
         else
         {
      ...
      public function removeFavoriteResponse(param1:Object) : void
      {
         this.main.loading(false);
         if(param1.status == 1)
         {
            this.setFavoriteData(param1.data);
            this.main.showMessage("Item removed from favorites");
         }
         else
         {
            this.main.showMessage(!!param1.hasOwnProperty("result") ? param1.result : "Unknown Error");
      ...
      public function setFavoriteData(param1:*) : void
      {
         var _loc2_:Array = param1 is Array ? param1 : [];
         Character.character_item_favorites = _loc2_.join(",");
         this.favoriteArray = this.sortItems(_loc2_);
         if(this.tabIndicator == "favorite")
         {
            this.selectedCategory = this.favoriteArray;
         }
      ...
      public function refreshOriginalArray(param1:String) : void
      {
         switch(param1)
         {
            case "weapon":
      ...
      public function getItemTypeFromId(param1:String) : String
      {
      ...
      {
         this.statsMC.txt_agility.text = StatManager.calculate_stats_with_data("agility");
         this.statsMC.txt_crit.text = StatManager.calculate_stats_with_data("critical") + "%";
         this.statsMC.txt_dodge.text = StatManager.calculate_stats_with_data("dodge") + "%";
         this.statsMC.txt_purify.text = StatManager.calculate_stats_with_data("purify") + "%";
         this.statsMC.txt_accuracy.text = StatManager.calculate_stats_with_data("accuracy") + "%";
      }
      ...
      public function handleSwitchItemMode(param1:MouseEvent) : void
      {
         this.sortMC.visible = this.tabIndicator == "essential" || this.tabIndicator == "material" || this.tabIndicator == "consumable" || this.tabIndicator == "hair" || this.tabIndicator == "favorite" ? false : true;
         this.listType = this.listType == "grid" ? "list" : "grid";
         this.itemPerPage = this.listType == "grid" ? int(this.gridPerPage) : int(this.listPerPage);
         NinjaSage.clearDynamicTooltip(this.btn_switch);
         NinjaSage.showDynamicTooltip(this.btn_switch,"Switch to " + (this.listType == "grid" ? "List" : "Grid") + " view");
         this.gridMC.visible = this.listType == "grid";
         this.listMC.visible = this.listType == "list";
         this.totalPage = Math.max(Math.ceil(this.selectedCategory.length / this.itemPerPage),1);
         this.resetIconHolder();
         this.resetRecursiveProperty();
         this.updatePageNumber();
      ...
      public function completeListItem() : void
      {
         var _loc8_:String = null;
         this.listMC["item_" + this.itemCount].gotoAndStop(1);
         this.listMC["item_" + this.itemCount].visible = true;
         var _loc1_:* = this.selectedCategory[this.itemIndex].split(":")[0];
         var _loc2_:* = this.selectedCategory[this.itemIndex].split(":")[1];
         var _loc3_:* = Library.getItemInfo(_loc1_);
         this.listMC["item_" + this.itemCount].lvlTxt.text = _loc3_.item_level;
         this.listMC["item_" + this.itemCount].txt_name.text = _loc3_.item_name;
         this.listMC["item_" + this.itemCount].iconMc.gotoAndStop(_loc1_.split("_")[0]);
         _loc3_.owned_qty = _loc2_;
         if(_loc3_.item_premium)
         {
            this.listMC["item_" + this.itemCount].emblemMC.visible = true;
         }
         if(_loc3_.item_level <= int(Character.character_lvl))
         {
            this.color.brightness = 0;
            this.listMC["item_" + this.itemCount].transform.colorTransform = this.color;
            this.listMC["item_" + this.itemCount].btn_equip.visible = true;
            this.listMC["item_" + this.itemCount].lockMc.visible = false;
         }
         if(_loc3_.item_id.indexOf("material") >= 0 || _loc3_.item_id.indexOf("essential") >= 0 || _loc3_.item_id.indexOf("item") >= 0)
         {
            this.listMC["item_" + this.itemCount].btn_equip.visible = false;
            this.listMC["item_" + this.itemCount].btn_use.visible = false;
         }
         if(_loc3_.hasOwnProperty("item_usable") && _loc3_.item_usable)
         {
            this.listMC["item_" + this.itemCount].btn_use.visible = true;
            this.listMC["item_" + this.itemCount].btn_use.metaData = {
               "usable_item":_loc3_,
               "owned_qty":_loc2_
            };
            this.eventHandler.addListener(this.listMC["item_" + this.itemCount].btn_use,MouseEvent.CLICK,this.useItem);
         }
         var _loc4_:* = _loc3_.item_id.indexOf("material") >= 0;
         var _loc5_:* = _loc3_.item_id.indexOf("item") >= 0;
         var _loc6_:* = _loc3_.item_id.indexOf("essential") >= 0;
         if(_loc4_ || _loc5_ || _loc6_)
         {
            this.listMC["item_" + this.itemCount].btn_addFavorite.visible = false;
            this.listMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
         }
         else
         {
            this.listMC["item_" + this.itemCount].btn_addFavorite.metaData = {"id":_loc3_["item_id"]};
            this.listMC["item_" + this.itemCount].btn_removeFavorite.metaData = {"id":_loc3_["item_id"]};
            if(this.tabIndicator == "favorite")
            {
               this.listMC["item_" + this.itemCount].btn_addFavorite.visible = false;
               this.listMC["item_" + this.itemCount].btn_removeFavorite.visible = true;
               this.eventHandler.addListener(this.listMC["item_" + this.itemCount].btn_removeFavorite,MouseEvent.CLICK,this.removeItemFavorite);
            }
            else if(this.favoriteArray.indexOf(_loc3_["item_id"]) >= 0)
            {
               this.listMC["item_" + this.itemCount].btn_addFavorite.visible = false;
               this.listMC["item_" + this.itemCount].btn_removeFavorite.visible = true;
            }
            ...
            {
               this.listMC["item_" + this.itemCount].btn_addFavorite.visible = true;
               this.listMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
               this.eventHandler.addListener(this.listMC["item_" + this.itemCount].btn_addFavorite,MouseEvent.CLICK,this.addItemFavorite);
            }
         }
         if(this.sellMode)
         {
            ...
            this.listMC["item_" + this.itemCount].btn_addFavorite.visible = false;
            this.listMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
            this.listMC["item_" + this.itemCount].btn_sell.visible = true;
            this.listMC["item_" + this.itemCount].btn_sell.metaData = {
               "item_info":_loc3_,
               "owned_qty":_loc2_
            };
            this.eventHandler.addListener(this.listMC["item_" + this.itemCount].btn_sell,MouseEvent.CLICK,this.openSellConfirmation);
         }
         var _loc7_:* = false;
         if(this.tabIndicator == "favorite")
         {
            if((_loc8_ = this.getItemTypeFromId(_loc1_)) == "weapon" && _loc1_ == Character.character_weapon)
            {
               _loc7_ = true;
            }
            else if(_loc8_ == "set" && _loc1_ == Character.character_set)
            {
               _loc7_ = true;
            }
            else if(_loc8_ == "back" && _loc1_ == Character.character_back_item)
            {
               _loc7_ = true;
            }
            else if(_loc8_ == "accessory" && _loc1_ == Character.character_accessory)
            {
               _loc7_ = true;
            }
            else if(_loc8_ == "hair" && _loc1_ == Character.character_hair)
            {
               _loc7_ = true;
            }
         }
         ...
         {
            _loc7_ = _loc1_ == this.equippedItem;
         }
         if(_loc7_)
         {
            this.listMC["item_" + this.itemCount]["btn_equipped"].visible = true;
            NinjaSage.showDynamicTooltip(this.listMC["item_" + this.itemCount]["btn_equipped"],"Equipped");
            this.listMC["item_" + this.itemCount]["btn_equip"].visible = false;
         }
         this.listMC["item_" + this.itemCount].clickmask.tooltip = _loc3_;
         this.listMC["item_" + this.itemCount].clickmask.item_type = _loc1_.split("_")[0];
         this.listMC["item_" + this.itemCount].btn_equip.metaData = {"id":_loc3_["item_id"]};
         this.listMC["item_" + this.itemCount].clickmask.metaData = {"id":_loc3_["item_id"]};
         this.eventHandler.addListener(this.listMC["item_" + this.itemCount].clickmask,MouseEvent.MOUSE_OVER,this.toolTiponOver);
         this.eventHandler.addListener(this.listMC["item_" + this.itemCount].clickmask,MouseEvent.MOUSE_OUT,this.toolTiponOut);
         this.eventHandler.addListener(this.listMC["item_" + this.itemCount].clickmask,MouseEvent.CLICK,this.loadItem);
         this.eventHandler.addListener(this.listMC["item_" + this.itemCount].btn_equip,MouseEvent.CLICK,this.loadItem);
         if(_loc3_.item_id.indexOf("material") >= 0 || _loc3_.item_id.indexOf("essential") >= 0 || _loc3_.item_id.indexOf("item") >= 0)
         {
            this.eventHandler.removeListener(this.listMC["item_" + this.itemCount].clickmask,MouseEvent.CLICK,this.loadItem);
            this.eventHandler.removeListener(this.listMC["item_" + this.itemCount].btn_equip,MouseEvent.CLICK,this.loadItem);
         }
         ++this.itemIndex;
         ++this.itemCount;
         this.loadSwf();
      ...
      public function completeIcon(param1:Event) : *
      {
         ...
         this.gridMC["item_" + this.itemCount].iconMc.iconHolder.addChild(itemMC);
         this.gridMC["item_" + this.itemCount].gotoAndStop(1);
         this.gridMC["item_" + this.itemCount].visible = true;
         var effectiveType:String = this.tabIndicator;
         if(this.tabIndicator == "favorite")
         {
            currentItemId = this.selectedCategory[this.itemIndex].split(":")[0];
            effectiveType = this.getItemTypeFromId(currentItemId);
         }
         if(effectiveType == "weapon")
         {
         ...
         this.gridMC["item_" + this.itemCount].lvlTxt.text = getItemInfo.item_level;
         if(itemQty != undefined)
         {
            this.gridMC["item_" + this.itemCount].amtTxt.visible = true;
            this.gridMC["item_" + this.itemCount].amtTxt.text = "x" + itemQty;
         }
         else
         {
            this.gridMC["item_" + this.itemCount].amtTxt.visible = false;
            itemQty = 1;
         }
         if(getItemInfo.item_premium)
         {
            this.gridMC["item_" + this.itemCount].emblemMC.visible = true;
         }
         if(getItemInfo.item_level <= int(Character.character_lvl))
         {
            this.color.brightness = 0;
            this.gridMC["item_" + this.itemCount].transform.colorTransform = this.color;
            this.gridMC["item_" + this.itemCount].btn_equip.visible = true;
            this.gridMC["item_" + this.itemCount].lockMc.visible = false;
         }
         if(getItemInfo.item_id.indexOf("material") >= 0 || getItemInfo.item_id.indexOf("essential") >= 0 || getItemInfo.item_id.indexOf("item") >= 0)
         {
            this.gridMC["item_" + this.itemCount].btn_equip.visible = false;
            this.gridMC["item_" + this.itemCount].btn_use.visible = false;
         }
         if(getItemInfo.hasOwnProperty("item_usable") && getItemInfo.item_usable)
         {
            this.gridMC["item_" + this.itemCount].btn_use.visible = true;
            this.gridMC["item_" + this.itemCount].btn_use.metaData = {
               "usable_item":getItemInfo,
               "owned_qty":itemQty
            };
            this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_use,MouseEvent.CLICK,this.useItem);
         }
         var isMaterial:Boolean = getItemInfo.item_id.indexOf("material") >= 0;
         var isConsumable:Boolean = getItemInfo.item_id.indexOf("item") >= 0;
         var isEssential:Boolean = getItemInfo.item_id.indexOf("essential") >= 0;
         if(isMaterial || isConsumable || isEssential)
         {
            this.gridMC["item_" + this.itemCount].btn_addFavorite.visible = false;
            this.gridMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
         }
         else
         {
            this.gridMC["item_" + this.itemCount].btn_addFavorite.metaData = {"id":getItemInfo["item_id"]};
            this.gridMC["item_" + this.itemCount].btn_removeFavorite.metaData = {"id":getItemInfo["item_id"]};
            if(this.tabIndicator == "favorite")
            {
               this.gridMC["item_" + this.itemCount].btn_addFavorite.visible = false;
               this.gridMC["item_" + this.itemCount].btn_removeFavorite.visible = true;
               this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_removeFavorite,MouseEvent.CLICK,this.removeItemFavorite);
            }
            else if(this.favoriteArray.indexOf(getItemInfo["item_id"]) >= 0)
            {
               this.gridMC["item_" + this.itemCount].btn_addFavorite.visible = false;
               this.gridMC["item_" + this.itemCount].btn_removeFavorite.visible = true;
            }
            ...
            {
               this.gridMC["item_" + this.itemCount].btn_addFavorite.visible = true;
               this.gridMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
               this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_addFavorite,MouseEvent.CLICK,this.addItemFavorite);
            }
         }
         if(this.sellMode)
         {
            ...
            this.gridMC["item_" + this.itemCount].btn_addFavorite.visible = false;
            this.gridMC["item_" + this.itemCount].btn_removeFavorite.visible = false;
            this.gridMC["item_" + this.itemCount].btn_sell.gotoAndStop(1);
            this.gridMC["item_" + this.itemCount].btn_sell.visible = true;
            this.gridMC["item_" + this.itemCount].btn_sell.txt_price.text = getItemInfo.item_sell_price;
            this.gridMC["item_" + this.itemCount].btn_sell.metaData = {
               "item_info":getItemInfo,
               "owned_qty":itemQty
            };
            this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_sell,MouseEvent.CLICK,this.openSellConfirmation);
            this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_sell,MouseEvent.MOUSE_OVER,this.hoverOver);
            this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_sell,MouseEvent.MOUSE_OUT,this.hoverOut);
         }
         var isEquipped:Boolean = false;
         if(this.tabIndicator == "favorite")
         {
            favType = this.getItemTypeFromId(itemId);
            if(favType == "weapon" && itemId == Character.character_weapon)
            {
               isEquipped = true;
            }
            else if(favType == "set" && itemId == Character.character_set)
            {
               isEquipped = true;
            }
            else if(favType == "back" && itemId == Character.character_back_item)
            {
               isEquipped = true;
            }
            else if(favType == "accessory" && itemId == Character.character_accessory)
            {
               isEquipped = true;
            }
            else if(favType == "hair" && itemId == Character.character_hair)
            {
               isEquipped = true;
            }
         }
         ...
         {
            isEquipped = itemId == this.equippedItem;
         }
         if(isEquipped)
         {
            this.gridMC["item_" + this.itemCount]["txt_equipped"].visible = true;
            this.gridMC["item_" + this.itemCount]["btn_equip"].visible = false;
         }
         this.gridMC["item_" + this.itemCount].clickmask.tooltip = getItemInfo;
         this.gridMC["item_" + this.itemCount].clickmask.item_type = itemId.split("_")[0];
         this.gridMC["item_" + this.itemCount].btn_equip.metaData = {"id":getItemInfo["item_id"]};
         this.gridMC["item_" + this.itemCount].clickmask.metaData = {"id":getItemInfo["item_id"]};
         this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].clickmask,MouseEvent.MOUSE_OVER,this.toolTiponOver);
         this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].clickmask,MouseEvent.MOUSE_OUT,this.toolTiponOut);
         this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].clickmask,MouseEvent.CLICK,this.loadItem);
         this.eventHandler.addListener(this.gridMC["item_" + this.itemCount].btn_equip,MouseEvent.CLICK,this.loadItem);
         if(getItemInfo.item_id.indexOf("material") >= 0 || getItemInfo.item_id.indexOf("essential") >= 0 || getItemInfo.item_id.indexOf("item") >= 0)
         {
            this.eventHandler.removeListener(this.gridMC["item_" + this.itemCount].clickmask,MouseEvent.CLICK,this.loadItem);
            this.eventHandler.removeListener(this.gridMC["item_" + this.itemCount].btn_equip,MouseEvent.CLICK,this.loadItem);
         }
         ++this.itemIndex;
         ++this.itemCount;
         this.loadSwf();
      ...
      public function loadItem(param1:MouseEvent) : void
      {
         ...
         var _loc4_:*;
         (_loc4_ = this.loaderSwf.add(_loc3_)).addEventListener(BulkLoader.COMPLETE,_loc2_ == "btn_equip" ? this.equipItem : this.onItemPreviewed);
         this.loaderSwf.start();
      }
      ...
      {
         var _loc3_:* = undefined;
         var _loc2_:String = this.tabIndicator;
         if(this.tabIndicator == "favorite")
         {
            _loc2_ = this.getItemTypeFromId(this.tempItemId);
         }
         if(_loc2_ == "weapon")
         {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.selectedSetMC.length)
            {
               if(this.selectedSetMC[_loc3_] != null)
               {
                  this.selectedSetMC[_loc3_].stopAllMovieClips();
               }
               GF.removeAllChild(this.selectedSetMC[_loc3_]);
               _loc3_++;
            }
            this.selectedSetMC = [];
            _loc3_ = 0;
            while(_loc3_ < this.tempSetArray.length)
            {
               if(this.tempSetArray[_loc3_] != null)
               {
                  this.tempSetArray[_loc3_].stopAllMovieClips();
               }
               GF.removeAllChild(this.tempSetArray[_loc3_]);
               _loc3_++;
            }
            this.tempSetArray = [];
            _loc3_ = 0;
            ...
            {
               this.tempSetMC = param1.target.content[this.bodyArray[_loc3_]];
            ...
            while(_loc3_ < this.bodyArray.length)
            {
               ...
               this.selectedSetMC.push(this.tempSetArray[_loc3_]);
               this.addSkinColor(this.tempSetArray[_loc3_]);
               this.char_mc[this.bodyArray[_loc3_]].addChild(this.tempSetArray[_loc3_]);
               _loc3_++;
            }
            try
            {
      ...
      public function equipItem(param1:Event) : *
      {
         ...
         else if(_loc2_ == "set")
         {
            ...
            while(_loc3_ < this.bodyArray.length)
            {
               ...
               this.addSkinColor(this.tempSetArray[_loc3_]);
               this.char_mc[this.bodyArray[_loc3_]].addChild(this.tempSetArray[_loc3_]);
               GF.removeAllChild(OutfitManager.set_mc[_loc3_]);
               OutfitManager.set_mc[_loc3_] = this.tempSetArray[_loc3_];
               _loc3_++;
            }
            try
            {
         ...
         if(this.tabIndicator == "favorite")
         {
            this.refreshOriginalArray(_loc2_);
         }
         this.currentPage = 1;
         this.totalPage = Math.max(Math.ceil(this.selectedCategory.length / this.itemPerPage),1);
      ...
      public function openSellConfirmation(param1:MouseEvent) : *
      {
         ...
         this.sellPanel.btn_use.visible = false;
         ...
         this.escapeKey.addListener(this.sellPanel,this.onCloseConfItem);
      }
      ...
      {
         this.main.loading(true);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.dSEakmGvt8xt",[Character.char_id,Character.sessionkey,this.selectedSellItem.item_id,this.sellQuantity],this.sellResponse);
      }
      ...
      {
         this.escapeKey.removeListener(this.sellPanel,this.onCloseConfItem);
         GF.removeAllChild(this.sellPanel.item.iconMc.iconHolder);
      ...
      {
         this.main.loading(true);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.2i9S4MV921j7",[Character.char_id,Character.sessionkey],this.getPresetResponse);
      }
      ...
      public function openPreset() : *
      {
         ...
         var _loc10_:OutfitManager = null;
         var _loc11_:* = undefined;
         var _loc12_:* = undefined;
         this.presetMC.visible = true;
         this.originalItemAnimation = Character.play_items_animation;
         Character.play_items_animation = false;
         this.main.handleVillageHUDVisibility(false);
         this.char_mc.visible = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.gridPerPage)
         {
            this.gridMC["item_" + _loc1_].visible = false;
            _loc1_++;
         }
         ...
         while(_loc2_ < 4)
         {
            ...
            {
               _loc4_ = -1;
               _loc5_ = this.presets.length;
               _loc7_ = new (_loc6_ = getDefinitionByName("PlusButton") as Class)();
            ...
            if(this.presets.length > _loc4_)
            {
               ...
               while(_loc3_ < 5)
               {
                  _loc11_ = this.presetMC["presetItem" + _loc2_]["iconMC" + _loc3_];
                  this.presetMC["presetItem" + _loc2_]["iconMC" + _loc3_].noItem.visible = true;
                  GF.removeAllChild(_loc11_.iconHolder);
                  if(_loc8_[_loc3_] != null)
                  {
                     this.presetMC["presetItem" + _loc2_]["iconMC" + _loc3_].noItem.visible = false;
                     NinjaSage.loadIconSWF("items",_loc8_[_loc3_],_loc11_.iconHolder,"icon");
                  }
      ...
      public function savePreset(param1:MouseEvent) : *
      {
         ...
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.ZwiSgZ9QhGjW",[Character.char_id,Character.sessionkey,this.presets[this.presetTarget].id,Character.character_weapon,Character.character_set,Character.character_hair,Character.character_back_item,Character.character_accessory,Character.character_color_hair],this.savePresetResponse);
      }
      ...
      {
         removeChild(this.confirmation);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.faOiPGgjDin6",[Character.char_id,Character.sessionkey,this.presets[this.presetTarget].id,this.presetMC.renameMC.nameTxt.text],this.presetRenameResponse);
      }
      ...
      {
         removeChild(this.confirmation);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.MlMXVvboanph",[Character.char_id,Character.sessionkey],this.presetBuyResponse);
      }
      ...
      public function closePreset(param1:MouseEvent) : *
      {
         ...
         Character.play_items_animation = this.originalItemAnimation;
         var _loc2_:int = 0;
         while(_loc2_ < this.gridPerPage)
         {
            this.gridMC["item_" + _loc2_].visible = this.gridMC["item_" + _loc2_].iconMc.iconHolder.numChildren > 0;
            _loc2_++;
         }
      ...
      public function openSortList(param1:MouseEvent) : void
      {
         ...
         this.sortMC.clickmask.visible = true;
         this.eventHandler.addListener(this.sortMC.clickmask,MouseEvent.CLICK,this.closeSortList);
         var _loc2_:int = 0;
      ...
      public function closeSortList(param1:MouseEvent = null) : void
      {
         this.sortMC.sort_list.visible = false;
         this.sortMC.clickmask.visible = false;
         this.eventHandler.removeListener(this.sortMC.clickmask,MouseEvent.CLICK,this.closeSortList);
      }
      
      public function selectSort(param1:MouseEvent) : void
      {
         var _loc2_:int = param1.currentTarget.name.replace("sort_","");
      ...
      public function searchItem(param1:MouseEvent) : *
      {
         ...
         while(_loc6_ < this.selectedCategory.length)
         {
            ...
            if(_loc4_ && _loc4_.hasOwnProperty(_loc7_) && _loc4_[_loc7_].toLowerCase().indexOf(_loc3_) >= 0)
            {
      ...
      {
         this.usableItem = param1.currentTarget.metaData.usable_item["item_id"];
         this.useItemQuantity = 1;
         if(this.usableItem == "essential_10")
         {
            this.main.loadExternalSwfPanel("ScrollOfWisdom","ScrollOfWisdom");
            return;
         }
         if(param1.currentTarget.metaData.owned_qty > 1)
         {
            this.useItemPanel = new ItemBuyConfirmation();
            this.useItemPanel.btn_buy.visible = false;
            this.useItemPanel.btn_sell.visible = false;
            this.useItemPanel.currencyIcon.visible = false;
            this.useItemPanel.lbl_use.visible = false;
            this.useItemPanel.txt_gold.visible = false;
            this.useItemMaxQuantity = param1.currentTarget.metaData.owned_qty;
            this.eventHandler.addListener(this.useItemPanel.btn_use,MouseEvent.CLICK,this.useItemAmf);
            this.eventHandler.addListener(this.useItemPanel.btn_prev,MouseEvent.CLICK,this.onChangeQuantityUse);
            this.eventHandler.addListener(this.useItemPanel.btn_prev_10,MouseEvent.CLICK,this.onChangeQuantityUse);
            this.eventHandler.addListener(this.useItemPanel.btn_next,MouseEvent.CLICK,this.onChangeQuantityUse);
            this.eventHandler.addListener(this.useItemPanel.btn_next_10,MouseEvent.CLICK,this.onChangeQuantityUse);
            this.eventHandler.addListener(this.useItemPanel.btn_close,MouseEvent.CLICK,this.closeUseItemPanel);
            this.useItemPanel.item.lvlTxt.text = param1.currentTarget.metaData.usable_item["item_level"];
            this.useItemPanel.item.gotoAndStop(1);
            this.useItemPanel.desctxt.text = "Confirm using " + param1.currentTarget.metaData.usable_item["item_name"] + "?";
            this.useItemPanel.txt_quality.text = String(this.useItemQuantity);
            GF.removeAllChild(this.useItemPanel.item.iconMc.iconHolder);
            NinjaSage.loadIconSWF(this.getAssetPath(param1.currentTarget.metaData.usable_item["item_id"]),param1.currentTarget.metaData.usable_item["item_id"],this.useItemPanel.item.iconMc.iconHolder,"icon");
            this.main.loader.addChild(this.useItemPanel);
            this.escapeKey.addListener(this.useItemPanel,this.closeUseItemPanel);
         }
         else
         {
            this.useItemAmf();
      ...
      public function useItemAmf(param1:MouseEvent = null) : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("36a62s4oZ7iYRJjd.kbCjIzXIF7GF",[Character.char_id,Character.sessionkey,this.usableItem,this.useItemQuantity],this.onUseItem);
      }
      
      public function onChangeQuantityUse(param1:MouseEvent) : *
      {
         switch(param1.currentTarget.name)
         {
            case "btn_prev":
               if(this.useItemQuantity > 1)
               {
                  --this.useItemQuantity;
                  break;
               }
               break;
            case "btn_prev_10":
               if(this.useItemQuantity > 10)
               {
                  this.useItemQuantity -= 10;
                  break;
               }
               this.useItemQuantity = 1;
               break;
            case "btn_next":
               if(this.useItemQuantity < 100)
               {
                  ++this.useItemQuantity;
                  break;
               }
         ...
         if(this.useItemQuantity > 100)
         {
            this.useItemQuantity = 100;
         }
         if(this.useItemQuantity > this.useItemMaxQuantity)
         {
            this.useItemQuantity = this.useItemMaxQuantity;
         }
         this.useItemPanel.txt_quality.text = String(this.useItemQuantity);
      }
      ...
      public function onUseItem(param1:Object) : *
      {
         ...
         if(param1.status == 1)
         {
            ...
            Character.removeEssentials(this.usableItem,this.useItemQuantity);
            this.materialArray = this.sortItems(Character.character_materials.split(","));
            this.essentialArray = this.sortItems(Character.character_essentials.split(","));
            this.setDefaultArray();
            this.totalPage = Math.max(Math.ceil(this.selectedCategory.length / this.itemPerPage),1);
      ...
      public function closeUseItemPanel(param1:MouseEvent = null) : *
      {
         if(this.useItemPanel != null)
         {
            this.escapeKey.removeListener(this.useItemPanel,this.closeUseItemPanel);
            GF.removeAllChild(this.useItemPanel.item.iconMc.iconHolder);
            GF.removeAllChild(this.useItemPanel);
            this.useItemQuantity = 1;
            this.useItemPanel = null;
         }
      }
      ...
      {
         if(this.tabIndicator == "accessory" || this.tabIndicator == "back")
         {
         ...
         this.main.showMessage("Unequip only for accessory or back item");
      }
      ...
      public function setDefaultArray() : *
      {
         ...
         else if(this.tabIndicator in _loc1_)
         {
      ...
      public function resetIconHolder() : *
      {
         ...
         if(this.listType == "grid")
         {
            ...
            while(_loc1_ < this.gridPerPage)
            {
               GF.removeAllChild(this.gridMC["item_" + _loc1_].iconMc.iconHolder);
               this.color.brightness = -0.3;
               this.gridMC["item_" + _loc1_].transform.colorTransform = this.color;
               this.gridMC["item_" + _loc1_].gotoAndStop(1);
               this.gridMC["item_" + _loc1_].visible = false;
               this.gridMC["item_" + _loc1_].btn_equip.visible = false;
               this.gridMC["item_" + _loc1_].btn_use.visible = false;
               this.gridMC["item_" + _loc1_].btn_sell.visible = false;
               this.gridMC["item_" + _loc1_].btn_addFavorite.visible = false;
               this.gridMC["item_" + _loc1_].btn_removeFavorite.visible = false;
               this.gridMC["item_" + _loc1_].lockMc.visible = true;
               this.gridMC["item_" + _loc1_].emblemMC.visible = false;
               this.gridMC["item_" + _loc1_].amtTxt.visible = false;
               this.gridMC["item_" + _loc1_].txt_equipped.visible = false;
               this.gridMC["item_" + _loc1_].btn_use.metaData = {};
               this.gridMC["item_" + _loc1_].btn_equip.metaData = {};
               this.gridMC["item_" + _loc1_].btn_sell.metaData = {};
               this.gridMC["item_" + _loc1_].btn_addFavorite.metaData = {};
               this.gridMC["item_" + _loc1_].btn_removeFavorite.metaData = {};
               delete this.gridMC["item_" + _loc1_].clickmask.tooltip;
               delete this.gridMC["item_" + _loc1_].clickmask.tooltipCache;
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].clickmask,MouseEvent.MOUSE_OVER,this.toolTiponOver);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].clickmask,MouseEvent.MOUSE_OUT,this.toolTiponOut);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].clickmask,MouseEvent.CLICK,this.loadItem);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].btn_equip,MouseEvent.CLICK,this.loadItem);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].btn_use,MouseEvent.CLICK,this.useItem);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].btn_addFavorite,MouseEvent.CLICK,this.addItemFavorite);
               this.eventHandler.removeListener(this.gridMC["item_" + _loc1_].btn_removeFavorite,MouseEvent.CLICK,this.removeItemFavorite);
               _loc1_++;
            }
         }
         else
         {
            _loc1_ = 0;
            while(_loc1_ < this.listPerPage)
            {
               this.color.brightness = -0.3;
               this.listMC["item_" + _loc1_].transform.colorTransform = this.color;
               this.listMC["item_" + _loc1_].gotoAndStop(1);
               this.listMC["item_" + _loc1_].visible = false;
               this.listMC["item_" + _loc1_].btn_equip.visible = false;
               this.listMC["item_" + _loc1_].btn_use.visible = false;
               this.listMC["item_" + _loc1_].btn_sell.visible = false;
               this.listMC["item_" + _loc1_].btn_addFavorite.visible = false;
               this.listMC["item_" + _loc1_].btn_removeFavorite.visible = false;
               this.listMC["item_" + _loc1_].lockMc.visible = true;
               this.listMC["item_" + _loc1_].emblemMC.visible = false;
               this.listMC["item_" + _loc1_].btn_equipped.visible = false;
               this.listMC["item_" + _loc1_].btn_use.metaData = {};
               this.listMC["item_" + _loc1_].btn_equip.metaData = {};
               this.listMC["item_" + _loc1_].btn_sell.metaData = {};
               this.listMC["item_" + _loc1_].btn_addFavorite.metaData = {};
               this.listMC["item_" + _loc1_].btn_removeFavorite.metaData = {};
               delete this.listMC["item_" + _loc1_].clickmask.tooltip;
               delete this.listMC["item_" + _loc1_].clickmask.tooltipCache;
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].clickmask,MouseEvent.MOUSE_OVER,this.toolTiponOver);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].clickmask,MouseEvent.MOUSE_OUT,this.toolTiponOut);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].clickmask,MouseEvent.CLICK,this.loadItem);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].btn_equip,MouseEvent.CLICK,this.loadItem);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].btn_use,MouseEvent.CLICK,this.useItem);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].btn_addFavorite,MouseEvent.CLICK,this.addItemFavorite);
               this.eventHandler.removeListener(this.listMC["item_" + _loc1_].btn_removeFavorite,MouseEvent.CLICK,this.removeItemFavorite);
               _loc1_++;
            }
         }
      }
      ...
      public function sortItems(param1:Array) : Array
      {
         ...
         {
            if((_loc7_ = param1[0].split("_")[0]) == "back" || _loc7_ == "accessory")
            {
               return param1;
            }
         }
      ...
      public function equipResponse(param1:Object) : *
      {
         ...
         {
            if(param1.status > 1 && param1.hasOwnProperty("result"))
            {
               this.main.showMessage(param1.result);
               return;
            }
      ...
      {
         this.itemPerPage = this.gridPerPage;
         this.main.HUD.setBasicData();
         this.main.HUD.loadFrame();
         var _loc1_:* = 0;
         ...
         {
            GF.removeAllChild(this.gridMC["item_" + _loc1_].iconMc.iconHolder);
            this.gridMC["item_" + _loc1_].clickmask.tooltip = null;
            this.gridMC["item_" + _loc1_].btn_use.metaData = {};
            this.gridMC["item_" + _loc1_].btn_equip.metaData = {};
            this.gridMC["item_" + _loc1_].btn_sell.metaData = {};
            this.gridMC["item_" + _loc1_].btn_addFavorite.metaData = {};
