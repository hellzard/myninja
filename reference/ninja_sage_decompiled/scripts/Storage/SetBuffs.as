   ...
   public class SetBuffs
   {
      ...
      private static function normalizeMemberId(param1:String, param2:String) : String
      {
         ...
         if(param1 == "cloth" || param1 == "hair")
         {
            ...
            if((_loc4_ = _loc3_.lastIndexOf("_")) > 0)
            {
               if((_loc5_ = _loc3_.substr(_loc4_ + 1)) == "0" || _loc5_ == "1")
               {
      ...
      public static function constructData(param1:*) : void
      {
         ...
         var _loc2_:Array = param1 != null && param1.hasOwnProperty("sets") ? param1.sets : param1 as Array;
         if(_loc2_ == null)
         {
            _constructed = true;
            return;
         ...
         for each(_loc3_ in _loc2_)
         {
            if(!(_loc3_ == null || !_loc3_.hasOwnProperty("setId") || _loc3_.setId == null))
            {
               ...
               if(!SetBuffs.data.hasOwnProperty(_loc4_))
               {
                  ...
                  if(!((_loc5_ = !!_loc3_.hasOwnProperty("members") ? _loc3_.members : null) == null || !(_loc5_ is Object) || _loc5_ is Array || _loc5_ is String || _loc5_ is Number))
                  {
                     for each(_loc6_ in SLOTS)
                     {
                        if(!(!_loc5_.hasOwnProperty(_loc6_) || _loc5_[_loc6_] == null))
                        {
                           if((_loc7_ = _loc5_[_loc6_] as Array) != null)
                           {
      ...
      public static function getSetMembers(param1:String) : Array
      {
         ...
         var _loc3_:Object = SetBuffs.data[param1];
         var _loc4_:Object;
         if((_loc4_ = !!_loc3_.hasOwnProperty("members") ? _loc3_.members : null) == null || !(_loc4_ is Object) || _loc4_ is Array || _loc4_ is String || _loc4_ is Number)
         {
            return _loc2_;
         }
         for each(_loc5_ in TOOLTIP_SLOTS)
         {
            ...
            {
               if((_loc6_ = _loc4_[_loc5_] as Array) != null)
               {
      ...
      private static function formatTierEffects(param1:String, param2:int) : String
      {
         ...
         for each(_loc5_ in _loc3_)
         {
            if(_loc5_ != null)
            {
               if((_loc6_ = formatEffectText(_loc5_)) != "")
               {
                  _loc4_.push(_loc6_);
               }
            }
      ...
      public static function buildSetTooltip(param1:String, param2:String, param3:String, param4:String, param5:String = null, param6:String = null) : String
      {
         ...
         var _loc7_:String;
         if((_loc7_ = getSetIdForAnyItem(param1)) == null)
         {
            return "";
         }
         var _loc8_:Array;
         if((_loc8_ = getSetMembers(_loc7_)).length < 1)
         {
            return "";
         }
         var _loc9_:Object = {
         ...
         _loc16_ = "\n";
         _loc17_ = _loc16_ + _loc16_ + getSetName(_loc7_) + " (" + _loc12_ + "/" + _loc14_ + ")" + _loc16_;
         for each(_loc11_ in _loc8_)
         {
            ...
            if((_loc21_ = String(_loc11_.itemId)).indexOf("%s") >= 0)
            {
               _loc21_ = _loc21_.replace("%s",Character.character_gender);
            }
            _loc23_ = (_loc22_ = Library.getItemInfo(_loc21_)) != null && _loc22_.hasOwnProperty("item_name") && _loc22_.item_name != "null" ? _loc22_.item_name : _loc21_;
            if(_loc20_)
            {
         ...
         {
            if((_loc24_ = formatTierEffects(_loc7_,_loc19_)) != "")
            {
               if(_loc12_ >= _loc19_)
               {
