package Storage
{
   ...
   public class TalentSkillLevel
   {
      ...
      public function TalentSkillLevel()
      {
         super();
      }
      ...
      public static function constructData(param1:*) : *
      {
         ...
         for(_loc2_ in param1)
         {
            ...
            TalentSkillLevel.data[_loc3_.id] = _loc3_;
         }
         _constructed = true;
         param1 = null;
      }
      
      public static function getTalentSkillLevels(param1:String, param2:*) : *
      {
         var _loc3_:* = param1 + ":" + String(param2);
         if(!TalentSkillLevel.data.hasOwnProperty(_loc3_))
         {
            return false;
         }
         var _loc4_:* = TalentSkillLevel.data[_loc3_];
         TalentSkillLevel.mutateEffects(_loc4_);
         return _loc4_;
      }
      
      public static function getCopy(param1:*, param2:*) : *
      {
         var _loc3_:* = TalentSkillLevel.getTalentSkillLevels(param1,param2);
         if(_loc3_)
         {
