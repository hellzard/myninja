   ...
   public class URI
   {
      ...
      public static function fastEscapeChars(param1:String, param2:URIEncodingBitmap) : String
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            if(_loc4_ = param2.ShouldEscape(_loc3_))
            {
               if((_loc3_ = _loc4_.toString(16)).length == 1)
               {
                  _loc3_ = "0" + _loc3_;
               }
               _loc3_ = (_loc3_ = "%" + _loc3_).toUpperCase();
            }
            _loc6_ += _loc3_;
            _loc5_++;
         }
      ...
      protected function parseURI(param1:String) : Boolean
      {
         ...
         var _loc5_:* = _loc2_ != -1;
         var _loc7_:Boolean = !(_loc6_ = _loc3_ != -1) || _loc2_ < _loc3_;
         if(_loc5_ && _loc7_)
         {
            this._scheme = _loc4_.substr(0,_loc2_);
            this._scheme = this._scheme.toLowerCase();
            if((_loc4_ = _loc4_.substr(_loc2_ + 1)).substr(0,2) != "//")
            {
      ...
      public function getExtension(param1:Boolean = false) : String
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:String;
         if((_loc4_ = this.getFilename()) == "")
         {
            return String("");
         }
         if((_loc3_ = _loc4_.lastIndexOf(".")) == -1 || _loc3_ == 0)
         {
            return String("");
         }
      ...
      public function getFilename(param1:Boolean = false) : String
      {
         ...
         var _loc4_:String;
         if((_loc3_ = (_loc4_ = this.path).lastIndexOf("/")) != -1)
         {
         ...
         if(param1)
         {
            if((_loc3_ = _loc2_.lastIndexOf(".")) != -1)
            {
      ...
      public function getRelation(param1:URI, param2:Boolean = true) : int
      {
         ...
         {
            if((_loc6_ = _loc4_[_loc4_.length - 1]).length > 0)
            {
               return URI.NOT_RELATED;
            }
            _loc4_.pop();
         ...
         if(_loc3_.length < _loc4_.length)
         {
            if((_loc5_ = _loc3_[_loc3_.length - 1]).length > 0)
            {
               return URI.NOT_RELATED;
            }
            _loc3_.pop();
      ...
      public function getCommonParent(param1:URI, param2:Boolean = true) : URI
      {
         ...
         if((_loc7_ = _loc5_.getRelation(_loc6_)) == URI.NOT_RELATED)
         {
            return null;
         }
         _loc5_.chdir(".");
         _loc6_.chdir(".");
         while(!((_loc7_ = _loc5_.getRelation(_loc6_,param2)) == URI.EQUAL || _loc7_ == URI.PARENT))
         {
      ...
      public function chdir(param1:String, param2:Boolean = false) : Boolean
      {
         ...
         var _loc16_:String = param1;
         if(param2)
         {
            _loc16_ = URI.escapeChars(param1);
         }
         if(_loc16_ == "")
         {
            return true;
         }
         if(_loc16_.substr(0,2) == "//")
         {
            _loc10_ = this.scheme + ":" + _loc16_;
         ...
         if(_loc11_ == false && _loc6_.length > 0)
         {
            _loc6_.pop();
         }
         this.queryRaw = _loc3_.queryRaw;
         ...
         _loc17_ = this.joinPath(_loc6_,_loc13_,_loc12_);
         this.path = _loc17_;
         return true;
      }
      ...
      public function makeRelativeURI(param1:URI, param2:Boolean = true) : Boolean
      {
         ...
         if((_loc7_ = this.joinPath(_loc10_,false,_loc14_)).length == 0)
         {
            _loc7_ = "./";
         }
      ...
      public function unknownToURI(param1:String, param2:String = "http") : Boolean
      {
         ...
         else if((_loc4_ = _loc5_.path) == ".." || _loc4_ == "." || _loc4_.length >= 3 && _loc4_.substr(0,3) == "../" || _loc4_.length >= 2 && _loc4_.substr(0,2) == "./")
         {
            this.copyURI(_loc5_);
            this.forceEscape();
            return true;
