package com.gestouch.input
{
   import com.gestouch.core.IInputAdapter;
   import com.gestouch.core.TouchesManager;
   import com.gestouch.core.gestouch_internal;
   ...
   public class NativeInputAdapter implements IInputAdapter
   {
      ...
      protected function touchBeginHandler(param1:TouchEvent) : void
      {
         ...
         this._touchesManager.onTouchBegin(param1.touchPointID,param1.stageX,param1.stageY,param1.target as InteractiveObject);
      }
      ...
      protected function touchMoveHandler(param1:TouchEvent) : void
      {
         ...
         this._touchesManager.onTouchMove(param1.touchPointID,param1.stageX,param1.stageY);
      }
      ...
      protected function touchEndHandler(param1:TouchEvent) : void
      {
         ...
         {
            this._touchesManager.onTouchCancel(param1.touchPointID,param1.stageX,param1.stageY);
         }
         else
         {
            this._touchesManager.onTouchEnd(param1.touchPointID,param1.stageX,param1.stageY);
         }
      }
      ...
      protected function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Boolean = this._touchesManager.onTouchBegin(MOUSE_TOUCH_POINT_ID,param1.stageX,param1.stageY,param1.target as InteractiveObject);
         if(_loc2_)
         {
      ...
      protected function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         this._touchesManager.onTouchMove(MOUSE_TOUCH_POINT_ID,param1.stageX,param1.stageY);
      }
      ...
      protected function mouseUpHandler(param1:MouseEvent) : void
      {
         ...
         this._touchesManager.onTouchEnd(MOUSE_TOUCH_POINT_ID,param1.stageX,param1.stageY);
