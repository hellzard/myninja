   ...
   public class TLSEngine extends EventDispatcher
   {
      ...
      private function parseRecord(param1:IDataInput) : void
      {
         ...
         while(this._state != STATE_CLOSED && param1.bytesAvailable > 4)
         {
            ...
            {
               _loc2_ = (_loc7_ = this._packetQueue.shift()).data;
            ...
            else
            {
               ...
               if((_loc5_ = param1.readShort()) > 16384 + 2048)
               {
      ...
      private function parseHandshake(param1:ByteArray) : ByteArray
      {
         ...
         var _loc5_:uint;
         var _loc4_:uint;
         if((_loc5_ = (_loc4_ = _loc2_.readUnsignedByte()) << 16 | _loc2_.readUnsignedShort()) + 4 > param1.length)
         {
            return null;
         }
         ...
         if(this._entityHandshakeHandlers.hasOwnProperty(_loc3_))
         {
            ...
            {
               (_loc6_ = new ByteArray()).writeBytes(param1,_loc5_ + 4,param1.length - (_loc5_ + 4));
               return _loc6_;
            }
            return null;
         }
      ...
      private function sendServerHello(param1:Object) : void
      {
         ...
         (_loc4_ = new ByteArray()).writeShort(this._securityParameters.version);
      ...
      private function loadCertificates(param1:ByteArray) : void
      {
         ...
         if(_loc7_)
         {
            ...
            else
            {
               ...
               if((_loc12_ = new RegExp(_loc11_.replace(/[\^\\\-$.[\]|()?+{}]/g,"\\$&").replace(/\*/g,"[^.]+"),"gi")).exec(this._otherIdentity))
               {
                  this._otherCertificate = _loc5_;
               }
               else
