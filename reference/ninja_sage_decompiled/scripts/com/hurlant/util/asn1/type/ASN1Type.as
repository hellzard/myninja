package com.hurlant.util.asn1.type
{
   ...
   public class ASN1Type
   {
      ...
      public function fromDER(param1:ByteArray, param2:int) : *
      {
         ...
         {
            if((_loc6_ = this.readDERTag(param1,this.explicitClass,true)) == this.explicitTag)
            {
               _loc4_ = this.readDERLength(param1);
               addr38:
               if(!isNaN(this.implicitTag))
               {
                  if((_loc6_ = this.readDERTag(param1,this.implicitClass)) != this.implicitTag)
                  {
                     addr93:
               ...
               _loc4_ = this.readDERLength(param1);
               if((_loc5_ = this.fromDERContent(param1,_loc4_)) != null)
               {
                  return _loc5_;
               }
            }
      ...
      protected function readDERTag(param1:ByteArray, param2:int = 0, param3:Boolean = false, param4:Boolean = false) : int
      {
         ...
         var _loc9_:* = 0;
         var _loc5_:*;
         var _loc6_:* = ((_loc5_ = int(param1.readUnsignedByte())) & 32) != 0;
         var _loc7_:* = (_loc5_ & 192) >> 6;
         if((_loc5_ &= 31) == 31)
         {
            _loc5_ = 0;
            do
            {
               _loc9_ = (_loc8_ = param1.readUnsignedByte()) & 127;
               _loc5_ = int((_loc5_ << 7) + _loc9_);
            }
            while(_loc8_ & 128 != 0);
