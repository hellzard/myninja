package com.hurlant.util.asn1.type
{
   ...
   public class SequenceType extends ASN1Type
   {
      ...
      override protected function fromDERContent(param1:ByteArray, param2:int) : *
      {
         ...
         if(this.children != null)
         {
            ...
            while(_loc7_ < this.children.length)
            {
               for(_loc8_ in this.children[_loc7_])
               {
                  ...
                  if((_loc6_ = (_loc10_ = this.children[_loc7_][_loc8_]).fromDER(param1,_loc4_)) == null)
                  {
                     if(!_loc10_.optional)
                     {
                  ...
                  if(_loc10_.extract)
                  {
                     (_loc11_ = new ByteArray()).writeBytes(param1,_loc9_,param1.position - _loc9_);
         ...
         while(_loc4_ > 0)
         {
            if((_loc6_ = this.childType.fromDER(param1,_loc4_)) == null)
            {
