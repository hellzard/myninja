   ...
   public final class GF
   {
      ...
      public static function removeAllChild(param1:MovieClip) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(param1.parent && param1.parent.cacheAsBitmap)
            {
               param1.parent.cacheAsBitmap = false;
            }
            while(_loc3_ < _loc2_)
            {
               if((_loc4_ = param1.getChildAt(0)) && "destroy" in _loc4_)
               {
                  _loc4_.destroy();
               }
               if(_loc4_ && "cacheAsBitmap" in _loc4_)
               {
      ...
      public static function removeAllChildArray(param1:Array) : void
      {
         ...
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc2_ = param1[_loc5_].numChildren;
               _loc3_ = 0;
               if(true)
               {
               ...
               while(_loc3_ < _loc2_)
               {
                  if((_loc4_ = param1[_loc5_].getChildAt(0)) && "destroy" in _loc4_)
                  {
                     _loc4_.destroy();
                  }
                  if(_loc4_ && "cacheAsBitmap" in _loc4_)
      ...
      public static function destroyArray(param1:Array) : *
      {
         ...
         while(_loc2_ < param1.length)
         {
            if(param1[_loc2_] && "destroy" in param1[_loc2_])
            {
      ...
      public static function cloneAsBitmap(param1:MovieClip, param2:Number, param3:Number, param4:Number, param5:Object = null) : MovieClip
      {
         ...
         if(param5 != null)
         {
            ...
            {
               _loc6_ = param5.transparent;
            }
            if(param5.background != null)
            {
               _loc7_ = param5.background;
            }
         }
      ...
      public static function duplicateDisplayObject(param1:DisplayObject, param2:Boolean = false) : DisplayObject
      {
         ...
         var _loc4_:Class;
         (_loc5_ = new (_loc4_ = param1["constructor"])()).transform = param1.transform;
      ...
      public static function startTimer(param1:Number, param2:int, param3:Function) : Timer
      {
         ...
         (_loc4_ = new Timer(param1,param2)).addEventListener(TimerEvent.TIMER_COMPLETE,param3);
         _loc4_.start();
         return _loc4_;
      }
