package com.worlize.websocket
{
   ...
   public class WebSocket extends EventDispatcher
   {
      ...
      private function fragmentAndSend(param1:WebSocketFrame) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:WebSocketFrame = null;
         var _loc6_:int = 0;
         if(param1.opcode > 7)
         {
         ...
         if(this.config.fragmentOutgoingMessages && param1.binaryPayload && param1.binaryPayload.length > _loc7_)
         {
            param1.binaryPayload.position = 0;
            _loc2_ = param1.binaryPayload.length;
            _loc3_ = Math.ceil(_loc2_ / _loc7_);
            _loc4_ = 1;
            while(_loc4_ <= _loc3_)
            {
               (_loc5_ = new WebSocketFrame()).opcode = _loc4_ === 1 ? int(int(param1.opcode)) : 0;
               _loc5_.fin = _loc4_ === _loc3_;
               _loc6_ = _loc4_ === _loc3_ ? int(int(_loc2_ - _loc7_ * (_loc4_ - 1))) : int(int(_loc7_));
      ...
      {
         var _loc3_:WebSocketErrorEvent = null;
         if(!this.connected)
         {
            return;
         }
         ...
         {
            (_loc3_ = new WebSocketErrorEvent(WebSocketErrorEvent.ABNORMAL_CLOSE)).text = "Close reason: " + param1;
            dispatchEvent(_loc3_);
         }
