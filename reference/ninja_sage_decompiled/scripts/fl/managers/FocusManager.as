package fl.managers
{
   ...
   public class FocusManager implements IFocusManager
   {
      ...
      {
         var _loc1_:* = null;
         var _loc2_:* = this.focusableObjects;
         var _loc3_:int = 0;
         var _loc4_:* = _loc2_;
      ...
      public function getNextFocusManagerComponent(param1:Boolean = false) : InteractiveObject
      {
         ...
         {
            _loc4_ = (_loc2_ = IFocusManagerGroup(_loc3_)).groupName;
         }
         ...
         if(_loc5_ == -1)
         {
            if(param1)
            {
               _loc5_ = this.focusableCandidates.length;
            }
            _loc6_ = true;
         }
         var _loc7_:int = this.getIndexOfNextObject(_loc5_,param1,_loc6_,_loc4_);
      ...
      private function getIndexOfNextObject(param1:int, param2:Boolean, param3:Boolean, param4:String) : int
      {
         ...
         var _loc10_:int = this.focusableCandidates.length;
      ...
      private function sortByDepth(param1:InteractiveObject, param2:InteractiveObject) : Number
      {
         ...
         try
         {
            ...
            {
               if((_loc4_ = (_loc3_ = this.getChildIndex(_loc9_.parent,_loc9_)).toString(16)).length < 4)
               {
         ...
         try
         {
            ...
            {
               if((_loc4_ = (_loc3_ = this.getChildIndex(_loc10_.parent,_loc10_)).toString(16)).length < 4)
               {
                  _loc5_ = _loc8_.substring(0,4 - _loc4_.length) + _loc4_;
               }
         ...
         return _loc6_ > _loc7_ ? Number(Number(1)) : (_loc6_ < _loc7_ ? Number(Number(-1)) : Number(Number(0)));
      }
      ...
      {
         return param1.tabIndex > param2.tabIndex ? 1 : (param1.tabIndex < param2.tabIndex ? -1 : int(int(this.sortByDepth(param1,param2))));
      }
