package fl.managers
{
   ...
   public class StyleManager
   {
      ...
      private static function getSharedStyle(param1:UIComponent, param2:String) : Object
      {
         ...
         var _loc5_:StyleManager = null;
         var _loc3_:Class = getClassDef(param1);
         if((_loc4_ = (_loc5_ = getInstance()).classToStylesDict[_loc3_][param2]) != null)
         {
            return _loc4_;
         }
         if((_loc4_ = _loc5_.globalStyles[param2]) != null)
         {
            return _loc4_;
         }
         return _loc5_.classToDefaultStylesDict[_loc3_][param2];
      }
