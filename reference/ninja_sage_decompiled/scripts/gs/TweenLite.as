package gs
{
   ...
   public class TweenLite
   {
      ...
      public function TweenLite(param1:Object, param2:Number, param3:Object)
      {
         ...
         this.vars = param3;
         this.duration = Number(Number(Number(Number(Number(param2))))) || Number(Number(Number(Number(Number(0.001)))));
         this.delay = Number(Number(Number(Number(Number(param3.delay))))) || Number(Number(Number(Number(Number(0)))));
         this._timeScale = Number(Number(Number(Number(Number(param3.timeScale))))) || Number(Number(Number(Number(Number(1)))));
         ...
         var _loc5_:int = param3.overwrite == undefined || !overwriteManager.enabled && param3.overwrite > 1 ? int(int(int(int(int(overwriteManager.mode))))) : int(int(int(int(int(int(param3.overwrite))))));
      ...
      public static function executeAll(param1:Event = null) : void
      {
         ...
         if(_listening)
         {
            ...
            for each(_loc3_ in _loc2_)
            {
               ...
               {
                  if(_loc3_[_loc4_] != undefined && _loc3_[_loc4_].active)
                  {
      ...
      public function render(param1:uint) : void
      {
         ...
         var _loc5_:int = 0;
         if((_loc2_ = (param1 - this.startTime) / 1000) >= this.duration)
         {
