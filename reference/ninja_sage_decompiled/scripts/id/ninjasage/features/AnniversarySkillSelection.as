package id.ninjasage.features
{
   ...
   public dynamic class AnniversarySkillSelection extends MovieClip
   {
      ...
      public function completeIcon(param1:Event) : *
      {
         ...
         (_loc4_ = param1.target.content.icon).stopAllMovieClips();
      ...
      public function searchItem(param1:MouseEvent) : *
      {
         ...
         while(_loc6_ < this.selectedCategory.length)
         {
            ...
            if((_loc4_ = SkillLibrary.getSkillInfo(_loc5_)) && _loc4_.hasOwnProperty("skill_name") && _loc4_["skill_name"].toLowerCase().indexOf(_loc3_) >= 0)
            {
               _loc2_.push(_loc5_);
            }
            _loc6_++;
