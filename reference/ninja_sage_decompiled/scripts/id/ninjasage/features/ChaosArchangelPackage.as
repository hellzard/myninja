   ...
   public dynamic class ChaosArchangelPackage extends MovieClip
   {
      ...
      private function playAnimationPreview(param1:MouseEvent = null) : void
      {
         ...
         else
         {
            ...
            _loc3_ = _loc2_.anims != null && _loc2_.anims.hasOwnProperty("standby") ? AnimationLibrary.getAnimation(_loc2_.anims.standby).label : "standby";
      ...
      public function gotoStandby() : void
      {
         ...
         var _loc2_:String = _loc1_.anims != null && _loc1_.anims.hasOwnProperty("standby") ? AnimationLibrary.getAnimation(_loc1_.anims.standby).label : "standby";
      ...
      private function playAnimation(param1:MouseEvent) : void
      {
         ...
         var _loc3_:String = param1.currentTarget.name == "standbyBtn" ? (_loc2_.anims != null && _loc2_.anims.hasOwnProperty("standby") ? AnimationLibrary.getAnimation(_loc2_.anims.standby).label : "standby") : _loc2_.attack_type;
         this.panelMC.panelMC.previewIdle.char_mc.gotoAndPlay(_loc3_);
      }
