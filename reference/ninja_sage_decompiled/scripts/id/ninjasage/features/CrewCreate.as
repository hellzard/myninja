package id.ninjasage.features
{
   ...
   public dynamic class CrewCreate extends MovieClip
   {
      ...
      public function onGetCrewsRes(param1:*, param2:* = null) : void
      {
         ...
         if(param1 != null && param1.hasOwnProperty("crews"))
         {
      ...
      public function searchCrew(param1:String = null) : Boolean
      {
         ...
         {
            return param1 && param1.id && String(param1.id).toLowerCase() === searchTerm;
         });
      ...
      private function onGetSearchRes(param1:Object, param2:* = null) : void
      {
         ...
         {
            _loc4_ = param1 && param1.errorMessage ? "Error: " + param1.errorMessage : "Crew not found. Please check the ID and try again.";
      ...
      {
         this.currentPage = 1;
         this.totalPage = param1 > 0 ? int(param1) : int(Math.ceil(this.crewData.length / 8));
