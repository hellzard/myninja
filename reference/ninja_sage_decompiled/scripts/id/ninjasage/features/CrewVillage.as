package id.ninjasage.features
{
   ...
   public dynamic class CrewVillage extends MovieClip
   {
      ...
      private function onMiniGameRes(param1:* = null, param2:* = null) : *
      {
         ...
         if(param1 != null && param1.hasOwnProperty("energy"))
         {
      ...
      {
         if(param1 != null && param1.hasOwnProperty("crew") && param1.hasOwnProperty("char") && this.crewData != null)
         {
      ...
      public function updateTimeleft() : void
      {
         ...
         var _loc7_:int;
         if((_loc7_ = Math.floor((_loc4_ - _loc5_ * _loc1_ - _loc6_ * _loc2_) / _loc3_)) >= 30)
         {
