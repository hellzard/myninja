package id.ninjasage.features
{
   ...
   public dynamic class ElementalArsPackage extends MovieClip
   {
      ...
      public function ElementalArsPackage(param1:*, param2:*)
      {
         this.outfits = [];
         this.gender = Character.character_gender;
         this.packageData = [];
         super();
         this.main = param1;
         this.panelMC = param2;
      ...
      private function initUI() : void
      {
         ...
         while(_loc1_ < this.packageData.length)
         {
            ...
            _loc2_ = !!this.main.isPaymentSupported() ? this.main.payment.getProductData("id.ninjasage.elementalars." + (_loc1_ + 1)).priceString : this.packageData[_loc1_].packagePrice;
      ...
      private function selectPackage(param1:MouseEvent = null) : void
      {
         ...
         this.panelMC.panelMC["item_" + this.selectedPackage].highlight.visible = true;
         this.panelMC.panelMC.txt_packageName.text = this.packageData[this.selectedPackage].packageName;
         this.panelMC.panelMC.btn_buy.metaData = {"packageId":"id.ninjasage.elementalars." + (this.selectedPackage + 1)};
         this.main.initButton(this.panelMC.panelMC.btn_buy,this.buyPack,!!this.main.isPaymentSupported() ? this.main.payment.getProductData("id.ninjasage.elementalars." + (this.selectedPackage + 1)).priceString : "Merchant");
         this.updateRewardPane();
         this.setUsedOutfit();
         this.loadIconPreview();
      }
      ...
      {
         var _loc1_:int = this.packageData[this.selectedPackage].packageOutfit.package_hair.length > 1 ? int(this.currentSet) : 0;
         var _loc2_:int = this.packageData[this.selectedPackage].packageOutfit.package_set.length > 1 ? int(this.currentSet) : 0;
         var _loc3_:int = this.packageData[this.selectedPackage].packageOutfit.package_back.length > 1 ? int(this.currentSet) : 0;
         var _loc4_:int = this.packageData[this.selectedPackage].packageOutfit.package_weapon.length > 1 ? int(this.currentSet) : 0;
         var _loc5_:int = this.packageData[this.selectedPackage].packageOutfit.package_accessory.length > 1 ? int(this.currentSet) : 0;
         var _loc6_:int = this.packageData[this.selectedPackage].packageOutfit.package_pet.length > 1 ? int(this.currentSet) : 0;
         var _loc7_:int = this.packageData[this.selectedPackage].packageOutfit.package_animation.length > 1 ? int(this.currentSet) : 0;
      ...
      private function initTooltipRightSide() : void
      {
         ...
         while(_loc1_ < this.packageData.length)
         {
            ...
            {
               if((_loc7_ = (_loc6_ = this.packageData[_loc1_].packageReward[_loc4_]).split("_")[0]) == "skill")
               {
      ...
      public function completePreviewSkill(param1:Event) : void
      {
         ...
         (_loc4_ = param1.target.content[this.selectedSkill]).gotoAndStop(1);
      ...
      private function getPackageData() : Object
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            if(_loc1_[_loc2_].code == "elementalars")
            {
