package id.ninjasage.features
{
   ...
   public dynamic class EncyclopediaEffect extends MovieClip
   {
      ...
      private var buffCategoryList:Array;
      
      private var debuffCategoryList:Array;
      ...
      {
         this.buffCategoryList = ["All","Offense","Defense","Hybrid"];
         this.debuffCategoryList = ["All","Offense","Defense","Control","Hybrid"];
         super();
      ...
      private function searchEffect(param1:MouseEvent) : void
      {
         ...
         {
            if((_loc6_ = (_loc5_ = _loc3_[_loc7_]).name.toLowerCase()).indexOf(_loc4_) >= 0)
            {
               _loc2_.push(_loc5_);
            }
            _loc7_++;
