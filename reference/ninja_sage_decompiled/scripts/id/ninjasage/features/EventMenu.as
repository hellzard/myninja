   ...
   public class EventMenu extends MovieClip
   {
      ...
      private function renderEventUI() : void
      {
         ...
         while(_loc1_ < 8)
         {
            ...
            {
               if(this.eventData[Character.event_current_tab][_loc2_].hasOwnProperty("icon") && (this.eventData[Character.event_current_tab][_loc2_].icon != null || this.eventData[Character.event_current_tab][_loc2_].icon != ""))
               {
      ...
      private function openEventPanel(param1:MouseEvent) : void
      {
         ...
         if(_loc2_.hasOwnProperty("inside") && _loc2_.inside)
         {
