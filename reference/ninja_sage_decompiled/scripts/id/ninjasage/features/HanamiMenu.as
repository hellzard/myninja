package id.ninjasage.features
{
   ...
   public class HanamiMenu extends MovieClip
   {
      ...
      public function HanamiMenu(param1:*, param2:*)
      {
         this.outfits = [];
         this.outfitsPreview = [];
         var _loc3_:Object = GameData.get("hanami2026");
      ...
      private function getEventData() : void
      {
         ...
         this.main.amf_manager.service("1MrX5OoGfy794qny.TgCCMOF3kQkY",[Character.char_id,Character.sessionkey],this.onGetEventData);
      }
      ...
      private function openBossBattle(param1:MouseEvent) : void
      {
         ...
         while(_loc2_ < 3)
         {
            this.panelMC.battleMC["boss_" + _loc2_].gotoAndStop("idle");
            this.eventHandler.addListener(this.panelMC.battleMC["boss_" + _loc2_],MouseEvent.CLICK,this.selectBoss);
            _loc2_++;
         }
         this.panelMC.battleMC["boss_0"].gotoAndStop("selected");
         this.panelMC.battleMC["boss_2"].gotoAndStop(this.response.ene_2122 == "locked" ? "locked" : "idle");
      }
      
      private function updateBossUI() : void
      {
         this.panelMC.battleMC.txt_name.text = this.bossData[this.selectedBoss].bossName;
         this.panelMC.battleMC.txt_desc.text = this.bossData[this.selectedBoss].bossDescription;
      ...
      {
         var _loc2_:int = int(param1.currentTarget.name.replace("boss_",""));
         if(this.selectedBoss == _loc2_ && this.panelMC.battleMC["boss_" + _loc2_].currentLabel == "selected")
         {
            return;
         }
         if(_loc2_ == 2 && this.panelMC.battleMC["boss_2"].currentLabel == "locked" && this.response.ene_2122 == "locked")
         {
            this.main.showMessage("You need to kill all previous bosses to unlock this boss.");
            return;
         }
         this.selectedBoss = _loc2_;
         this.panelMC.battleMC["boss_0"].gotoAndStop("idle");
         this.panelMC.battleMC["boss_1"].gotoAndStop("idle");
         this.panelMC.battleMC["boss_2"].gotoAndStop(this.response.ene_2122 == "locked" ? "locked" : "idle");
         this.panelMC.battleMC["boss_" + this.selectedBoss].gotoAndStop("selected");
         this.updateBossUI();
      }
      ...
      public function refillAmf(param1:MouseEvent) : *
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.TXBr4TKHsjAx",[Character.char_id,Character.sessionkey],this.refillResponse);
      }
      ...
      private function startBattle(param1:MouseEvent) : void
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.1jnnFfYXlAjx",[Character.char_id,_loc6_,_loc2_,_loc5_,_loc4_,Character.sessionkey],this.onStartEventAmf);
      }
      ...
      private function openMilestone(param1:MouseEvent) : *
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.kzKjdJjcP71K",[Character.char_id,Character.sessionkey],this.openMilestoneRewards);
         var _loc2_:* = 0;
         while(_loc2_ < 8)
         {
      ...
      private function onClaimBonusRequest(param1:MouseEvent) : *
      {
         ...
         this.main.amf_manager.service("1MrX5OoGfy794qny.wBGon3T4sr4o",[Character.char_id,Character.sessionkey,_loc2_],this.onClaimBonusResponse);
      }
      ...
      private function openRewardList(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Object = GameData.get("hanami2026");
      ...
      private function buySkill(param1:MouseEvent) : void
      {
         ...
         this.confirmation = null;
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.z274EQi4vhJp",[Character.char_id,Character.sessionkey,this.selectedBuySkill],this.buyResponse);
      }
      ...
      {
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.SSrORR6YXsQ4",[Character.char_id,Character.sessionkey],this.onGetPackageData);
      }
      ...
      private function buyPackage(param1:MouseEvent) : void
      {
         ...
         this.confirmation = null;
         this.main.loading(true);
         this.main.amf_manager.service("1MrX5OoGfy794qny.m7ZmVcn2tSJQ",[Character.char_id,Character.sessionkey],this.buyPackageResponse);
      }
      ...
      private function buyPackageResponse(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            this.main.giveReward(1,this.packageData.packageRewards,"hanami");
