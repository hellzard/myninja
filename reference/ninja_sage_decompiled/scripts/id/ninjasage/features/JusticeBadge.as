package id.ninjasage.features
{
   ...
   public dynamic class JusticeBadge extends MovieClip
   {
      ...
      private function initUI() : void
      {
         ...
         var _loc2_:int = this.rewardArray[0].id.replace("xp_","");
         var _loc3_:int = int(this.statManager.calculate_xp(int(Character.character_lvl)));
         var _loc4_:int = _loc3_ * _loc2_ / 100;
         var _loc5_:int = this.rewardArray[1].id.replace("gold_","");
         var _loc6_:int = this.rewardArray[2].id.replace("tp_","");
         var _loc7_:int = this.rewardArray[3].id.replace("ss_","");
