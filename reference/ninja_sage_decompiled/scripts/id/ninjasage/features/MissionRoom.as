package id.ninjasage.features
{
   ...
   public dynamic class MissionRoom extends MovieClip
   {
      ...
      private var gradeC:Array;
      
      private var gradeB:Array;
      
      private var gradeA:Array;
      
      private var gradeS:Array;
      
      private var gradeSS:Array;
      
      private var gradeTP:Array;
      
      private var gradeSpecial:Array;
      
      private var gradeDaily:Array;
      ...
      {
         this.outfits = [];
         this.gradeC = MissionLibrary.getMissionIds("c");
         this.gradeB = MissionLibrary.getMissionIds("b");
         this.gradeA = MissionLibrary.getMissionIds("a");
         this.gradeS = MissionLibrary.getMissionIds("s");
         this.gradeSS = MissionLibrary.getMissionIds("ss");
         this.gradeTP = MissionLibrary.getMissionIds("tp");
         this.gradeSpecial = MissionLibrary.getMissionIds("special");
         this.gradeDaily = MissionLibrary.getMissionIds("daily");
         super();
         this.main = param1;
