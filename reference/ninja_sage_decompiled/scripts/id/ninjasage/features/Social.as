package id.ninjasage.features
{
   ...
   public dynamic class Social extends MovieClip
   {
      ...
      {
         this.outfits = [];
         this.tabArray = ["allfriend","favorite","request","recommendation"];
      ...
      private function friendListResponse(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            ...
            this.isRecruitable = !!param1.hasOwnProperty("recruitable") ? Boolean(param1.recruitable) : Boolean(this.isRecruitable);
      ...
      private function openFriendProfile(param1:MouseEvent) : void
      {
         ...
         _loc2_ = param1.currentTarget.parent.name == "addFriendMC" ? true : Boolean(_loc2_);
      ...
      {
         var _loc2_:MovieClip = this.panelMC.friendListMC;
         var _loc3_:int = param1.currentTarget.parent.name.replace("friend_","");
      ...
      private function selectAllListUnfriend(param1:MouseEvent) : void
      {
         ...
         while(_loc3_ < 8)
         {
            if(!_loc2_.tick.tick.visible && this.friendData[_loc3_] && this.selectedIdArray.indexOf(this.friendData[_loc3_].id) == -1)
            {
      ...
      private function checkIfCurrentPageIsAllSelected() : Boolean
      {
         ...
         while(_loc1_ < 8)
         {
            if(this.friendData[_loc1_] && this.selectedIdArray.indexOf(this.friendData[_loc1_].id) == -1)
            {
               return false;
            }
            _loc1_++;
      ...
      {
         this.selectedFriendId = this.currentTab == "recommendation" ? int(param1.currentTarget.metaData.data.id) : int(this.selectedFriendId);
         this.main.loading(true);
      ...
      private function changeBorderColor(param1:MovieClip, param2:int) : void
      {
         ...
         if(_loc3_ != 0)
         {
            (_loc4_ = new ColorTransform()).color = _loc3_;
      ...
      private function getCharacterColor(param1:int) : uint
      {
         ...
         if(_loc2_ is Array)
         {
            return _loc2_.length > 0 ? uint(uint("0x" + String(_loc2_[0]).substr(1))) : uint(0);
         }
      ...
      private function applyGradient(param1:MovieClip, param2:Array, param3:Array, param4:Array) : void
      {
         ...
         var _loc7_:Matrix;
         (_loc7_ = new Matrix()).createGradientBox(_loc6_.width,_loc6_.height,0,_loc6_.x,_loc6_.y);
         var _loc8_:Sprite;
         (_loc8_ = new Sprite()).name = param1.parent.name + "_gradient";
         ...
         var _loc9_:int = _loc5_.getChildIndex(param1);
