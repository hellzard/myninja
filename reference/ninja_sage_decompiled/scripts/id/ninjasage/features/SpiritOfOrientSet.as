package id.ninjasage.features
{
   ...
   public dynamic class SpiritOfOrientSet extends MovieClip
   {
      ...
      public function SpiritOfOrientSet(param1:*, param2:*)
      {
         this.costumeData = {};
         super();
         this.main = param1;
      ...
      private function getDataResponse(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            ...
            this.costumeData = param1.packages.spiritoforient;
         }
      ...
      private function buyPackage(param1:MouseEvent) : void
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("UokNmLBKpsRnTHx2.ucqwx8rP1T7A",[Character.char_id,Character.sessionkey,"spiritoforient"],this.buyResponse);
      }
