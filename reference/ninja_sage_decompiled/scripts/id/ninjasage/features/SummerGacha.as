package id.ninjasage.features
{
   ...
   public dynamic class SummerGacha extends MovieClip
   {
      ...
      private static const MATERIAL_GACHA:String = "material_2267";
      ...
      public function SummerGacha(param1:*, param2:*)
      {
         this.outfits = [];
         var _loc3_:* = GameData.get("summer2026");
      ...
      private function getEventData() : void
      {
         ...
         this.main.amf_manager.service("urUACOuL6PahuoEd.8R2AXOjYQZCu",[Character.char_id,Character.sessionkey,Character.account_id],this.eventDataResponse);
      }
      ...
      private function sendAmf() : *
      {
         ...
         this.main.amf_manager.service("urUACOuL6PahuoEd.BYqyakm9cVvG",[Character.char_id,Character.sessionkey,this.playType,this.playQty],this.getGachaRewardsRes);
      }
      ...
      {
         this.main.giveReward(1,this.obtainedGachaRewards,"summer");
      }
      
      private function openBonusRewards(param1:MouseEvent) : void
      {
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.tPhojiP09mL0",[Character.char_id,Character.sessionkey,Character.account_id],this.openBonusRewardsRes);
      }
      ...
      private function openBonusRewardsRes(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            ...
            while(_loc2_ < this.bonusData.length)
            {
               ...
               this.panelMC.bonusMC["reward_" + _loc2_]["btn_claim"].visible = _loc3_;
               this.panelMC.bonusMC["reward_" + _loc2_]["txt_draw"].text = this.bonusData[_loc2_].rewardReq + " Draws";
               if(_loc3_)
               {
                  this.eventHandler.addListener(this.panelMC.bonusMC["reward_" + _loc2_]["btn_claim"],MouseEvent.CLICK,this.onClaimBonusRequest);
               }
               _loc2_++;
            }
      ...
      private function showRewardsBonus() : void
      {
         ...
         {
            this.panelMC.bonusMC["reward_" + _loc1_].iconMc.visible = true;
            this.panelMC.bonusMC["reward_" + _loc1_].iconMc.amountTxt.visible = false;
            this.panelMC.bonusMC["reward_" + _loc1_].iconMc.ownedTxt.visible = false;
            this.panelMC.bonusMC["reward_" + _loc1_].iconMc.btn_preview.visible = this.checkIsItemOrSkill(this.bonusData[_loc1_].rewardId);
            this.panelMC.bonusMC["reward_" + _loc1_].iconMc.btn_preview.metaData = {"itemId":this.bonusData[_loc1_].rewardId};
            this.eventHandler.addListener(this.panelMC.bonusMC["reward_" + _loc1_].iconMc.btn_preview,MouseEvent.CLICK,this.openPreview);
            if(Character.hasSkill(this.bonusData[_loc1_].rewardId) > 0)
            {
               this.panelMC.bonusMC["reward_" + _loc1_].iconMc.ownedTxt.visible = true;
               this.panelMC.bonusMC["reward_" + _loc1_].iconMc.ownedTxt.text = "Owned";
            }
            ...
            {
               this.panelMC.bonusMC["reward_" + _loc1_].iconMc.amountTxt.visible = true;
               this.panelMC.bonusMC["reward_" + _loc1_].iconMc.amountTxt.text = "x" + String(this.bonusData[_loc1_].rewardQty);
            }
            NinjaSage.loadItemIcon(this.panelMC.bonusMC["reward_" + _loc1_].iconMc,this.bonusData[_loc1_].rewardId);
            _loc1_++;
         }
      }
      ...
      private function onClaimBonusRequest(param1:MouseEvent) : void
      {
         ...
         this.main.amf_manager.service("urUACOuL6PahuoEd.219wdo55Q7Mp",[Character.char_id,Character.sessionkey,_loc2_],this.onClaimBonusResponse);
      }
      ...
      private function onClaimBonusResponse(param1:Object) : void
      {
         if(param1.status > 0)
         {
            if(param1.status == 1)
            {
               ...
               this.main.giveReward(1,param1.reward,"summer");
               this.panelMC.tokenTxt.text = String(Character.account_tokens);
      ...
      private function closeBonusRewards(param1:MouseEvent) : void
      {
         ...
         while(_loc2_ < 8)
         {
            this.panelMC.bonusMC["reward_" + _loc2_].iconMc.rewardIcon.tooltip = null;
            this.panelMC.bonusMC["reward_" + _loc2_].iconMc.skillIcon.tooltip = null;
            GF.removeAllChild(this.panelMC.bonusMC["reward_" + _loc2_].iconMc.rewardIcon.iconHolder);
            GF.removeAllChild(this.panelMC.bonusMC["reward_" + _loc2_].iconMc.skillIcon.iconHolder);
            _loc2_++;
         }
         this.panelMC.bonusMC.visible = false;
         System.gc();
      ...
      private function openHistory(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ == "personalBtn")
         {
            ...
            this.main.amf_manager.service("urUACOuL6PahuoEd.mUK5NbZx0g1J",[Character.char_id,Character.sessionkey],this.historyResponse);
         }
         else
         {
            this.panelMC.historyMC.titleTxt.text = "Global Prize History";
            this.main.amf_manager.service("urUACOuL6PahuoEd.wANN9uGdPEhl",[Character.char_id,Character.sessionkey],this.historyResponse);
         }
      }
      ...
      private function initHistory() : void
      {
         ...
         this.totalPageHistory = Math.max(1,Math.ceil(this.historyData.length / 5));
      ...
      private function renderHistoryList() : void
      {
         ...
         while(_loc1_ < 5)
         {
            _loc2_ = _loc1_ + int(int(this.currentPageHistory - 1) * 5);
