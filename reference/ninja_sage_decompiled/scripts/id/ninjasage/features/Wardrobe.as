package id.ninjasage.features
{
   ...
   public dynamic class Wardrobe extends MovieClip
   {
      ...
      public function Wardrobe(param1:*, param2:*, param3:*)
      {
         ...
         this.backHairMC = [];
         this.skirtMC = [];
         this.tabButton = ["mcHairstyle","mcSet","mcBackItem","mcWeapon","mcAccessory","mcPet"];
      ...
      public function equipItem(param1:MouseEvent) : *
      {
         ...
         var _loc4_:int = param1.currentTarget.parent.name.replace("item_","");
         if(_loc3_ == "wpn")
         {
            this.removeChildsFromMovieClip(this.panelMC.char_mc["weapon"]);
      ...
      public function searchItem(param1:MouseEvent) : *
      {
         ...
         while(_loc6_ < this.selectedCategory.length)
         {
            ...
            if((_loc4_ = Library.getItemInfo(_loc5_)) && _loc4_.hasOwnProperty("item_name") && _loc4_["item_name"].toLowerCase().indexOf(_loc3_) >= 0)
            {
      ...
      public function toolTiponOver(param1:MouseEvent) : *
      {
         ...
         var _loc4_:Array = _loc3_ && _loc3_.hasOwnProperty("item_source") ? _loc3_.item_source : null;
         var _loc5_:Array = _loc3_ && _loc3_.hasOwnProperty("skill_source") ? _loc3_.skill_source : null;
      ...
      public function sortItems(param1:Array) : *
      {
         ...
         {
            if((_loc2_ = param1[_loc6_].split("_"))[0] == "back" || _loc2_[0] == "accessory")
            {
               return param1;
            }
         }
         ...
         {
            if((_loc4_ = (_loc3_ = param1[_loc6_].split(":"))[0]) == PresetData.preset_wpn || _loc4_ == PresetData.preset_back || _loc4_ == PresetData.preset_acc || _loc4_ == PresetData.preset_set || _loc4_ == PresetData.preset_hair)
            {
