package id.ninjasage.features.exam.chunin.stage2
{
   ...
   public dynamic class Map_9 extends MovieClip
   {
      ...
      public function initMap() : void
      {
         ...
         if(!this._parent.map9_enemy_killed)
         {
            this._parent.getMap9Enemies(this.map_mc.enemy_mc);
         }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         else if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            this._parent.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.main.startStage2Battle1();
         }
