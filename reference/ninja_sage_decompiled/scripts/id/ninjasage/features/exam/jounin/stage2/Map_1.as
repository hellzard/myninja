package id.ninjasage.features.exam.jounin.stage2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[0],this.parent_mc.langFile.textArr[1],this.parent_mc.langFile.textArr[2],this.parent_mc.langFile.textArr[3]];
         this.main.showDialogue(_loc1_,null,"genzu");
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enterMc))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.exitMc))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
         }
