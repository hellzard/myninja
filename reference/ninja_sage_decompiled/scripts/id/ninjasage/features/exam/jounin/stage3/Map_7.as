package id.ninjasage.features.exam.jounin.stage3
{
   ...
   public dynamic class Map_7 extends MovieClip
   {
      ...
      public function Map_7(param1:*, param2:*, param3:*)
      {
      ...
      public function initMap() : void
      {
         ...
         this.map_mc.npcMc.visible = this._parent.total_seals == 2 || this._parent.kekkaiGame.completed;
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         else if(this.map_mc.char_mc.hitTestObject(this.map_mc.npcMc) && this.map_mc.npcMc.visible)
         {
            this.map_mc.npcMc.visible = false;
            this._parent.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this._parent.kekkaiGame.init(this.main,this._parent.kekkaiMC,this._parent,3,this);
