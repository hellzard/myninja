package id.ninjasage.features.exam.ninjatutor.stage1.chapter2
{
   ...
   public dynamic class Map_2 extends MovieClip
   {
      ...
      public function initMap() : void
      {
         ...
         if(!this.parent_mc.enemy4_killed)
         {
            this.parent_mc.getMapEnemies(this.map_mc.enemy_mc,4);
         }
         this.showDialogue1();
      }
      
      public function showDialogue1() : *
      {
      ...
      public function showDialogue2() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,null,this.parent_mc.getAsset("npcPain1"));
      }
      
      public function showFinalDialog() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[5]];
         this.main.showDialogueNew(_loc1_,this.finishStageS1C2,this.parent_mc.getAsset("npcPain1"));
      }
      
      public function finishStageS1C2() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("NinjaTutorExam.finishStage",[Character.char_id,Character.sessionkey,25,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startNinjaTutorS1C2Battle(4);
            this.map_mc.removeChild(this.map_mc.enemy_mc);
         }
         if(_loc4_)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
