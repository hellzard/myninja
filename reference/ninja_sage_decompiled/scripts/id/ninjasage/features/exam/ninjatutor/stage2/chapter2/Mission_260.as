package id.ninjasage.features.exam.ninjatutor.stage2.chapter2
{
   ...
   public class Mission_260 extends MovieClip
   {
      ...
      public function Mission_260(param1:*, param2:*)
      {
         super();
         this.main = param1;
         ...
         this.npcs = {
            ...
            "npcPain2":param2.npcPain2,
            "npcMonsterBlue":param2.npcMonsterBlue,
            "npcWhitePuppet":param2.npcWhitePuppet
         };
         this.player_mc = this.main.createPlayerMc();
         this.langFile = new Mission_260_Language();
      ...
      public function showFailDialog() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showFailDialog2,this.getAsset("npcMonsterBlue"));
      }
      
      public function showFailDialog2() : *
      {
         var _loc1_:* = [this.langFile.textArr[15]];
         this.main.showDialogueNew(_loc1_,this.destroy,this.getAsset("npcPain2"));
      }
