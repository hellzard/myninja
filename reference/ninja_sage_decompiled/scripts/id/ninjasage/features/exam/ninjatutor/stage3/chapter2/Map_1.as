package id.ninjasage.features.exam.ninjatutor.stage3.chapter2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function showDialogue() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue2,this.parent_mc.getAsset("npcBlueHair"));
      }
      ...
      public function showDialogue3() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue4,this.parent_mc.getAsset("npcPain3"));
      }
      ...
      public function showDialogue6() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue7,this.parent_mc.getAsset("npcPain3"));
      }
      ...
      public function showFinalDialog1() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.finishStageS3C2,this.parent_mc.getAsset("npcPain3"));
      }
      
      public function finishStageS3C2() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("NinjaTutorExam.finishStage",[Character.char_id,Character.sessionkey,29,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startNinjaTutorS3C2Battle(1);
