package id.ninjasage.features.exam.ninjatutor.stage5.chapter2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function showDialogue() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue2,this.parent_mc.getAsset("npcBrownHair"));
      }
      
      public function showDialogue2() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[1]];
         this.main.showDialogueNew(_loc1_,this.showDialogue3,this.parent_mc.getAsset("npcBlueHair"));
      }
      
      public function showDialogue3() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[2]];
         this.main.showDialogueNew(_loc1_,this.showDialogue4,this.parent_mc.getAsset("npcPain5"));
      }
      ...
      public function showFinalDialog2() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showFinalDialog3,null);
      }
      
      public function showFinalDialog3() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[7]];
         this.main.showDialogueNew(_loc1_,this.showFinalDialog4,null);
      }
      
      public function showFinalDialog4() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[8]];
         this.main.showDialogueNew(_loc1_,this.showFinalDialog5,this.parent_mc.getAsset("npcPain5"));
      }
      
      public function showFinalDialog5() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[9]];
         this.main.showDialogueNew(_loc1_,this.finishStageS5C2,null);
      }
      
      public function finishStageS5C2() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("NinjaTutorExam.finishStage",[Character.char_id,Character.sessionkey,33,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startNinjaTutorS5C2Battle(1);
