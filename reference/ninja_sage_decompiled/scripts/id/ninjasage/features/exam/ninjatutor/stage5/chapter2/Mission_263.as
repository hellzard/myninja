package id.ninjasage.features.exam.ninjatutor.stage5.chapter2
{
   ...
   public class Mission_263 extends MovieClip
   {
      ...
      public function Mission_263(param1:*, param2:*)
      {
         super();
         this.main = param1;
         this.panelMC = param2.panelMC;
         this.npcs = {
            "npcBrownHair":param2.npcBrownHair,
            "npcBlueHair":param2.npcBlueHair,
            "npcPain5":param2.npcPain5
         };
         this.player_mc = this.main.createPlayerMc();
         this.langFile = new Mission_263_Language();
      ...
      public function showFailDialog() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.destroy,this.getAsset("npcPain5"));
      }
