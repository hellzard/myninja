package id.ninjasage.features.exam.ninjatutor.stage6.chapter1
{
   ...
   public dynamic class Map_5 extends MovieClip
   {
      ...
      public function Map_5(param1:* = null, param2:* = null, param3:* = null)
      {
      ...
      public function initMap() : void
      {
         ...
         if(!this.parent_mc.enemy5_killed)
         {
            this.parent_mc.getMapEnemies(this.map_mc.enemy_mc,5);
         }
         this.showDialogue();
      }
      ...
      public function showFinalDialog() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.finishStageS6C1,null);
      }
      
      public function finishStageS6C1() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("NinjaTutorExam.finishStage",[Character.char_id,Character.sessionkey,34,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startNinjaTutorS6C1Battle(5);
