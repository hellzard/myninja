package id.ninjasage.features.exam.smission.stage4
{
   ...
   public dynamic class Map_4 extends MovieClip
   {
      ...
      public function initMap() : void
      {
         ...
         if(this.parent_mc.enemy5_killed && !this.parent_mc.enemy6_killed)
         {
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1) && this.parent_mc.enemy6_killed)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
