package id.ninjasage.features.exam.specialjounin.stage1.chapter2
{
   ...
   public dynamic class Map_2 extends MovieClip
   {
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_2) && this.parent_mc.map2_enemy_killed)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1) && this.parent_mc.map2_enemy_killed)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
