package id.ninjasage.features.exam.specialjounin.stage5.chapter2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function showDialogue() : *
      {
         ...
         this.main.showDialogue(_loc1_,this.showDialogue2,"npc_class");
      }
      ...
      public function showDialogue3() : *
      {
         ...
         this.main.showDialogue(_loc1_,this.showDialogue4,"perceive");
      }
      ...
      public function showDialogueHit() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[4]];
         this.main.showDialogue(_loc1_,this.startGame,"panda");
      }
      
      public function startGame() : *
      {
         this.main.startSpecialJouninS5C2Battle1();
      }
