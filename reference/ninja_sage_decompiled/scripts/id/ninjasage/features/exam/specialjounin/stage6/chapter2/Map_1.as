package id.ninjasage.features.exam.specialjounin.stage6.chapter2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function showDialogue2() : *
      {
         ...
         this.main.showDialogue(_loc1_,this.showDialogue3,"vadarnomask");
      }
      ...
      public function showDialogue4() : *
      {
         ...
         this.main.showDialogue(_loc1_,null,"vadarnomask");
      }
      ...
      {
         this.parent_mc.storyMC.visible = true;
         this.parent_mc.storyMC.gotoAndPlay(2);
         this.parent_mc.storyMC.addFrameScript(252,this.frame253);
      }
      
      public function frame253() : *
      {
         this.parent_mc.storyMC.stop();
         this.parent_mc.storyMC.visible = false;
         this.main.startSpecialJouninS6C2Battle1();
      }
   }
}
