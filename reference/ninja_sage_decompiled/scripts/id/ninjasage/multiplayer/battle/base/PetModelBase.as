package id.ninjasage.multiplayer.battle.base
{
   ...
   public class PetModelBase extends MovieClip
   {
      ...
      public function setScalingAndSaveStartingPosition() : *
      {
         ...
         if(this.pet_info && this.pet_info.hasOwnProperty("size_x") && this.pet_info.hasOwnProperty("size_y"))
         {
      ...
      public function setFrameScript() : void
      {
         ...
         {
            if(this.pet_info.attacks[_loc1_].anims && this.pet_info.attacks[_loc1_].anims.hit)
            {
               _loc3_ = 0;
            ...
            if(this.pet_info.attacks[_loc1_].anims && this.pet_info.attacks[_loc1_].anims.hasOwnProperty("fullscreen"))
            {
      ...
      {
         var _loc2_:int = 0;
         if(param1.indexOf("attack_") == 0 && this.pet_info && this.pet_info.attacks)
         {
