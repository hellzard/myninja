package id.ninjasage.pvp
{
   ...
   public class BattleResult extends MovieClip
   {
      ...
      public function initUI() : void
      {
         ...
         if(this.data && this.data.hasOwnProperty("id") && PvPBattleManager.PVP.character.getID() == this.data.id)
         {
         ...
         var _loc5_:* = 0;
         var _loc6_:* = 0;
         if(this.data && this.data.hasOwnProperty("rewards"))
         {
         ...
         while(_loc7_ < 4)
         {
            (_loc8_ = _loc2_["iconMc_" + _loc7_]).visible = false;
