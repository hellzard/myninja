package id.ninjasage.pvp.battle
{
   ...
   public class PvPActionManager
   {
      ...
      public function PvPActionManager(param1:String = "player", param2:int = 0, param3:Number = 0)
      {
         ...
         this._skill_icons = [];
         this._talent_icons = [];
         this._senjutsu_icons = [];
         this._character_skills_mc = [];
         this._character_senjutsu_skills_mc = [];
         this._character_talent_skills_mc = [];
         this._character_talent_passive_skills_mc = [];
         this._character_senjutsu_passive_skills_mc = [];
         this._character_talent_skills_info = [];
         this._character_senjutsu_skills_info = [];
         this._cooldown_info = {};
         super();
         this._team = param1;
      ...
      public function onSkillSWFLoaded(param1:*) : void
      {
         ...
         var _loc4_:Object;
         (_loc4_ = SkillLibrary.getCopy(this._loading_skill_id)).skill_id = this._loading_skill_id;
      ...
      public function onClassSkillSWFLoaded(param1:*) : *
      {
         ...
         if(param1.target.content[this._special_skill_id])
         {
            ...
            (_loc5_ = param1.target.content[this._special_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function onTalentSkillSWFLoaded(param1:*) : *
      {
         ...
         (_loc6_ = TalentSkillLevel.getTalentSkillLevels(this._loading_skill_id,PvPBattleManager.CHARACTER_MANAGERS[this._team][this._playerNumber].getTalentLevel(this._loading_skill_id))).skill_id = this._loading_skill_id;
         if(param1.target.content[this._loading_skill_id])
         {
            (_loc13_ = param1.target.content[this._loading_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function onSenjutsuSkillSWFLoaded(param1:*) : *
      {
         ...
         var _loc11_:* = false;
         (_loc4_ = SenjutsuSkillLevel.getSenjutsuSkillLevels(this._loading_skill_id,PvPBattleManager.CHARACTER_MANAGERS[this._team][this._playerNumber].getSenjutsuLevel(this._loading_skill_id))).skill_id = this._loading_skill_id;
         _loc11_ = _loc4_.cooldown == 0;
         if(param1.target.content[this._loading_skill_id] && !_loc11_)
         {
            (_loc9_ = param1.target.content[this._loading_skill_id]).gotoAndStop(1);
            if(true)
            {
      ...
      public function copySkillSWFLoaded(param1:*) : void
      {
         ...
         var _loc4_:*;
         (_loc4_ = param1.target.content[this._copy_skill_id]).gotoAndStop(1);
         if(true)
         {
      ...
      public function getSkillHandlerByID(param1:String) : PvPSkillHandler
      {
         var _loc3_:* = undefined;
         var _loc4_:* = undefined;
         if(this._special_skill_handler && this._special_skill_handler.skill_info.skill_id == param1)
         {
            return this._special_skill_handler;
         }
         if(this._copy_skill_handler && this._copy_skill_handler.skill_info.skill_id == param1)
         {
