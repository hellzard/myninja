package id.ninjasage.pvp.battle
{
   ...
   public class PvPAgilityBarManager
   {
      ...
      public function onStartAttackBar(param1:Object) : void
      {
         ...
         this._authoritativeWinnerId = param1 && param1.hasOwnProperty("w") && param1.w != null ? String(param1.w) : "";
         ...
         for(_loc5_ in param1.x)
         {
            ...
            if(_loc9_)
            {
               ...
               _loc14_ = !!_loc9_.headMc ? Number(Number(_loc9_.headMc.x)) : Number(Math.min(_loc11_,ACTION_BAR_WIDTH));
               _loc15_ = !!_loc13_ ? Number(0) : Number(_loc14_);
      ...
      public function applySpectatorSync(param1:Object) : void
      {
         ...
         for(_loc5_ in param1.x)
         {
            ...
            if(_loc9_)
            {
               _loc11_ = (_loc10_ = Number(_loc6_.p || 0)) == 0 && Number(_loc6_.s || 0) == 0 && Number(_loc6_.n || 0) == 0;
               _loc9_.agility = _loc8_;
               _loc9_.x = _loc10_;
               _loc9_.startX = 0;
               _loc9_.visualX = Math.min(_loc10_,ACTION_BAR_WIDTH);
      ...
      private function buildHeadMap() : Object
      {
         ...
         var _loc1_:Object = {};
         var _loc2_:int = this._teamHeadMcAgility.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            if(_loc4_ = this._teamHeadMcAgility[_loc3_])
            {
      ...
      private function updateEntityAgility(param1:String, param2:Number) : void
      {
         ...
         {
            if(_loc4_ = PvPBattleManager.getPetManagerByID(param1))
            {
      ...
      private function showEntitiesImmediately() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            while(_loc5_ < _loc4_.length)
            {
               ...
               if(_loc7_ = this._battle.getObjectHolder(_loc6_.getPlayerTeam(),_loc6_.getPlayerNumber()))
               {
                  _loc7_.alpha = 1;
                  _loc7_.visible = true;
               }
      ...
      private function checkPendingPetHead() : void
      {
         ...
         for(_loc2_ in this._playersMcHolders)
         {
            if(_loc2_.indexOf("pet") >= 0)
            {
               ...
               if(_loc3_)
               {
                  if(_loc4_ = this.getPetManager(_loc3_))
                  {
                     if(!(_loc5_ = _loc4_.getPetModel()))
                     {
                        _loc1_.push(_loc2_);
                     }
                     else if(!(_loc6_ = _loc5_.getHead()))
                     {
                        _loc1_.push(_loc2_);
                     }
                  }
         ...
         for(_loc2_ in this._playersMcHolders)
         {
            ...
            if(_loc3_)
            {
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc7_)
                  {
                     if(_loc13_ = _loc5_.getPetModel())
                     {
                        _loc8_ = _loc13_.getHead();
                     }
                  }
                  else if(_loc14_ = _loc4_.getCharacterModel())
                  {
                  ...
                  if(_loc8_)
                  {
                     ...
                     if((_loc11_ = _loc6_.getAgility()) > _loc1_)
                     {
                        _loc1_ = _loc11_;
                     }
      ...
      {
         param1.x = 0;
         param1.y = !!param3 ? Number(HEAD_Y_PLAYER) : Number(HEAD_Y_ENEMY);
         param1.scaleX = !!param2.isCharacter() ? Number(HEAD_SCALE) : Number(-HEAD_SCALE);
      ...
      private function addHeadsToActionBar() : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc3_ && _loc3_.parent != _loc1_)
            {
               if(_loc3_.parent)
               {
      ...
      public function updateAgilityToActionBar() : void
      {
         ...
         if(this._actionBar && this._actionBar.hasOwnProperty("holder"))
         {
            ...
            _loc10_ = this._teamHeadMcAgility.length - 1;
            while(_loc10_ >= 0)
            {
               if((_loc11_ = this._teamHeadMcAgility[_loc10_].headMc as MovieClip) && _loc11_.parent == _loc9_)
               {
      ...
      private function renderServerFrame() : void
      {
         ...
         while(_loc2_ < this._teamHeadMcAgility.length)
         {
            ...
            if(_loc3_ != null)
            {
               if((_loc4_ = this._serverFrame[String(_loc3_.id)]) != null)
               {
                  if((_loc7_ = Number(_loc4_.p || 0)) < 0)
                  {
                     _loc7_ = 0;
                  }
                  _loc3_.x = _loc7_;
                  _loc3_.visualX = Math.min(_loc7_,ACTION_BAR_WIDTH);
                  if(_loc8_ = this._authoritativeWinnerId != "" && this.isSameEntity(this._authoritativeWinnerId,_loc3_.id))
                  {
                     _loc1_ = _loc2_;
                  }
                  if(_loc7_ > _loc6_)
      ...
      public function checkAmbush() : void
      {
         ...
         var _loc3_:Array = [];
         var _loc4_:Number;
         if((_loc4_ = this.prepareAmbushState(_loc1_,_loc2_,_loc3_)) == Number.MAX_VALUE)
         {
            this.stop();
            return;
         }
         var _loc5_:int;
         if((_loc5_ = this.applyAmbushMovement(_loc4_,_loc1_,_loc2_)) >= 0)
         {
      ...
      private function prepareAmbushState(param1:Array, param2:Array, param3:Array) : Number
      {
         ...
         while(_loc5_ < this._teamHeadMcAgility.length)
         {
            ...
            if(_loc7_ = this.getManagerForEntry(_loc6_))
            {
               ...
               else if((_loc10_ = this.getAmbushSpeed(Number(_loc6_.agility))) > 0)
               {
                  _loc11_ = Number(_loc6_.x);
                  param1[_loc5_] = _loc11_;
                  param2[_loc5_] = _loc10_;
                  if((_loc13_ = (_loc12_ = Number(ACTION_BAR_WIDTH - _loc11_)) <= 0 ? Number(1) : Number(Math.ceil(_loc12_ / _loc10_))) < _loc4_)
                  {
                     _loc4_ = _loc13_;
                  }
               }
      ...
      private function resetAmbushStateForEntry(param1:Object, param2:String, param3:MovieClip) : void
      {
         ...
         this._lastAmbushKey = "";
         var _loc4_:Number = this._plusXNextRound[param2] != null ? Number(Number(this._plusXNextRound[param2])) : Number(0);
         param1.x = _loc4_;
         if(param3)
         {
            param3.x = _loc4_;
      ...
      private function applyAmbushMovement(param1:Number, param2:Array, param3:Array) : int
      {
         ...
         while(_loc6_ < this._teamHeadMcAgility.length)
         {
            ...
            if(_loc8_ = this.getManagerForEntry(_loc7_))
            {
               ...
               {
                  if((_loc10_ = Number(param2[_loc6_]) + param1 * Number(param3[_loc6_])) >= ACTION_BAR_WIDTH)
                  {
                     if(_loc4_ < 0)
                     {
                        _loc4_ = _loc6_;
         ...
         if(_loc4_ >= 0)
         {
            ...
            while(_loc6_ < this._teamHeadMcAgility.length)
            {
               ...
               {
                  _loc7_ = this._teamHeadMcAgility[_loc6_];
                  if(!(!(_loc8_ = this.getManagerForEntry(_loc7_)) || _loc8_.isDead()))
                  {
                     if((_loc12_ = Number(param2[_loc6_]) + param1 * Number(param3[_loc6_])) >= ACTION_BAR_WIDTH)
                     {
                        _loc13_ = String(_loc8_.getID());
                        delete this._plusXNextRound[_loc13_];
                        _loc14_ = !!_loc7_.headMc ? Number(Number(_loc7_.headMc.x)) : Number(Number(param2[_loc6_]));
      ...
      private function resolveAuthoritativeAmbushIndex(param1:int, param2:Array, param3:Array, param4:Number) : int
      {
         ...
         while(_loc5_ < this._teamHeadMcAgility.length)
         {
            if(!((_loc6_ = this._teamHeadMcAgility[_loc5_]) == null || String(_loc6_.id) != this._authoritativeWinnerId))
            {
               if(!(_loc7_ = this.getManagerForEntry(_loc6_)) || _loc7_.isDead() || param3[_loc5_] == null)
               {
                  return param1;
               }
               _loc8_ = String(_loc7_.getID());
      ...
      private function triggerAmbushAnimation(param1:int, param2:Array) : void
      {
         ...
         if(_loc3_.headMc && this._actionBar && this._actionBar.hasOwnProperty("holder"))
         {
         ...
         {
            if(!(!(_loc7_ = (_loc6_ = this._teamHeadMcAgility[_loc4_]).headMc as MovieClip) || _loc6_.isDead))
            {
      ...
      private function isSameEntity(param1:*, param2:*) : Boolean
      {
         ...
         var _loc7_:* = _loc3_.indexOf("_pet") >= 0;
         var _loc8_:* = _loc4_.indexOf("_pet") >= 0;
         return _loc7_ == _loc8_;
      }
      ...
      public function destroy() : void
      {
         ...
         if(this._actionBar && this._actionBar.hasOwnProperty("holder"))
         {
            ...
            if(_loc1_)
            {
               ...
               {
                  _loc3_ = this._teamHeadMcAgility[_loc2_];
                  if(_loc3_ && _loc3_.headMc)
                  {
                     if(_loc4_ = _loc3_.headMc as MovieClip)
                     {
