package id.ninjasage.pvp.battle
{
   ...
   public class PvPBattleHandler
   {
      ...
      private function handleSpectatorSync(param1:Object) : void
      {
         ...
         if(param1.hasOwnProperty("attackBar") && PvPBattleManager.AGILITY_BAR_MANAGER)
         {
            PvPBattleManager.AGILITY_BAR_MANAGER.applySpectatorSync(param1.attackBar);
         }
         this.syncSpectatorTurnState(!!param1.hasOwnProperty("activeTurnCharId") ? param1.activeTurnCharId : null,!!param1.hasOwnProperty("turnUsed") ? param1.turnUsed === true : true,!!param1.hasOwnProperty("remainingTurnSeconds") ? int(int(param1.remainingTurnSeconds)) : 0);
      }
      ...
      private function handleBattleElapsedSync(param1:Object) : void
      {
         ...
         if(param1.hasOwnProperty("isBerserkActive") && param1.isBerserkActive && !this._berserkActive)
         {
      ...
      private function resolveElapsedTimerTextTarget(param1:Object) : Object
      {
         ...
         for each(_loc2_ in ELAPSED_TIMER_TARGETS)
         {
            if(!(!param1.hasOwnProperty(_loc2_) || !param1[_loc2_]))
            {
               ...
               if(_loc3_.hasOwnProperty("txt") && _loc3_.txt && _loc3_.txt.hasOwnProperty("text"))
               {
                  return _loc3_.txt;
               }
      ...
      public function handleAmbushAction(param1:Object) : void
      {
         ...
         if(PvPBattleManager.getIsSpectator())
         {
            this.syncSpectatorTurnState(param1.id,false,param1 && param1.hasOwnProperty("remainingTurnSeconds") ? int(int(param1.remainingTurnSeconds)) : int(BattleTimer.DEFAULT_TURN_DURATION_SECONDS));
            return;
         }
      ...
      public function handleChargeAction(param1:Object) : void
      {
         ...
         if(param1.error && param1.id == PvPBattleManager.PVP.character.getID())
         {
      ...
      public function handleSkillAction(param1:Object) : void
      {
         ...
         this.stopTurnTimer();
         this._actions.push(param1);
         if(param1.hasOwnProperty("copySkill") && param1.copySkill)
         {
      ...
      public function handleHit(param1:* = null) : void
      {
         ...
         if(_loc5_ && _loc2_.hasOwnProperty("stat"))
         {
         ...
         {
            _loc7_ = _loc2_.hasOwnProperty("dodged") && _loc2_.dodged ? "dodge" : "hit";
      ...
      public function handleUpdateInfo(param1:Object) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = PvPBattleManager.getCharacterManagerByID(param1.id);
         if(param1.hasOwnProperty("skillCooldowns") && _loc3_)
         {
            _loc3_.getActionManager().updateSkillsCooldownDisplay(param1.skillCooldowns);
         }
         if(param1.hasOwnProperty("stat") && _loc3_)
         {
            _loc3_.updateStats(param1.stat);
            _loc3_.getCharacterModel().refreshStats(_loc3_,this._battle);
            _loc3_.getActionManager().updateSageModeButton();
         }
         if(_loc3_ && _loc3_.getID() == PvPBattleManager.PVP.character.getID() && param1.hasOwnProperty("scrolls"))
         {
            _loc3_.updateScrolls(param1.scrolls);
            _loc3_.getActionManager().updateScrollsDisplay();
         }
      ...
      private function handleTieBreaker(param1:Object) : void
      {
         ...
         for(_loc2_ in PvPBattleManager.CHARACTER_MANAGERS)
         {
            ...
            {
               if((_loc6_ = PvPBattleManager.CHARACTER_MANAGERS[_loc2_][_loc5_]) && _loc6_.getActionManager())
               {
         ...
         if(this._battle && this._battle.actionBar)
         {
            this._battle.actionBar.visible = false;
         }
         var _loc3_:int = !!param1.hasOwnProperty("durationMs") ? int(int(param1.durationMs)) : 4000;
         var _loc4_:Array;
         if(_loc4_ = param1.stats as Array)
         {
            _loc7_ = 0;
            while(_loc7_ < _loc4_.length)
            {
               _loc8_ = _loc4_[_loc7_];
               if((_loc9_ = PvPBattleManager.getCharacterManagerByID(String(_loc8_.id))) && _loc9_.getCharacterModel())
               {
      ...
      protected function handleCloseBattle(param1:MouseEvent) : void
      {
         ...
         if(PvPBattleManager.getIsSpectator() && PvPBattleManager.PVP)
         {
