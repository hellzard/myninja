package id.ninjasage.pvp.battle
{
   ...
   public class PvPBattleLoader
   {
      ...
      public function onPlayerInfo(param1:Object) : void
      {
         ...
         if(param1.set.hasOwnProperty("char_pet") && param1.set.char_pet != null && param1.set.char_pet.hasOwnProperty("pet"))
         {
            _loc2_ = "player_pet";
      ...
      private function setupOwnEffectTooltip() : void
      {
         ...
         if(_loc1_ && _loc1_.hasOwnProperty("btn_info") && _loc1_.btn_info)
         {
      ...
      private function hideUIElements(param1:Boolean = false) : void
      {
         ...
         if(param1)
         {
            ...
            {
               if(_loc4_ = this._battle.btn_UI_Gear)
               {
