package id.ninjasage.sounds
{
   ...
   public class SoundManager
   {
      ...
      {
         return this.play(param1,!!this._enableSfx ? Number(param2) : Number(0),param3,param4,true);
      }
      ...
      {
         var _loc4_:SoundInstance;
         if((_loc4_ = this.instancesByType[param2]) && _loc4_.url == param1)
         {
            return;
         }
         (_loc4_ = new SoundInstance(null,param2)).url = param1;
      ...
      function addTween(param1:String, param2:Number, param3:Number, param4:Number, param5:Boolean) : SoundTween
      {
         ...
         var _loc7_:SoundTween;
         (_loc7_ = new SoundTween(_loc6_,param3,param4)).stopAtZero = param5;
