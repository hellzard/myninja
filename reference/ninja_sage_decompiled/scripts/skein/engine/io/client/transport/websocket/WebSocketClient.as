package skein.engine.io.client.transport.websocket
{
   ...
   public class WebSocketClient implements IWebSocketLogger
   {
      ...
      protected function create(param1:String, param2:Array, param3:String = null, param4:int = 0, param5:String = null) : void
      {
         ...
         var _loc6_:WebSocket;
         (_loc6_ = new WebSocket(this.getId(),param1,param2,this.getOrigin(),param3,param4,this.getCookie(param1),param5,this)).addEventListener(WebSocketEvent.OPEN,this.socketOpenHandler);
      ...
      {
         var _loc2_:* = "xmlsocket://" + this.getHostname() + ":843";
      ...
      {
         return !!this.dataSource ? int(this.dataSource.webSocketClientID()) : 0;
      }
