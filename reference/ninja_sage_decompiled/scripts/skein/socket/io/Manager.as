package skein.socket.io
{
   ...
   public class Manager extends Emitter
   {
      ...
      private function initOptions(param1:Options) : Options
      {
         ...
         this.reconnectionAttempts(int(param1.reconnectionAttempts) || int(int.MAX_VALUE));
         this.reconnectionDelay(Number(param1.reconnectionDelay) || Number(1000));
         this.reconnectionDelayMax(Number(param1.reconnectionDelayMax) || Number(5000));
         this.timeout(param1.timeout < 0 ? Number(10000) : Number(param1.timeout));
         return param1;
      }
      ...
      public function open(param1:Function = null) : Manager
      {
         ...
         var errorSub:OnHandle = On.on(this.engine,Engine.EVENT_ERROR,function(param1:Object = null):void
         {
            cleanup();
      ...
      function destroy(param1:Socket) : void
      {
      ...
      function packet(param1:Packet) : void
      {
