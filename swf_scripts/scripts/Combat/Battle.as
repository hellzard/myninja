package Combat
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6356")]
   public class Battle extends MovieClip
   {
      ...
      {
         if(this.character_team_players.length > 0 && Boolean(this.character_team_players[0].isCharacter()))
         {
      ...
      private function reEnableKeyboardIfPlayerTurn() : void
      {
         ...
         if(this.character_team_players.length > 0 && Boolean(this.character_team_players[0].isCharacter()))
         {
            ...
            if(Boolean(_loc1_.action_bar) && Boolean(_loc1_.action_bar.visible))
            {
      ...
      public function setElementsForStage4() : *
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            if(!_loc2_[_loc3_])
            {
               _loc4_ = this.enemy_team_players[_loc3_].setModes(Character.stage_mode,_loc1_[_loc3_]);
               if(!_loc4_ && _loc3_ == 0)
               {
                  _loc2_[1] = true;
                  _loc4_ = this.enemy_team_players[1].setModes(Character.stage_mode,_loc1_[_loc3_]);
                  if(!_loc4_)
                  {
                     _loc2_[2] = true;
      ...
      public function setupViewForAmbush(param1:String, param2:int, param3:Boolean = false) : void
      {
         ...
         if(Boolean(_loc4_.isCharacter()) && Boolean(_loc4_.isDead()) && BattleVars.PLAY_DEAD_ANIMATION == "CHAR")
         {
         ...
         if(!_loc4_.isCharacter() && Boolean(_loc4_.isDead()))
         {
            BattleManager.startRun();
            return;
         }
         if(Boolean(_loc6_.checkActivateUnyielding()) || Boolean(_loc6_.checkReviveEOM()))
         {
            return;
         }
         if(Boolean(_loc4_.isCharacter()) && Boolean(_loc4_.isDead()))
         {
            BattleManager.startRun();
            return;
         }
         ...
         {
            _loc9_ = _loc4_.actions_manager;
            _loc9_.updateSkillsCooldownDisplay();
      ...
      private function handlePlayerTurn() : void
      {
         ...
         if(Boolean(Character.is_jounin_stage_4) && ++this.current_round > 1)
         {
      ...
      {
         return this.attacker_model != null && Boolean(this.attacker_model.isEnemy()) && this.isDebugEncyclopediaEnemyControl(this.attacker_model.getPlayerTeam(),this.attacker_model.getPlayerNumber());
      }
      ...
      private function showDebugEnemySkillPanel() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            _loc4_ = this.createDebugEnemySkillButton(_loc3_,int(_loc2_[_loc3_]));
            _loc4_.x = int(_loc3_ % 3) * 66;
      ...
      private function createDebugEnemySkillButton(param1:int, param2:int) : MovieClip
      {
         ...
         _loc3_.alpha = _loc4_ ? 1 : 0.45;
         _loc3_.graphics.beginFill(_loc4_ ? 5973256 : 2960685,0.92);
         _loc3_.graphics.lineStyle(2,_loc4_ ? 15843890 : 7829367);
         _loc3_.graphics.drawRoundRect(0,0,60,60,10,10);
         _loc3_.graphics.endFill();
         var _loc5_:TextField = new TextField();
         _loc5_.defaultTextFormat = new TextFormat("_sans",21,16777215,true,null,null,null,null,"center");
         _loc5_.width = 60;
         _loc5_.height = 28;
         _loc5_.y = param2 > 0 ? 7 : 16;
         ...
         if(param2 > 0)
         {
            ...
            _loc6_.defaultTextFormat = new TextFormat("_sans",14,16763904,true,null,null,null,null,"center");
            _loc6_.width = 60;
            _loc6_.height = 20;
            _loc6_.y = 36;
      ...
      public function handleSkipTurns(param1:String, param2:String, param3:int) : *
      {
         ...
         var _loc6_:Boolean = ["barrier","chaos","pet_chaos"].indexOf(param1) != -1;
      ...
      private function removeEffect(param1:Vector.<Object>, param2:String) : void
      {
         ...
         if(param1.length > 0)
         {
            ...
            for(; _loc3_ >= 0; _loc3_--)
            {
               ...
               if(param2 == "disperse")
               {
                  if(Boolean("no_disperse" in _loc4_) && Boolean(_loc4_.no_disperse) || Effects.doesEffectCannotDisperse(_loc4_.effect))
                  {
                     continue;
                  }
               }
               ...
               {
                  if(Boolean("no_purify" in _loc4_) && Boolean(_loc4_.no_purify) || Effects.doesEffectCannotPurified(_loc4_.effect))
                  {
                     continue;
                  }
               }
      ...
      private function handlePurify(param1:Array, param2:Object) : void
      {
         ...
         if(Boolean(param2.effects_manager.hadEffect("negate")) && param1[0].effect != "sensation")
         {
            return;
         }
         var _loc3_:int = 0;
      ...
      public function handleDamageAndEffects() : void
      {
         ...
         var _loc7_:String = this.geetTarget(_loc5_) + "_model";
         ...
         if(!_loc5_)
         {
            ...
            {
               if(!(_loc10_ == null || _loc10_.health_manager == null || Boolean(_loc10_.isDead())))
               {
            ...
            _loc12_ = int(_loc6_.effects_manager.checkAoeAttackerDamage("recoil_curse",_loc9_));
            if(_loc12_ > 0)
            {
               for each(_loc14_ in _loc8_)
               {
                  if(!(_loc14_ == null || _loc14_.health_manager == null || Boolean(_loc14_.isDead())))
                  {
      ...
      private function handlingEffects(param1:Array) : void
      {
         ...
         for each(effect in effects)
         {
            if(!effect.is_passive)
            {
               try
               {
                  effectType = Boolean(effect.is_self_buff) || Boolean(effect.is_master_buff) || Boolean(effect.is_buff) || Boolean(effect.is_self) && Boolean(!effect.is_debuff) ? "buff" : "debuff";
      ...
      private function setEffect(param1:String, param2:Object) : *
      {
         ...
         switch(param1)
         {
            case "self":
               if(param2.multi_hit)
               {
                  _loc4_ = String(this.attacker_model.getPlayerTeam());
                  _loc3_ = _loc4_ == "player" ? this.character_team_players : this.enemy_team_players;
               }
               else
               {
      ...
      private function applyEffect(param1:Array, param2:Object, param3:String) : *
      {
         ...
         for(; _loc4_ < param1.length; _loc4_++)
         {
            ...
            if(!(_loc5_ == null || _loc5_.health_manager == null))
            {
               if(param3 === "Debuff")
               {
                  if(_loc5_.isDead())
               ...
               if(param2.hasOwnProperty("conditional") && Boolean(param2.conditional))
               {
                  if(param2.effect === "ultra_burning")
                  {
                     ...
                     for each(_loc7_ in _loc5_.effects_manager.dataDebuff)
                     {
                        ...
                        {
                           if(!(_loc7_.effect === "burn" && _loc7_.hasOwnProperty("exclude_from_conditional") && Boolean(_loc7_.exclude_from_conditional)))
                           {
                              _loc6_ = true;
                              break;
                           }
      ...
      private function handlingExtraEffects(param1:String) : void
      {
         ...
         if(param1 == "skill_2359" && (Boolean(this.defender_model.effects_manager.hadEffect("bleeding")) || Boolean(this.defender_model.effects_manager.hadEffect("pet_bleeding"))))
         {
            _loc2_ = {
               "passive":false,
               "type":"Debuff",
      ...
      private function handlingDamage(param1:Object, param2:int, param3:int = 1) : void
      {
         ...
         var _loc4_:Boolean = Boolean(param1.effects_manager.checkForShedding());
         if(_loc4_)
         {
         ...
         var _loc5_:Boolean = Boolean(this.attacker_model.effects_manager.handleLightMatter());
         ...
         var _loc6_:Boolean = Boolean(this.attacker_model.effects_manager.handleDarkMatter());
         if((_loc6_) && !param1.IS_BLOCK_DAMAGE)
         {
         ...
         var _loc7_:Object = param1.effects_manager;
         _loc7_.wakePlayer();
         ...
         param2 = int(this.attacker_model.effects_manager.calculateDamage(param2,param1,_loc9_));
         ...
         param2 = int(_loc7_.checkAbsorbDamage(param1,param2));
         ...
         var _loc12_:Boolean = Boolean(param1.checkConvertDamage());
         if(_loc12_)
         {
      ...
      public function isMainPlayerOrControllable(param1:String, param2:int) : Boolean
      {
         ...
         return Boolean(Character.teammate_controllable) && param1 == "player" && Boolean(this.character_team_players[param2].isCharacter());
      }
      ...
      public function hitByTalentSkill(param1:String, param2:int, param3:String) : void
      {
         var isTrue:Boolean;
         var titan:Boolean;
         var emberstep_demonic:Boolean;
         var targetTeam:String;
         var targetNum:int;
         var talentLevel:int;
         var talent:Object;
         var skillTarget:Boolean;
         var talentDamage:int;
         var isMultiHit:*;
         ...
         isTrue = false;
         titan = Boolean(this.attacker_model.effects_manager.hadEffect("titan_mode"));
         emberstep_demonic = Boolean(this.attacker_model.effects_manager.hadEffect("emberstep_demonic"));
         targetTeam = team == "player" ? "enemy" : "player";
         targetNum = team == "player" ? BattleVars.PLAYER_TARGET : BattleVars.ENEMY_TARGET;
         try
         {
         ...
         talentLevel = int(this.attacker_model.character_manager.getTalentLevel(skillId));
         talent = TalentSkillLevel.getCopy(skillId,talentLevel);
         talent.talent_skill_damage = Math.floor(talent.talent_skill_damage * this.attacker_model.character_manager.getLevel());
         skillTarget = "skill_target" in talent && talent.skill_target == "Self" ? true : false;
         talentDamage = int(talent.talent_skill_damage);
         ...
         isMultiHit = talent.target == "All" ? true : talent.multi_hit;
      ...
      public function hitBySenjutsuSkill(param1:String, param2:int, param3:String) : *
      {
         ...
         var _loc5_:int = param1 == "player" ? BattleVars.PLAYER_TARGET : BattleVars.ENEMY_TARGET;
      ...
      public function checkDamageAfterCriticalAndCombustion(param1:*) : int
      {
         ...
         if(BattleVars.IS_CRITICAL)
         {
            ...
            {
               _loc5_ = int(this.attacker_model.effects_manager.dataBuff.length);
               if(_loc5_ > 0)
               {
      ...
      public function playHitAnimation(param1:String, param2:int, param3:String) : void
      {
         ...
         var _loc6_:Boolean = param1 == "player";
         ...
         var _loc19_:Boolean = _loc18_ == "Self";
         BattleVars.IS_GENJUTSU = _loc17_.skill_type == 7;
         BattleVars.SKILL_USED_TYPE = _loc17_.skill_type;
         BattleVars.IS_SELF_SKILL = _loc19_;
         if(Boolean(this.defender_model && this.defender_model.isCharacter()) && Boolean(!_loc19_) && _loc17_.skill_type == 7)
         {
         ...
         switch(param3)
         {
            ...
            case "skill_2113":
               ...
               if(_loc10_ && Boolean(this.defender_model))
               {
                  this.defender_model.IS_DODGED = false;
               }
               if(Boolean(!_loc10_) && Boolean(this.defender_model) && !this.defender_model.IS_DODGED)
               {
                  this.handlingEffect(_loc21_);
               }
         }
         if(Boolean(_loc21_.length > 0 && _loc21_[0].hasOwnProperty("effect")) && Boolean(_loc21_[0].effect == "critical_on_heavy_voltage") && Boolean(this.attacker_model.effects_manager.hadEffect("heavy_voltage")))
         {
      ...
      {
         if(this.attacker_model != null && Boolean(this.attacker_model.isCharacter()))
         {
         ...
         if(this.defender_model != null && Boolean(this.defender_model.isCharacter()))
         {
      ...
      {
         return param1 == null || param1.health_manager == null || Boolean(param1.health_manager.isDead());
      }
      ...
      private function scheduleTimeout(param1:Function, param2:Number, ... rest) : void
      {
         ...
         var _loc4_:uint = uint(setTimeout.apply(null,[param1,param2].concat(rest)));
      ...
      public function afterAttackChecks(param1:String = "", param2:Boolean = false, param3:Boolean = false) : *
      {
         ...
         var _loc5_:Boolean = Boolean(this.defender_model) && Boolean(this.defender_model.isCharacter());
         var _loc6_:Boolean = Boolean(this.defender_model) && Boolean(this.defender_model.IS_DODGED);
         ...
         _loc8_ = this.isModelDead(this.defender_model);
         if(_loc8_)
         {
      ...
      public function copySkill(param1:String, param2:* = null) : *
      {
         ...
         var _loc6_:Boolean = this.attacker_model == null || this.attacker_model.health_manager == null || Boolean(this.attacker_model.health_manager.isDead());
         var _loc7_:Boolean = this.defender_model == null || this.defender_model.health_manager == null || Boolean(this.defender_model.health_manager.isDead());
         ...
         if(BattleVars.COPY_SKILL_TEXT == "Titan Mode" && (Boolean(this.base_damage <= 0 || this.attacker_model.health_manager.isDead() || this.defender_model == null || this.defender_model.health_manager == null) || Boolean(Boolean(this.defender_model.health_manager.isDead()))))
         {
            this.agility_bar_manager.startRun();
            return;
         }
      ...
      public function checkTitanMode(param1:String) : Boolean
      {
         var _loc7_:Object = null;
         var _loc8_:int = 0;
         if(Boolean(this.defender_model == null || !this.attacker_model.isCharacter()) || Boolean(this.defender_model.IS_DODGED) || param1 == "skill_1022")
         {
            return false;
         }
         var _loc2_:Boolean = this.agility_bar_manager.ambush_team == "player";
      ...
      private function getLoadedsSkill() : *
      {
         ...
         try
         {
            ...
            if(Boolean(_loc2_) && Boolean(_loc2_.actions_manager))
            {
         ...
         if(param1)
         {
            switch(BattleManager.BATTLE_VARS.BATTLE_MODE)
            {
               ...
               case BattleVars.MISSION_MATCH:
                  ...
                  else if(Character.stage_grade_s_mission == 3 && Boolean(this._main.is_ambush_battle))
                  {
                     this._main.remainingStatus = [];
                     _loc9_ = 0;
                     while(_loc9_ < this.character_team_players.length)
      ...
      private function setupBattleEffectTooltips() : void
      {
         ...
         while(_loc1_ < 3)
         {
            if(Boolean(this["charMc_" + _loc1_]) && Boolean(this["charMc_" + _loc1_].btn_info))
            {
               this.bindEffectTooltip(this["charMc_" + _loc1_].btn_info,"character",_loc1_);
            }
            if(Boolean(this["enemyMc_" + _loc1_]) && Boolean(this["enemyMc_" + _loc1_].btn_info))
            {
      ...
      private function getEffectLine(param1:Object) : String
      {
         ...
         if(_loc2_ == "")
         {
            _loc6_ = Effects.all_buffs[param1.effect] || Effects.all_debuffs[param1.effect];
            if(_loc6_)
            {
         ...
         var _loc5_:int = int(param1.duration);
