package Combat
{
   ...
   public class BattleManager
   {
      ...
      public static function modifyChance(param1:Array, param2:String, param3:int, param4:String = "") : int
      {
         ...
         {
            _loc5_ = int(_loc6_.amount);
            _loc7_ = false;
            switch(_loc6_.effect)
            {
               case "transform":
               case "pet_frenzy":
                  _loc5_ = int(_loc6_.amount_cp);
                  break;
               case "meditation":
                  _loc5_ = int(_loc6_.amount_dodge);
                  break;
               case "slow":
               case "slow_oil":
            ...
            if(param2 == "ADD")
            {
               if(param4 != "accuracy" && param4 != "purify" && param4 != "dodge" && param4 != "critical" && param4 != "reactive_force")
               {
                  ...
                  param3 = param3 + Math.round(param3 * _loc5_ / 100);
                  param3 = _loc6_.calc_type == "percent" ? (param3) : (param3);
               }
      ...
      private static function unloadBattleSwfs() : void
      {
         ...
         {
            _loc5_ = _loc3_.url.url;
            if(_loc5_.indexOf("enemy/") >= 0 || _loc5_.indexOf("npcs/") >= 0 || _loc5_.indexOf("mission/") >= 0)
            {
               _loc2_.push(_loc5_);
            }
         }
