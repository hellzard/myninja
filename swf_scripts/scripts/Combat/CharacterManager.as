package Combat
{
   ...
   public class CharacterManager extends CharacterManagerBase
   {
      ...
      public function getTalentSkillsString() : String
      {
         ...
         if(Boolean(this.character.hasOwnProperty("character_inventory")) && Boolean(this.character.character_inventory.hasOwnProperty("char_talent_skills")))
         {
      ...
      public function getSenjutsuSkillsString() : String
      {
         ...
         if(Boolean(this.character.hasOwnProperty("character_inventory")) && Boolean(this.character.character_inventory.hasOwnProperty("char_senjutsu_skills")))
         {
      ...
      {
         if(Boolean(param2.is_special_jounin_exam_s1c2) && Character.mission_id == "special_jounin_s1c2_3")
         {
            Character.character_class = "skill_4002";
            return "skill_4002";
         }
         if(Boolean(param2.is_special_jounin_exam_s2c2) && Character.mission_id == "special_jounin_s2c2_3")
         {
            Character.character_class = "skill_4004";
            return "skill_4004";
         }
         if(Boolean(param2.is_special_jounin_exam_s3c2) && Character.mission_id == "special_jounin_s3c2_2")
         {
         ...
         if(Boolean(param2.is_special_jounin_exam_s6c1) || Boolean(param2.is_special_jounin_exam_s6c2) || Boolean(param2.is_special_jounin_exam_s6c3))
         {
