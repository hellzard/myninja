   ...
   public class CharacterModel extends CharacterModelBase
   {
      ...
      public function handleCharacterData(param1:Object) : *
      {
         ...
         this.characterAnimations = {
            "dodge":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("dodge")) ? param1.character_sets.anims.dodge : "ani_1"),
            "standby":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("standby")) ? param1.character_sets.anims.standby : "ani_5"),
            "win":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("win")) ? param1.character_sets.anims.win : "ani_7"),
            "dead":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("dead")) ? param1.character_sets.anims.dead : "ani_3"),
            "charge":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("charge")) ? param1.character_sets.anims.charge : "ani_9"),
            "hit":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("hit")) ? param1.character_sets.anims.hit : "ani_10"),
            "run":(Boolean(param1.character_sets.hasOwnProperty("anims")) && Boolean(param1.character_sets.anims.hasOwnProperty("run")) ? param1.character_sets.anims.run : "ani_11")
         };
      ...
      {
         var _loc1_:int = int(this.character_info.character_accuracy);
      ...
      {
         var _loc1_:int = int(this.character_info.character_dodge);
      ...
      public function getCombustionChance() : int
      {
         ...
         return BattleManager.modifyChance(_loc4_,"RM",_loc1_);
      }
      
      public function getCriticalChance() : int
      {
         var _loc1_:Number = Number(this.character_info.character_critical);
      ...
      public function attackWithWeapon() : *
      {
         ...
         var _loc3_:int = this.player_team == "player" ? BattleVars.PLAYER_TARGET : BattleVars.ENEMY_TARGET;
         var _loc4_:Array = [];
      ...
      override public function handleHitFrame() : *
      {
         ...
         var _loc6_:int = this.player_team == "player" ? BattleVars.PLAYER_TARGET : BattleVars.ENEMY_TARGET;
      ...
      internal function copyClip(param1:MovieClip) : *
      {
      ...
      public function getAttack(param1:int = 0, param2:int = -1) : *
      {
         ...
         var _loc15_:Object = this.enemy_ai.decideAction(this,_loc13_,_loc14_);
         _loc10_ = int(_loc15_.type);
         _loc11_ = int(_loc15_.index);
         ...
         var _loc20_:Boolean = Boolean(_loc15_.is_friendly_target) && !_loc19_;
         var _loc21_:Array = _loc20_ ? _loc14_ : _loc13_;
         ...
         var _loc22_:int = int(_loc15_.target);
         ...
         else if(_loc10_ == 2)
         {
            ...
            _loc4_ = Boolean(_loc3_.setPositionAndAttack(this.player_team,_loc22_,this.player_number,false));
            if(_loc4_)
            {
               _loc5_ = this.actions_manager.onUseSkill(_loc11_,_loc23_);
               if(!_loc5_)
               {
                  this.getAttack(param1 + 1,2);
               }
         ...
         else if(_loc10_ == 3)
         {
            ...
            if(_loc4_)
            {
               _loc5_ = this.actions_manager.useTalentSkill(_loc11_,_loc23_);
               if(!_loc5_)
               {
                  this.getAttack(param1 + 1,3);
               }
         ...
         else if(_loc10_ == 4)
         {
            ...
            if(_loc4_)
            {
               _loc5_ = this.actions_manager.useSenjutsuSkill(_loc11_,_loc23_);
               if(!_loc5_)
               {
                  this.getAttack(param1 + 1,4);
               }
         ...
         else if(_loc10_ == 5)
         {
            ...
            if(_loc4_)
            {
               _loc5_ = this.actions_manager.onUseClassSkill(null);
               if(!_loc5_)
               {
                  this.getAttack(0,1);
               }
      ...
      override public function destroy() : *
      {
         ...
         if(Boolean(_loc1_) && _loc2_ in _loc1_)
         {
