package Combat
{
   ...
   public class EffectsManager
   {
      ...
      public function purifyPlayer(param1:String = "Purify", param2:String = "") : *
      {
         ...
         {
            _loc4_ = int(this.dataDebuff.length - 1);
            while(_loc4_ >= 0)
            {
               _loc5_ = this.dataDebuff[_loc4_];
               if(!(Boolean("no_purify" in _loc5_) && Boolean(_loc5_.no_purify) || Effects.doesEffectCannotPurified(_loc5_.effect)))
               {
      ...
      public function checkPassiveEffectsAfterBeingHit(param1:*, param2:*, param3:Boolean = true) : *
      {
         ...
         if(param1.isCharacter())
         {
            ...
            if(param1.effects_manager.hadEffect("pet_stubborn_recover_cp"))
            {
               ...
               _loc8_ = "chance" in _loc4_ ? int(_loc4_.chance) : 100;
      ...
      public function checkRecoverHpIfUserIsUnderBloodlust() : *
      {
         ...
         var _loc4_:* = _loc3_.effects_manager.getEffect("bloodlust");
         if(_loc4_.duration > 0)
         {
            ...
            _loc1_ = Math.floor(_loc4_.amount * BattleManager.getTotalDamage() / 100);
            if(_loc1_ > 0)
            {
      ...
      public function checkForIncreasePurifyFromHPPercentage() : *
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:* = this.getCurrentModel();
         ...
         var _loc5_:Boolean = _loc3_ <= _loc2_ / 2;
         if(Boolean(_loc4_.effects_manager.hadEffect("cp_shield_and_increase_purify")) && _loc5_)
         {
            _loc1_ += 100;
         }
         return _loc1_;
      ...
      public function checkKekkaiReduceHpCp() : *
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:* = BattleManager.getBattle().getDefender();
         var _loc6_:Object = _loc5_.effects_manager.getEffect("kekkai");
      ...
      public function checkRecoverEnemyHPAfterDidDamage() : void
      {
         ...
         var _loc3_:int = 0;
         if(Boolean(_loc2_.hadEffect("bloodfeed")) || Boolean(_loc2_.hadEffect("pet_bloodfeed")))
         {
      ...
      public function checkRecoverHPAfterPurified() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            ...
            {
               if(Boolean(_loc6_) && _loc6_.effect == "recover_hp_after_purify")
               {
         ...
         if((_loc3_ > 0 || _loc4_ > 0) && Boolean(_loc1_.health_manager))
         {
            _loc7_ = int(_loc1_.health_manager.getMaxHP());
      ...
      public function checkRecoverCPAfterPurified() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            for each(_loc6_ in _loc5_)
            {
               if(Boolean(_loc6_) && _loc6_.effect == "recover_cp_after_purify")
               {
                  if(_loc6_.calc_type == "number")
                  {
                     _loc4_ += _loc6_.amount;
         ...
         if((_loc3_ > 0 || _loc4_ > 0) && Boolean(_loc1_.health_manager))
         {
            _loc7_ = int(_loc1_.health_manager.getMaxCP());
            _loc8_ = _loc4_ + Math.floor(_loc7_ * _loc3_ / 100);
      ...
      public function checkStunAfterDidDamage(param1:String = "critical_buff_n_received_stun") : *
      {
         ...
         var _loc4_:* = BattleManager.getBattle().getDefender().effects_manager;
         var _loc5_:* = _loc4_.getEffect(param1);
      ...
      public function checkBleedingAfterDidDamage(param1:String = "attacker_bleeding") : void
      {
         ...
         var _loc4_:Object = _loc2_.getDefender();
         var _loc5_:Object = _loc4_.effects_manager;
         var _loc6_:Object = _loc5_.getEffect(param1);
         if((Boolean(_loc6_)) && _loc6_.duration > 0)
         {
            _loc7_ = {
               "effect":"bleeding",
      ...
      public function checkRecoverHPAfterCritical(param1:Object) : void
      {
         ...
         var _loc2_:Array = param1.effects_manager.getAllCharacterSetEffects();
         var _loc3_:Number = Number(param1.health_manager.getMaxHP());
         for each(_loc4_ in _loc2_)
         {
            for each(_loc5_ in _loc4_)
            {
               ...
               {
                  _loc6_ = _loc5_.calc_type == "percent" ? Math.floor(_loc3_ * _loc5_.amount / 100) : Number(_loc5_.amount);
      ...
      public function checkRecoverHPAfterReceivedCritical(param1:Object) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            for each(_loc5_ in _loc4_)
            {
               ...
               {
                  _loc6_ = "chance" in _loc5_ ? int(_loc5_.chance) : 100;
                  _loc7_ = NumberUtil.getRandomInt();
                  if(_loc6_ >= _loc7_)
                  {
                     _loc8_ = _loc5_.calc_type == "percent" ? Math.floor(_loc3_ * _loc5_.amount / 100) : Number(_loc5_.amount);
      ...
      public function checkTheft(param1:String = "theft") : void
      {
         ...
         var _loc7_:String = param1 + "_mode";
         if(_loc6_.duration > 0)
         {
      ...
      public function checkAoeDamage(param1:String, param2:int) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:Object = this.getCurrentModel();
         var _loc6_:Object = _loc5_.effects_manager.getEffect(param1);
         if(_loc6_.duration > 0)
         {
      ...
      public function checkWeaponAttackPenalty() : void
      {
         ...
         if(_loc2_.duration > 0)
         {
            _loc3_ = int(_loc1_.health_manager.getMaxHP());
            _loc4_ = int(_loc1_.health_manager.getMaxCP());
            _loc5_ = 0;
            _loc6_ = 0;
            ...
            {
               _loc5_ = int(_loc2_.amount);
               _loc6_ = int(_loc2_.amount);
            }
            if(_loc5_ > 0)
            {
      ...
      {
         var _loc3_:int = "sacrifice_amount" in param2 && param2.sacrifice_amount > 0 ? int(param2.sacrifice_amount) : 30;
         var _loc4_:int = int(param1.health_manager.getCurrentHP());
         var _loc5_:int = int(param1.health_manager.getMaxHP());
         var _loc6_:int = Math.floor(_loc5_ * _loc3_ / 100);
         if(_loc6_ >= _loc4_)
         {
            _loc6_ = _loc4_ - 1;
         }
         ...
         var _loc8_:int = param2.duration > 0 ? int(param2.duration) : 3;
         var _loc9_:int = param2.amount > 0 ? int(param2.amount) : 50;
         switch(_loc7_)
         {
            case 0:
      ...
      public function noCPCostFromTalent() : Boolean
      {
         ...
         {
            _loc2_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1057",_loc1_.character_manager.getTalentLevel("skill_1057")).chance);
      ...
      public function getCooldownReduceFromTalent(param1:String) : Boolean
      {
         ...
         {
            _loc5_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1057",_loc2_.character_manager.getTalentLevel("skill_1057")).cooldown_chance);
            if(_loc5_ >= NumberUtil.getRandomInt())
            {
               _loc3_ = true;
            }
         }
      ...
      public function getCooldownReduceMemekKuda(param1:String) : int
      {
         ...
         while(_loc6_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = int(SenjutsuSkillLevel.getSenjutsuSkillLevels("skill_3101",_loc2_.character_manager.getSenjutsuLevel("skill_3101")).cooldown_decrease);
               _loc5_ = true;
            }
            _loc6_++;
         }
         var _loc7_:* = this.checkTempForSenjutsu(param1);
         if(_loc5_ && Boolean(_loc7_))
         {
            _loc2_.health_manager.createDisplay("Cooldown Reduction");
         }
         else
      ...
      public function getDecreaseChargeCPByEffect() : Number
      {
         ...
         var _loc5_:Boolean = Boolean(_loc3_.hadEffect("decrease_charge"));
         if(_loc5_)
         {
      ...
      public function checkAddHPAfterDodge() : *
      {
         ...
         var _loc3_:Array = this.getAllCharacterSetEffects();
         var _loc4_:* = this.getCurrentModel();
         var _loc5_:int = int(_loc4_.health_manager.getMaxHP());
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         while(_loc7_ < _loc3_.length)
         {
      ...
      public function getAllCharacterSetEffects() : Array
      {
         ...
         signature = [disableWeaponEffect ? "1" : "0",weaponId,backItemId,accessoryId,clothingId,hairId].join("|");
      ...
      public function isInternalInjuryImmune() : Boolean
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.effect == "immune_internal_injury")
               {
                  _loc6_ = _loc5_.chance != null ? Number(_loc5_.chance) : 100;
      ...
      public function increaseRecoverByEffects(param1:int, param2:String) : int
      {
         ...
         var _loc7_:Object = this.checkIncreaseRecoverItemFromTalent();
         if(_loc7_ != null)
         {
            _loc9_ = 0;
      ...
      public function handleLightMatter() : Boolean
      {
         ...
         {
            _loc2_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1113",_loc1_.character_manager.getTalentLevel("skill_1113")).internal_injury_chance);
         }
      ...
      public function handleDarkMatter() : Boolean
      {
         ...
         {
            _loc2_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1116",_loc1_.character_manager.getTalentLevel("skill_1116")).disable_chance);
         }
         return NumberUtil.getChance(_loc2_);
      }
      ...
      {
         var _loc2_:Number = 0;
         if(Boolean(param1) && Boolean(param1.effects_manager) && Boolean(param1.effects_manager.hadEffect("disable_passive_talent")))
         {
            return 0;
         }
      ...
      public function calculateDamage(param1:int, param2:Object, param3:Boolean = false) : int
      {
         ...
         return this.decreaseDamage(param1,param2);
      }
      ...
      public function increaseDamage(param1:int, param2:Object, param3:Boolean = false) : int
      {
         ...
         var _loc5_:int = int(this.increaseDamageFromPassive_Buff(_loc4_).additive);
         ...
         _loc13_ = int(_loc9_.additive);
         _loc14_ = _loc9_.multiplicative;
         _loc15_ = int(_loc10_.additive);
         _loc16_ = _loc10_.multiplicative;
         _loc17_ = int(_loc11_.additive);
         _loc18_ = _loc11_.multiplicative;
         _loc19_ = int(_loc12_.additive);
      ...
      private function calculateCriticalDamage(param1:int) : int
      {
         ...
         {
            _loc6_ = this.getEffect("decrease_critical_damage");
            if((Boolean(_loc6_)) && Boolean(_loc6_.amount))
            {
               _loc4_ -= _loc6_.amount;
            }
         }
         ...
         {
            _loc6_ = this.getEffect("critical_buff_n_received_stun");
            if((Boolean(_loc6_)) && Boolean(_loc6_.amount))
            {
               _loc4_ += _loc6_.amount;
            }
         ...
         {
            _loc6_ = this.getEffect("pet_mortal");
            if((Boolean(_loc6_)) && Boolean(_loc6_.amount))
            {
               _loc4_ += _loc6_.amount;
            }
      ...
      {
         var _loc2_:Array = [];
         var _loc3_:int = int(param1.effects_manager.checkIncreaseDamageFromMarionette(param1));
         var _loc4_:int = int(param1.effects_manager.checkIncreaseDamageFromEssenceOfTime(param1));
         if(_loc4_ > 0)
         {
            _loc2_.push(_loc4_);
         }
      ...
      {
         var _loc2_:Array = [];
         var _loc3_:int = int(param1.effects_manager.checkDecreaseDamageFromOnmyouji(param1));
         var _loc4_:int = int(param1.effects_manager.checkDecreaseDamageFromOrochi(param1));
         var _loc5_:int = int(param1.effects_manager.checkDecreaseDamageFromCarapace(param1));
         if(_loc3_ > 0)
         {
            _loc2_.push(_loc3_);
         }
      ...
      public function decreaseDamage(param1:int, param2:Object) : int
      {
         ...
         var _loc23_:int = 0;
         var _loc3_:Object = this.getCurrentModel();
         if(Boolean(param2 != null) && Boolean(param2.effects_manager.getEffect("fast_forward")) && param2.effects_manager.getEffect("fast_forward").duration > 1)
         {
            return param1;
         }
         _loc3_ = this.getCurrentModel();
         var _loc4_:int = int(this.decreaseDamageFromPassive_Buff(param2).additive);
         ...
         _loc12_ = int(_loc8_.additive);
         _loc13_ = _loc8_.multiplicative;
         _loc14_ = int(_loc9_.additive);
         _loc15_ = _loc9_.multiplicative;
         _loc16_ = int(_loc10_.additive);
         _loc17_ = _loc10_.multiplicative;
         _loc18_ = int(_loc11_.additive);
      ...
      public function checkIncreaseDamageForToad(param1:*) : int
      {
         ...
         var _loc5_:int = int(_loc3_.health_manager.getCurrentHP());
         var _loc6_:int = int(_loc3_.health_manager.getMaxHP());
         var _loc7_:int = _loc6_ - _loc5_;
         var _loc8_:* = 0;
         while(_loc8_ < _loc4_.length)
         {
            _loc9_ = _loc4_[_loc8_].split(":");
            if(_loc9_[0] == "skill_3009")
            {
      ...
      public function decreaseDamageByEffect(param1:int, param2:Object, param3:* = null) : *
      {
         ...
         if(param2.effect == "stealth" && (!("no_protect" in param2) || param2.no_protect == false))
         {
            ...
            _loc4_ = int(param2.amount_protection);
            if(_loc4_ == 100)
            {
               BattleVars.SHOW_DAMAGE_ZERO = true;
            }
      ...
      {
         var _loc4_:Object = this.getCurrentModel();
         var _loc5_:Object = _loc4_.character_manager;
         var _loc6_:int = int(_loc5_.getWindAttributes());
         var _loc7_:int = int(_loc5_.getFireAttributes());
         var _loc8_:int = int(_loc5_.getLightningAttributes());
         var _loc9_:int = int(_loc5_.getEarthAttributes());
         var _loc10_:int = int(_loc5_.getWaterAttributes());
         var _loc11_:Object = {};
         switch(param2)
         {
            case 5:
      ...
      private function handleInstantEffect(param1:Object, param2:Object) : void
      {
         ...
         {
            var _loc2_:Number = Number(param1.effects_manager.getRecoverWhenHPReducedByTalent());
            if(_loc2_ > 0)
            {
         ...
         var handleInstantReduceHp:Function = function(param1:*, param2:*):*
         {
            var _loc3_:Boolean = false;
            var _loc4_:Object = null;
            _loc3_ = Boolean(param2.effects_manager.hadEffect("slow"));
         ...
         switch(effect.effect)
         {
            ...
            case "hpcp_up":
               amountHP = 0;
               amountCP = 0;
               if("checkSageMode" in effect && Boolean(model.effects_manager.hadEffect("sage_mode")))
               {
                  effect.amount += 15;
               }
               if(effect.calc_type == "percent")
               ...
               {
                  amountHP = int(effect.amount);
                  amountCP = int(effect.amount);
               }
            ...
            case "instant_cp_recover":
               ...
               switch(effect.effect_name)
               {
                  ...
                  case "Stubborn Recover CP":
                     ...
                     break;
                  default:
                     totalAmount = int(target.health_manager.getMaxCP());
               }
               if(effect.calc_type == "percent")
               {
      ...
      public function drainHP(param1:Object, param2:Object, param3:Object) : void
      {
         ...
         if(_loc7_ > 0)
         {
            _loc11_ = param2.effects_manager;
            if(!(Boolean(_loc11_.hadEffect("unyielding")) || Boolean(_loc11_.hadEffect("negate"))))
            {
            ...
            if(_loc10_ > 0)
            {
               _loc12_ = Number(param2.effects_manager.getRecoverWhenHPReducedByTalent());
               if(_loc12_ > 0)
               {
      ...
      public function drainCP(param1:*, param2:*, param3:Object) : *
      {
         ...
         _loc9_ = param2.effects_manager;
         if(!(Boolean(_loc9_.hadEffect("unyielding")) || Boolean(_loc9_.hadEffect("negate"))))
         {
      ...
      public function drainSP(param1:*, param2:*, param3:Object) : *
      {
         ...
         _loc5_ = int(param1.health_manager.getCurrentSP());
         _loc6_ = int(param1.health_manager.getMaxSP());
         if(_loc6_ == 0)
         {
            return;
         }
         var _loc7_:int = int(param2.health_manager.getCurrentSP());
         var _loc8_:int = int(param2.health_manager.getMaxSP());
      ...
      public function addBuff(param1:Object, param2:Object = null) : void
      {
         ...
         _loc8_ = this.replaceEffect(param1,"Buff");
         if(!_loc8_)
         {
         ...
         if(Effects.doesEffectIncreaseMaxHealth(param1.effect))
         {
            ...
            {
               _loc13_ = _loc5_.effectAddMaxHP.slug_sage != null && _loc5_.effectAddMaxHP.slug_sage.increase_hp > 0;
               if(_loc13_)
               {
      ...
      public function checkForPowerofToad(param1:*) : void
      {
         ...
         _loc4_ = _loc2_.health_manager;
         _loc5_ = int(_loc4_.getMaxHP());
         _loc6_ = _loc5_ * (_loc3_.amount / 100);
      ...
      public function checkForShedding() : Boolean
      {
         ...
         var _loc3_:int = int(_loc2_.sp_req);
         _loc4_ = _loc1_.health_manager;
         _loc5_ = int(_loc4_.getCurrentSP());
         _loc6_ = int(_loc4_.getMaxSP());
         if(_loc6_ == 0)
         {
            return false;
         }
         _loc7_ = _loc5_ / _loc6_ * 100;
         if(_loc7_ > _loc2_.sp_req || Boolean(_loc1_.effects_manager.hadEffect("sage_mode")))
         {
      ...
      public function addDebuff(param1:Object, param2:Object = null, param3:Boolean = true) : void
      {
         ...
         for each(_loc8_ in this.getAllDebuffs())
         {
            ...
            {
               if("add_in_array" in _loc8_ && Boolean(_loc8_.add_in_array))
               {
         ...
         _loc9_ = ["burn","inflict_burn","pet_burn","fire_wall_burn","hemorrhage","burning","ultra_burning"];
         if(_loc9_.indexOf(param1.effect) >= 0 && this.isBurnImmune())
         {
            Effects.showEffectInfo(this.user_team,this.user_number,"Burn Immune");
            return;
         }
         _loc10_ = ["bleeding","inflict_bleeding","pet_bleeding","attacker_bleeding","pet_attacker_bleeding","bleeding_attacker","ultra_bleeding"];
         if(_loc10_.indexOf(param1.effect) >= 0 && this.hadEffect("bleeding_protection"))
         {
            Effects.showEffectInfo(this.user_team,this.user_number,"Bleeding Immune");
            return;
         }
         _loc11_ = ["poison","inflict_poison","pet_poison"];
         if(_loc11_.indexOf(param1.effect) >= 0 && Boolean(this.getResistPoisonPrcByTalent()))
         {
            Effects.showEffectInfo(this.user_team,this.user_number,"Poison Immune");
            return;
         }
         _loc12_ = ["internal_injury","hanyaoni","suffocate"];
         if(_loc12_.indexOf(param1.effect) >= 0 && (this.hadEffect("vigor") || this.isInternalInjuryImmune()))
         {
         ...
         _loc11_ = ["poison","inflict_poison","pet_poison","poison_attacker"];
         if(_loc11_.indexOf(param1.effect) >= 0)
         {
         ...
         if(_loc13_.effect == "disable_passive_talent" && Boolean(_loc4_.isCharacter()))
         {
            this.is_passive_talent_disabled = true;
            _loc17_ = int(_loc4_.character_manager.recalculateHP());
            _loc18_ = int(_loc4_.character_manager.recalculateCP());
         ...
         if(_loc13_.effect == "disable_weapon_effect" && Boolean(_loc4_.isCharacter()))
         {
         ...
         {
            _loc22_ = int(_loc7_.getCurrentCP());
            _loc23_ = int(_loc7_.getMaxCP());
            if(param1.calc_type == "percent")
            {
            ...
            _loc24_ = int(_loc7_.getCurrentHP());
            _loc25_ = int(_loc7_.getMaxHP());
            if(param1.calc_type == "percent")
            {
         ...
         {
            _loc26_ = int(_loc7_.getCurrentSP());
            _loc27_ = int(_loc7_.getMaxSP());
            if(param1.calc_type == "percent")
            {
      ...
      private function cloneEffect(param1:Object) : Object
      {
         ...
         _loc4_ = Effects.getEffectDeductType(_loc2_.effect);
         if(_loc4_ === "after_attack" && (!_loc2_.hasOwnProperty("no_duration_increment") || !_loc2_.no_duration_increment))
         {
            ++_loc2_.duration;
         }
         return _loc2_;
      ...
      private function replaceEffect(param1:Object, param2:String) : Boolean
      {
         ...
         {
            _loc5_ = _loc3_[_loc4_];
            if(_loc5_.effect == param1.effect)
            {
      ...
      public function handleAddDebuffDuration(param1:Object) : void
      {
         ...
         if(param1.chance >= _loc3_)
         {
            ...
            {
               _loc5_ = _loc2_[0][_loc2_[1][_loc4_]];
               if(_loc5_ != null)
               {
      ...
      public function checkPassiveEffects() : *
      {
         ...
         _loc7_ = int(_loc1_.health_manager.getCurrentHP());
         _loc8_ = int(_loc1_.health_manager.getMaxHP());
         _loc9_ = int(_loc1_.health_manager.getCurrentCP());
         _loc10_ = int(_loc1_.health_manager.getMaxCP());
         var _loc11_:int = int(_loc1_.health_manager.getCurrentSP());
         _loc12_ = int(_loc1_.health_manager.getMaxSP());
         _loc13_ = 0;
         _loc14_ = 0;
      ...
      private function filterActiveDebuffs(param1:Array) : Array
      {
         ...
         {
            _loc4_ = param1[0][param1[1][_loc3_]];
            if(_loc4_.duration > 0)
            {
               _loc2_.push(_loc4_);
            }
      ...
      {
         return param1.calc_type == "number" ? int(param1.amount) : int(Math.floor(param2 * param1.amount / 100));
      }
      ...
      private function calculateHPRecovery(param1:Object, param2:int, param3:int) : int
      {
         ...
         if("chance" in param1 && param1.chance >= _loc4_)
         {
            ...
            {
               return param1.calc_type == "number" ? int(param1.amount) : int(Math.floor(int(param1.amount) * param3 / 100));
            }
            _loc5_ = Math.round(param2 / param3 * 100);
            if(_loc5_ < param1.hp_requirement)
            {
      ...
      {
         var _loc4_:Boolean = false;
         _loc4_ = param2 <= Math.floor(param3 * param1.active_when / 100);
         return _loc4_ ? this.calculateRecovery(param1,param3) : 0;
      }
      
      private function handleHPRecoveryBelowCP(param1:Object, param2:int, param3:int, param4:int) : int
      {
         var _loc5_:Boolean = false;
         _loc5_ = param2 <= Math.floor(param3 * param1.active_when / 100);
         return _loc5_ ? this.calculateRecovery(param1,param4) : 0;
      }
      ...
      public function deductDurationOfEffects() : void
      {
         ...
         while(_loc4_ >= 0)
         {
            ...
            if(_loc7_.hasOwnProperty("duration") && typeof _loc7_.duration === "number")
            {
               _loc8_ = Effects.getEffectDeductType(_loc7_.effect);
               if(_loc8_ === "never")
               {
         ...
         for each(_loc5_ in _loc2_)
         {
            _loc9_ = Boolean(_loc5_.type === "Buff") || Boolean(_loc5_.is_master_buff) || Boolean(_loc5_.is_buff) || Boolean(_loc5_.is_self) && Boolean(!_loc5_.is_debuff) ? "buff" : "debuff";
            if(_loc9_ === "debuff")
            {
      ...
      public function removeEffect(param1:String) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            _loc6_ = Boolean(_loc4_.type === "Buff") || Boolean(_loc4_.is_master_buff) || Boolean(_loc4_.is_buff) || Boolean(_loc4_.is_self) && Boolean(!_loc4_.is_debuff) ? "buff" : "debuff";
            if(_loc6_ === "debuff")
            {
      ...
      {
         var _loc2_:* = undefined;
         if(Boolean(param1) && Boolean(param1.duration == 0) && Boolean(param1.remove_effect))
         {
      ...
      public function checkIncreaseMaxHPCPFinish() : void
      {
         ...
         _loc3_ = Boolean(_loc2_.hadEffect("self_love"));
         _loc4_ = Boolean(_loc2_.hadEffect("bloodflame"));
         _loc5_ = Boolean(_loc2_.hadEffect("domain_expansion"));
         _loc6_ = Boolean(_loc2_.hadEffect("disable_weapon_effect"));
         _loc7_ = Boolean(_loc2_.hadEffect("disable_passive_talent"));
         if(!_loc7_ && Boolean(_loc2_.is_passive_talent_disabled))
         {
            _loc2_.is_passive_talent_disabled = false;
            _loc8_ = int(_loc1_.character_manager.recalculateHP());
            _loc9_ = int(_loc1_.character_manager.recalculateCP());
      ...
      public function checkIncreaseMaxHPFinish() : void
      {
         ...
         _loc2_ = _loc1_.effects_manager;
         _loc3_ = Boolean(_loc2_.hadEffect("slug_sage"));
         if(!_loc3_)
         {
            this.resetMaxStats(_loc1_,"slug_sage","increase");
            _loc4_ = int(_loc1_.character_manager.recalculateHP());
      ...
      private function reApplyMaxHPBonuses(param1:Object) : void
      {
         ...
         if(Boolean(param1.effectDecreaseMaxHP) && Boolean(param1.effectDecreaseMaxHP.unwell))
         {
      ...
      public function checkDecreaseMaxCPFinish() : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc2_.duration == 0) && Boolean(_loc2_.remove_effect) || !_loc3_)
         {
      ...
      public function checkDecreaseMaxHPCPFinish() : void
      {
         ...
         if(Boolean(_loc2_.duration == 0) && Boolean(_loc2_.remove_effect) || !_loc3_)
         {
            _loc2_.remove_effect = false;
      ...
      public function checkPurifyOnRoundStart() : void
      {
         ...
         if(Boolean(_loc1_) && Boolean(_loc1_.duration > 0) || Boolean(_loc2_) && Boolean(_loc2_.duration > 0))
         {
      ...
      public function checkPeace() : *
      {
         ...
         {
            _loc6_ = _loc4_[_loc5_];
            _loc7_ = _loc6_.effects_manager.getEffect("peace");
            if((Boolean(_loc7_)) && _loc7_.duration > 1)
            {
      ...
      public function getAccuracyBelowHP() : void
      {
         ...
         _loc4_ = int(_loc3_.getCurrentHP());
         _loc5_ = int(_loc3_.getMaxHP());
      ...
      public function getCriticalAndAccuracyWhenHPBelow() : void
      {
         ...
         _loc2_ = int(_loc1_.health_manager.getMaxHP());
         _loc3_ = int(_loc1_.health_manager.getCurrentHP());
         if(_loc2_ == 0)
         {
            return;
         }
      ...
      public function checkStealJutsu() : Boolean
      {
         ...
         if(Boolean(!_loc2_.isCharacter()) || Boolean(_loc2_.effects_manager.hadEffect("unyielding")) || Boolean(_loc2_.effects_manager.hadEffect("debuff_resist")) || !_loc1_.character_manager.hasSenjutsuSkill("skill_3005"))
         {
            return false;
         }
      ...
      public function checkCopySkill(param1:String) : Boolean
      {
         ...
         _loc3_ = this.user_team == "player" ? Boolean(BattleVars.CHARACTER_REVIVED[this.user_number]) : Boolean(BattleVars.ENEMY_REVIVED[this.user_number]);
         ...
         _loc4_ = int(_loc2_.character_manager.getTalentLevel("skill_1018"));
      ...
      public function resetKnowledgeOfTime() : void
      {
         ...
         var _loc4_:String = null;
         _loc1_ = this.getCurrentModel();
         _loc2_ = Boolean(_loc1_.effects_manager.hadEffect("defer"));
         _loc3_ = Boolean(_loc1_.effects_manager.hadEffect("fast_forward"));
         if(_loc2_)
         {
      ...
      public function setupDefer(param1:Object, param2:Object) : void
      {
         ...
         _loc4_ = param2.hasOwnProperty("heal_block_turns") ? int(param2.heal_block_turns) : 0;
         if(_loc4_ > 0)
         {
            _loc5_ = param1.effects_manager.getEffect("defer");
            if(_loc5_ != null && _loc5_.hasOwnProperty("effect"))
            {
               _loc5_.after_effect = [{
                  "effect":"internal_injury",
                  "effect_name":"Internal Injury",
      ...
      public function calculateKnowledgeOfTime(param1:int) : int
      {
         ...
         if(Boolean(_loc2_.effects_manager.hadEffect("defer")) && _loc3_ > 0)
         {
            _loc4_ = _loc3_ - int(_loc2_.knowledge_of_time.stored_damage);
            if(_loc4_ <= 0)
            {
               return param1;
            }
      ...
      public function checkRecoverCPFromTalent() : int
      {
         ...
         _loc6_ = int(_loc1_.health_manager.getMaxCP());
      ...
      public function checkReboundEffects() : Boolean
      {
         ...
         var _loc4_:int = 0;
         _loc1_ = this.getCurrentModel();
         _loc2_ = this.user_team == "player" ? Boolean(BattleVars.CHARACTER_REVIVED[this.user_number]) : Boolean(BattleVars.ENEMY_REVIVED[this.user_number]);
         if(!_loc1_.isCharacter())
         {
            return false;
         }
      ...
      public function getDebuffResistByTalent() : void
      {
         ...
         _loc2_ = int(TalentSkillLevel.getTalentSkillLevels("skill_1110",_loc1_.character_manager.getTalentLevel("skill_1110")).resist_debuff_chance);
         if(_loc2_ >= NumberUtil.getRandomInt())
         {
      ...
      public function getReduceDamageTakenByTalent() : Number
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            {
               _loc5_ = int(_loc1_.character_manager.getTalentLevel(_loc4_));
      ...
      public function calculateChanceFromTalent_Wolfram(param1:int) : void
      {
         ...
         _loc3_ = NumberUtil.getRandomInt();
         _loc4_ = int(_loc2_.character_manager.getTalentLevel("skill_1107"));
         _loc5_ = TalentSkillLevel.getTalentSkillLevels("skill_1107",_loc4_);
         if(_loc5_.chance >= _loc3_ && param1 > _loc5_.damage_count)
         {
            _loc6_ = {
               "passive":false,
               "type":"Buff",
      ...
      internal function calculateInsectPurify(param1:int, param2:int) : int
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
      ...
      public function getIncreasePurifyByTalent() : Number
      {
         ...
         if(_loc1_.effects_manager.hasActivePassiveTalent("skill_1051"))
         {
            _loc2_ = Number(_loc1_.health_manager.getMaxCP());
            _loc3_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1051",_loc1_.character_manager.getTalentLevel("skill_1051")).purify_chance_on);
            return Math.round(_loc2_ / _loc3_);
         }
         if(_loc1_.effects_manager.hasActivePassiveTalent("skill_1102"))
         {
            _loc5_ = Number(_loc1_.health_manager.getMaxHP());
            _loc3_ = Number(TalentSkillLevel.getTalentSkillLevels("skill_1102",_loc1_.character_manager.getTalentLevel("skill_1102")).purify_chance_on);
            return Math.round(_loc5_ / _loc3_);
         }
      ...
      public function getIncreaseCritDamageByTalent() : Number
      {
         ...
         {
            _loc4_ = int(_loc2_.getTalentLevel("skill_1009"));
            _loc5_ = TalentSkillLevel.getTalentSkillLevels("skill_1009",_loc4_);
            if((Boolean(_loc5_)) && _loc5_.hasOwnProperty("increase_critical_damage"))
            {
      ...
      public function getCaptureChanceFromSilhouette() : Object
      {
         ...
         _loc5_ = 0;
         if(Boolean(_loc1_.effects_manager.hadEffect("increase_silhouette_chance")) && Boolean(_loc2_ != null) && !isNaN(_loc2_.amount))
         {
      ...
      private function handleReactiveForce(param1:Object, param2:Object, param3:int) : void
      {
         ...
         if(param1.isCharacter())
         {
            ...
            _loc4_ = BattleManager.modifyChance(_loc5_,"ADD",_loc4_,"reactive_force");
            _loc4_ = _loc4_ + param1.effects_manager.getIncreaseReactiveFromSlugEarthMastery();
         }
         else
         {
         ...
         if(_loc8_.length > 0)
         {
            ...
            {
               _loc12_ = _loc8_[0][_loc8_[1][_loc11_]];
               if(_loc12_.effect == "reactive_force")
               {
      ...
      public function checkForReboundAsDamage(param1:int, param2:int) : *
      {
         ...
         _loc3_ = 0;
         _loc4_ = null;
         _loc5_ = this.getCurrentModel();
         if(!_loc5_.isCharacter())
         {
            return 0;
         }
         _loc6_ = NumberUtil.getRandomInt();
         ...
         if(!_loc9_.effects_manager.hasDebuffResist(_loc9_))
         {
            if(_loc7_ > 0)
            {
               ...
               _loc3_ = _loc12_ > _loc3_ ? _loc3_ : _loc12_;
               if(_loc3_ > 0)
               {
            ...
            if(_loc3_ > 0 && !this.meridian_kekkai_procced_this_turn)
            {
               ...
               _loc13_ = Boolean(_loc9_.effects_manager.getAcceptChance("stun"));
               if((_loc13_) && _loc8_ >= _loc6_ && !_loc9_.debuff_resist)
               {
                  _loc4_ = new Object();
                  _loc4_.effect = "stun";
      ...
      public function handleEffectIfImmediately(param1:Object, param2:Array) : Array
      {
         ...
         _loc5_ = Boolean(param1) && Boolean(param1.effect_name) ? String(param1.effect_name) : "";
         _loc6_ = param1.effect;
         _loc7_ = Boolean(_loc3_.effects_manager.hadEffect("skip_turn"));
         _loc8_ = {
            "hp":_loc4_.getMaxHP(),
            "cp":_loc4_.getMaxCP(),
            "sp":_loc4_.getMaxSP()
         ...
         switch(_loc6_)
         {
            ...
            case "ultra_burning":
               if(!_loc7_)
               {
                  ...
                  if(Boolean(param1.amount_per_debuff) && _loc11_ > 0)
                  {
                     if(param1.calc_type == "number")
                     {
      ...
      public function increaseOrDecreaseByObject(param1:int, param2:int, param3:Object, param4:String = "amount") : int
      {
         ...
         if(param4 == "amount_cp")
         {
            _loc5_ = Number(Number(param3.amount_cp) || 0);
         }
         else if(param4 == "frostbite_amount")
         {
            _loc5_ = Number(_loc6_ ? Number(param3.frostbite_amount) || 0 : 0);
         }
         else if(param4 == "amount_reduce")
         {
            _loc5_ = Number(_loc6_ ? Number(param3.amount_reduce) || 0 : 0);
         }
         else
         {
            _loc5_ = Number(Number(param3.amount) || 0);
         }
      ...
      public function checkPreventDeath(param1:*, param2:int) : int
      {
         ...
         _loc9_ = param2;
         _loc8_ = this.getEffect("unyielding");
      ...
      public function checkUnyielding(param1:*) : *
      {
         ...
         _loc3_ = this.getEffect("unyielding");
      ...
      public function disablePassiveTalentEffect() : void
      {
         ...
         if(Boolean(_loc1_) && Boolean(_loc1_.isCharacter()))
         {
            _loc2_ = new Object();
            ...
            _loc3_ = int(_loc1_.character_manager.recalculateHP());
            _loc4_ = int(_loc1_.character_manager.recalculateCP());
      ...
      public function checkReduceHealthEffects(param1:*, param2:int) : int
      {
         ...
         _loc9_ = this.getActiveBuff("damage_reduction");
         _loc9_ = _loc9_.concat(this.getActiveBuff("damage_reduce"));
         ...
         _loc11_ = this.getEffect("damage_absorption");
         if(_loc11_.duration > 0 && !BattleVars.REDUCED_HP_AS_DAMAGE)
         {
         ...
         _loc12_ = this.getEffect("liquidation_armor");
         if(_loc12_.duration > 0 && !BattleVars.REDUCED_HP_AS_DAMAGE)
         {
         ...
         _loc13_ = this.getEffect("venom_spread");
         if(_loc13_.duration > 0)
         {
            _loc25_ = int(_loc5_.health_manager.getMaxHP());
            _loc26_ = int(_loc5_.health_manager.getMaxCP());
            _loc27_ = int(_loc5_.health_manager.getMaxSP());
         ...
         _loc14_ = this.getEffect("pet_serene_mind") || this.getEffect("serene_mind");
         if(_loc14_ != null && _loc14_.duration > 0)
         {
            _loc5_.health_manager.reduceHealth(param2,"Pet Serene Mind -");
            return 0;
         }
         _loc15_ = this.getEffect("breakthrough");
         if(_loc15_.duration > 0 && !BattleVars.REDUCED_HP_AS_DAMAGE)
         {
      ...
      private function applyCPShieldDamageReduction(param1:Object, param2:int, param3:int, param4:Object, param5:String, param6:int = 0) : int
      {
         ...
         _loc8_ = Math.floor(param2 * _loc7_ / 100);
         if(_loc8_ <= 0)
         {
            return param2;
         }
      ...
      public function parasiteDrain(param1:Object) : *
      {
         ...
         _loc7_ = int(_loc3_.health_manager.getCurrentHP());
         if(_loc7_ > 0)
         {
            if(param1.calc_type == "percent")
            {
