package Combat
{
   ...
   public class EnemyAI
   {
      ...
      public function decideAction(param1:Object, param2:Array, param3:Array = null) : Object
      {
         ...
         var _loc4_:Object = consumeDebugManualAction(param1);
         if(_loc4_ != null)
         {
         ...
         _loc7_ = this.selectTeamSurvivalAction(param1,param3,_loc6_);
         if(_loc7_)
         {
            return _loc7_;
         }
         _loc7_ = this.selectTeamPurifyAction(param1,param3,_loc6_);
         if(_loc7_)
         {
            return _loc7_;
         }
         _loc7_ = this.selectSelfSurvivalAction(param1,_loc5_);
         if(_loc7_)
         {
            return _loc7_;
         }
         var _loc8_:Object = this.findRuthlessTarget(param1,param2);
         var _loc9_:Object = _loc8_.model;
         var _loc10_:int = int(_loc8_.index);
         if(!_loc9_)
         {
         ...
         _loc7_ = this.selectUtilityPlannedAction(param1,_loc9_,_loc11_,_loc10_,param3,_loc6_,_loc12_);
         if(_loc7_)
         {
            return _loc7_;
         }
      ...
      private function selectTeamSurvivalAction(param1:Object, param2:Array, param3:Object) : Object
      {
         ...
         {
            _loc4_ = this.findReadySkillByType(param1,TYPE_HEAL,false,"master");
            if(_loc4_)
            {
         ...
         {
            _loc5_ = this.findReadySkillByType(param1,TYPE_HEAL,true);
            if(_loc5_)
            {
      ...
      private function selectTeamPurifyAction(param1:Object, param2:Array, param3:Object) : Object
      {
         ...
         var _loc4_:Object = this.findReadySkillByType(param1,TYPE_PURIFY,true);
         if(_loc4_)
         {
      ...
      private function selectUtilityPlannedAction(param1:Object, param2:Object, param3:Object, param4:int, param5:Array, param6:Object, param7:Object) : Object
      {
         ...
         while(_loc15_ < _loc8_.length)
         {
            ...
            _loc10_ = this.chooseBestOverride(_loc10_,this.getLethalOverride(param1,param2,_loc20_));
            if(_loc10_ != null && !ENABLE_AI_LOG)
            {
               break;
            }
         ...
         var _loc17_:Boolean = this.isFriendlyAction(_loc9_.metadata);
         var _loc18_:int = _loc17_ ? this.selectFriendlyTargetIndex(_loc9_.metadata,param5,param6,param1) : param4;
      ...
      private function pickJitteredBest(param1:Array, param2:Object) : Object
      {
         ...
         var _loc3_:Number = param2 != null ? Number(param2.score) : Number.NEGATIVE_INFINITY;
         var _loc4_:int = 0;
         ...
         while(_loc8_ < param1.length)
         {
            ...
            if(_loc12_ != null && Number(_loc12_.score) >= _loc5_)
            {
      ...
      private function getLethalOverride(param1:Object, param2:Object, param3:Object) : Object
      {
         ...
         var _loc4_:Number = param2.health_manager != null ? Number(param2.health_manager.getCurrentHP()) : 0;
      ...
      private function getSurvivalOverride(param1:Object, param2:Object, param3:Object, param4:Object) : Object
      {
         ...
         else if(Boolean(_loc5_.tag_map.control) && Boolean(!param4.enemy_disabled) && !param4.enemy_protected)
         {
            _loc6_ = 680 + this.scoreUtilityEffects(_loc5_.effects,param4);
         }
         else if(Boolean(_loc5_.tag_map.purify) && param4.self_debuff_count > 0)
         {
      ...
      private function buildActionCandidates(param1:Object, param2:Object) : Array
      {
         ...
         if(param1.hasOwnProperty("actions_manager") && param1.actions_manager != null)
         {
            ...
            if(Boolean(_loc6_.class_skill) && Boolean(_loc6_.class_skill.getCurrentCooldown() <= 0) && this.canAffordCharacterSkill(param1,_loc6_.class_skill.skill_info,5))
            {
         ...
         var _loc4_:Object = this.getUnitInfo(param1);
         if(_loc4_ == null || _loc4_.attacks == null)
         {
            return _loc3_;
         }
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.attacks.length)
         {
            ...
            _loc8_ = Boolean(_loc4_.curr_skill_cooldowns) && _loc5_ < _loc4_.curr_skill_cooldowns.length ? int(_loc4_.curr_skill_cooldowns[_loc5_]) : 0;
      ...
      private function appendCharacterCandidates(param1:Array, param2:Object, param3:Array, param4:int, param5:Object) : void
      {
         ...
         while(_loc6_ < param3.length)
         {
            ...
            if((Boolean(_loc7_)) && Boolean(_loc7_.getCurrentCooldown() <= 0) && this.canAffordCharacterSkill(param2,_loc7_.skill_info,param4))
            {
      ...
      private function scoreCandidatePrepass(param1:Object, param2:Object) : Number
      {
         ...
         if(Boolean(_loc3_.tag_map.buff) || Boolean(_loc3_.tag_map.setup))
         {
         ...
         _loc4_ -= this.getRepeatPenalty(this.getActionKey(param1.type,param1.index)) * 0.5;
         return _loc4_ - param1.tie_breaker * 0.001;
      }
      ...
      private function scoreCheapSetupValue(param1:Object, param2:Object) : Number
      {
         ...
         if(Boolean(param2 != null) && Boolean(param2.has_damage_boost) && !this.hasDefensiveMetadataEffect(param1))
         {
            _loc3_ -= 45;
         }
      ...
      private function evaluateSkillAction(param1:Object, param2:Object, param3:Object, param4:Object, param5:Array, param6:Object, param7:Object) : Object
      {
         ...
         var _loc27_:Number = _loc11_ + _loc12_ + _loc13_ + _loc14_ + _loc16_ - _loc15_;
         _loc27_ = _loc27_ + (_loc17_ + _loc18_ + _loc19_ + _loc20_ + _loc21_ + _loc22_ + _loc23_ + _loc24_ + _loc25_ + _loc26_);
      ...
      private function buildSkillMetadata(param1:Object) : Object
      {
         ...
         var _loc6_:int = 0;
         while(Boolean(_loc4_) && _loc6_ < _loc4_.length)
         {
      ...
      {
         if(param3 == null || param3 == "" || Boolean(param2[param3]))
         {
            return;
         }
         param2[param3] = true;
      ...
      private function scoreImmediateValue(param1:Object, param2:Object, param3:Object, param4:Number, param5:Number, param6:Object, param7:Object, param8:Object) : Number
      {
         ...
         if(param3.tag_map.damage)
         {
            ...
            _loc11_ = Math.min(1.5,param5 / _loc10_);
            _loc12_ = _loc11_ * 180;
      ...
      private function scoreBurstWindow(param1:Object, param2:Object, param3:Object, param4:Number, param5:Object, param6:Object) : Number
      {
         ...
         var _loc7_:Number = 0;
         if(Boolean(param3.tag_map.damage) && this.isTargetVulnerable(param5))
         {
      ...
      private function estimateNextTurnDamageWithBuff(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object) : Number
      {
         ...
         var _loc6_:Number = this.getBestFutureActualDamage(param1,param2,param4);
         if(_loc6_ <= 0)
         {
            return 0;
         }
         ...
         var _loc10_:Number = this.hasDefensiveMetadataEffect(param3) ? 0.75 + Math.max(0,1 - param5.self_hp_ratio) : 1;
         var _loc11_:Number = this.metadataTargetsTeam(param3) ? 1.25 : 1;
      ...
      private function estimateDebuffExtraDamage(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Number
      {
         ...
         var _loc7_:Number = this.getBestFutureActualDamage(param1,param2,param4);
         if(_loc7_ <= 0)
         {
            return 0;
         }
         ...
         var _loc11_:Number = this.isTargetVulnerable(param5) ? 1.25 : 1;
         var _loc12_:Number = param6 != null && Boolean(param6.enemy_protected) ? 0.45 : 1;
      ...
      private function getBuffDamageMultiplier(param1:Object) : Number
      {
         ...
         var _loc2_:Number = this.hasDamageBoostMetadataEffect(param1) ? 0.5 : 0.18;
         var _loc3_:int = 0;
         while(param1 != null && param1.effects != null && _loc3_ < param1.effects.length)
         {
            _loc4_ = param1.effects[_loc3_];
            if(_loc4_ != null && this.detectSingleEffectType(_loc4_,TYPE_BUFF))
            {
               _loc5_ = this.getEffectAmountRatio(_loc4_);
               if(DAMAGE_BOOST_EFFECTS[_loc4_.effect])
               {
                  _loc2_ = Math.max(_loc2_,_loc5_ > 0 ? _loc5_ : 0.5);
               }
      ...
      private function getDebuffExploitMultiplier(param1:Object) : Number
      {
         ...
         {
            _loc4_ = param1.effects[_loc3_];
            if(_loc4_ != null && this.detectSingleEffectType(_loc4_,TYPE_DEBUFF))
            {
               _loc5_ = this.getEffectAmountRatio(_loc4_);
               if(Boolean(VULNERABILITY_EFFECTS[_loc4_.effect]) || Boolean(OFFENSIVE_DEBUFF_EFFECTS[_loc4_.effect]))
               {
                  _loc2_ = Math.max(_loc2_,_loc5_ > 0 ? _loc5_ : 0.35);
               }
      ...
      private function getEffectAmountRatio(param1:Object) : Number
      {
         ...
         if(param1.hasOwnProperty("amount"))
         {
            ...
            return _loc2_ > 1 ? _loc2_ / 100 : _loc2_;
         }
         return 0;
      }
      ...
      private function getMetadataDurationFactor(param1:Object) : Number
      {
         ...
         {
            _loc4_ = param1.effects[_loc3_];
            if(_loc4_ != null && _loc4_.hasOwnProperty("duration"))
            {
      ...
      private function getMetadataChanceFactor(param1:Object) : Number
      {
         ...
         {
            _loc5_ = param1.effects[_loc4_];
            if(_loc5_ != null && _loc5_.hasOwnProperty("chance"))
            {
      ...
      {
         var _loc3_:Boolean = this.getBestFutureActualDamage(param1,param2,this.currentTargetModel) > 0;
         return _loc3_ ? 1 : 0.35;
      }
      ...
      private function scoreExpectedValue(param1:Object, param2:Object, param3:Object, param4:Number, param5:Object, param6:Object, param7:Object) : Number
      {
         ...
         var _loc9_:Number = 0;
         if(Boolean(param3.tag_map.damage) && _loc8_ < 1)
         {
      ...
      private function scoreTwoTurnLookahead(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Number
      {
         ...
         var _loc9_:Number = Math.min(120,_loc7_ / Math.max(1,param6.current_hp) * 80);
         _loc9_ = _loc9_ + Math.min(90,_loc8_ / Math.max(1,param6.current_hp) * 55);
         if(Boolean(param3.tag_map.buff) || Boolean(param3.tag_map.debuff) || Boolean(param3.tag_map.setup))
         {
      ...
      private function scoreResourcePlanning(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object) : Number
      {
         ...
         if(Boolean(param3.tag_map.setup) || Boolean(param3.tag_map.buff) || Boolean(param3.tag_map.debuff))
         {
      ...
      private function scoreTeamCoordination(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Array, param7:Object, param8:Object) : Number
      {
         ...
         if(Boolean(param3.tag_map.debuff) && Boolean(param4 != null) && this.hasActiveMetadataEffect(param4,param3))
         {
            _loc9_ -= 120;
         }
         if(Boolean(param3.tag_map.debuff && _loc12_ != null && _loc12_.effect != null) && Boolean(this.metadataHasEffect(param3,_loc12_.effect)) && this.decisionTurn - int(_loc12_.turn) <= 2)
         {
            _loc9_ -= 95;
         }
         if(Boolean(param3.tag_map.debuff) && Boolean(param6 != null) && param6.length > 1)
         {
            _loc9_ += Math.min(120,this.getBestTeamFutureDamage(param6,param1,param4) / Math.max(1,param5.current_hp) * 90);
         }
         if(Boolean(param3.tag_map.damage && this.isTargetVulnerable(param5)) && Boolean(param6 != null) && param6.length > 1)
         {
            _loc9_ += 45;
         }
      ...
      private function scoreSurvivalRisk(param1:Object, param2:Object, param3:Object, param4:Object) : Number
      {
         ...
         if(this.hasDefensiveMetadataEffect(param2) || Boolean(param2.tag_map.purify))
         {
            _loc6_ += 115 * _loc5_;
         }
         if(Boolean(param2.tag_map.control) && Boolean(!param3.enemy_disabled) && !param3.enemy_protected)
         {
            _loc6_ += 90 * _loc5_;
         }
         if(Boolean((param2.tag_map.setup || param2.tag_map.buff) && !this.hasDefensiveMetadataEffect(param2)) && Boolean(!param2.tag_map.healing) && _loc5_ > 0.7)
         {
            _loc6_ -= 120 * _loc5_;
         }
         return _loc6_;
      ...
      private function scoreIntentAlignment(param1:Object, param2:Object, param3:Object) : Number
      {
         ...
         {
            if(Boolean(param1.tag_map.healing) || Boolean(this.hasDefensiveMetadataEffect(param1)) || Boolean(param1.tag_map.purify))
            {
               return 70;
            }
            ...
            if(Boolean(param1.tag_map.setup) && !this.hasDefensiveMetadataEffect(param1))
            {
               return -45;
            }
         }
         ...
         {
            if(Boolean(param1.tag_map.setup) || Boolean(param1.tag_map.buff) || Boolean(param1.tag_map.debuff))
            {
               return 55;
            }
            if(Boolean(param1.tag_map.damage) && param3.hp_ratio > 0.45)
            {
               return -20;
            }
         }
         else if(this.currentIntent == INTENT_BURST_READY)
         {
            ...
            if(Boolean(param1.tag_map.debuff) && !param3.is_vulnerable)
            {
               return 35;
            }
         }
         ...
         {
            if(Boolean(param1.tag_map.damage) || Boolean(param1.tag_map.finisher))
            {
               return 45;
            }
            if(Boolean(param1.tag_map.healing) && param2.self_hp_ratio > 0.55)
            {
               return -55;
            }
         }
      ...
      private function scorePersonalityModifier(param1:Object, param2:Object, param3:Object) : Number
      {
         if(this.currentPersonality == PERSONALITY_BERSERKER)
         {
            ...
            if(Boolean(param1.tag_map.healing) && param2.self_hp_ratio > 0.25)
            {
               return -40;
            }
            if(Boolean(param1.tag_map.setup) && param3.hp_ratio > 0.6)
            {
               return 20;
            }
         }
         ...
         {
            if(Boolean(param1.tag_map.healing) || Boolean(this.hasDefensiveMetadataEffect(param1)) || this.metadataTargetsTeam(param1))
            {
               return 45;
            }
            if(Boolean(param1.tag_map.damage) && param2.self_hp_ratio < 0.35)
            {
               return -25;
            }
         }
         ...
         {
            if(Boolean(param1.tag_map.setup) || Boolean(param1.tag_map.debuff) || param1.next_skill >= 0)
            {
               return 35;
            }
            if(Boolean(param1.tag_map.disperse) && param2.enemy_buff_count > 0)
            {
               return 25;
            }
         }
         ...
         {
            if(Boolean(param1.tag_map.control) || Boolean(param1.tag_map.debuff) || Boolean(param1.tag_map.disperse))
            {
               return 45;
            }
            if(Boolean(param1.tag_map.damage) && param3.hp_ratio > 0.45)
         ...
         {
            if(Boolean(param1.tag_map.healing) || Boolean(param1.tag_map.purify) || this.metadataTargetsTeam(param1))
            {
               return 55;
            }
            if(Boolean(param1.tag_map.damage) && param2.self_hp_ratio < 0.45)
            {
               return -20;
            }
         }
      ...
      private function scorePlanningMemory(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object) : Number
      {
         ...
         if(this.plannedTarget != null && this.plannedTarget == _loc7_)
         {
            ...
            if(this.plannedIntent == INTENT_SETUP && (Boolean(param3.tag_map.damage) || Boolean(param3.tag_map.finisher) || Boolean(param5.is_vulnerable)))
            {
               _loc6_ += 65;
            }
            if(Boolean(this.plannedIntent == INTENT_CONTROL) && Boolean(param3.tag_map.damage) && this.targetIsDisabled(param4))
            {
               _loc6_ += 45;
            }
         }
         if(this.lastSetupTarget != null && this.lastSetupTarget == _loc7_ && this.turnsSinceSetup <= 2 && Boolean(param3.tag_map.damage))
         {
            _loc6_ += 60;
         }
         return _loc6_;
      ...
      private function scoreAntiStupidRules(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Number
      {
         ...
         if(Boolean(param3.tag_map.healing) && Boolean(param6.self_hp_ratio > 0.62) && _loc8_ < 0.25)
         {
            _loc7_ -= 130;
         }
         if(Boolean(param3.tag_map.debuff) && Boolean(param4 != null) && this.hasActiveMetadataEffect(param4,param3))
         ...
         if(Boolean((param3.tag_map.setup || param3.tag_map.buff) && !this.hasDefensiveMetadataEffect(param3)) && Boolean(!param3.tag_map.healing) && _loc8_ > 0.75)
         {
            _loc7_ -= 150;
         }
         if(Boolean(param3.tag_map.buff) && this.hasActiveMetadataEffect(param1,param3))
         {
            _loc7_ -= 130;
         }
         if(Boolean(param3.tag_map.buff && this.getMetadataDurationFactor(param3) <= 0.95) && Boolean(param6.self_hp_ratio < 0.25) && !this.hasDefensiveMetadataEffect(param3))
         {
            _loc7_ -= 60;
         }
         if(Boolean(param3.tag_map.damage) && param5.hp_ratio <= 0.3)
         {
            _loc7_ += 55;
         }
         if(Boolean(param3.tag_map.damage) && Boolean(param4 != null) && param4.health_manager != null)
         {
            _loc9_ = this.estimateActualDamage(param1,param2.skill,param4) - param4.health_manager.getCurrentHP();
            if(_loc9_ > param4.health_manager.getMaxHP() * 0.35 && !param3.tag_map.finisher)
            {
               _loc7_ -= 50;
            }
         }
      ...
      private function scoreStrategicValue(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Number
      {
         ...
         if(Boolean(param3.tag_map.buff) && !this.hasActiveMetadataEffect(param1,param3))
         {
            _loc7_ += param4.self_hp_ratio < 0.45 ? 95 : 55;
            _loc7_ = _loc7_ + this.normalizeFutureDamageValue(this.estimateNextTurnDamageWithBuff(param1,param6,param3,param2,param4),param5);
         }
         if(Boolean(param3.tag_map.debuff) && Boolean(!this.hasActiveMetadataEffect(param2,param3)) && !param4.enemy_protected)
         {
            _loc8_ = param5.hp_ratio > 0.35 ? (param4.enemy_threat >= 90 ? 150 : 110) : (param5.hp_ratio <= FINISH_HP_RATIO ? 0 : 45);
            _loc7_ += _loc8_;
            _loc7_ = _loc7_ + this.estimateDebuffExploitScore(param1,param6,param3,param2,param5,param4);
         }
         if(Boolean(param3.tag_map.disperse) && param4.enemy_buff_count > 0)
         {
         ...
         if(Boolean(param3.tag_map.control) && Boolean(!param4.enemy_disabled) && !param4.enemy_protected)
         {
            _loc7_ += 85;
         }
         return _loc7_;
      ...
      private function scoreComboPotential(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Number
      {
         var _loc9_:Object = null;
         var _loc7_:Number = 0;
         var _loc8_:Number = Math.max(1,param6 != null ? Number(param6.current_hp) : 1);
         ...
         {
            _loc9_ = this.getUnitSkillByIndex(param1,param3.next_skill);
            if(_loc9_ != null && this.comboSkillCanRunNextTurn(param1,param3.next_skill,param2))
            {
               _loc7_ += Math.max(25,Math.min(180,this.estimateActualDamage(param1,_loc9_,param5) / _loc8_ * 160));
            }
         }
         if(Boolean(param3.tag_map.debuff) || Boolean(param3.tag_map.control))
         {
      ...
      {
         var _loc5_:Number = this.decisionTurn <= 2 && Boolean(param2.tag_map.setup) ? 35 : 0;
         if(Boolean(param2.tag_map.finisher) && param4.hp_ratio <= 0.35)
         {
            _loc5_ += 120;
         }
         if(Boolean(param2.tag_map.healing) && param3.self_hp_ratio < 0.4)
         {
            _loc5_ += 120;
         }
      ...
      private function scoreRiskValue(param1:Object, param2:Object, param3:Object, param4:Object, param5:Number, param6:Object, param7:Object) : Number
      {
         ...
         if(Boolean(param4.tag_map.buff) && Boolean(this.hasActiveMetadataEffect(param1,param4)) || Boolean(param4.tag_map.debuff) && Boolean(this.hasActiveMetadataEffect(param2,param4)))
         {
            _loc8_ += 140;
         }
         if(Boolean(param4.tag_map.control) && Boolean(param6.enemy_disabled))
         {
            _loc8_ += 120;
         }
         if(Boolean(param4.tag_map.debuff) && Boolean(param6.enemy_protected))
         {
            _loc8_ += 150;
         }
         ...
         if(Boolean(param4.tag_map.disperse) && param6.enemy_buff_count == 0)
         {
            _loc8_ += 90;
         }
         return _loc8_;
      ...
      private function estimateLookaheadValue(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object = null) : Number
      {
         ...
         var _loc7_:Number = Math.min(220,_loc6_ / Math.max(1,param5 != null && param5.health_manager != null ? Number(param5.health_manager.getCurrentHP()) : 1) * 160);
         if(Boolean(param3.tag_map.setup) || Boolean(param3.tag_map.buff) || Boolean(param3.tag_map.debuff))
         {
            _loc7_ += 120 + Math.min(140,_loc6_ / Math.max(1,param5 != null && param5.health_manager != null ? Number(param5.health_manager.getCurrentHP()) : 1) * 120);
         }
         if(param3.next_skill >= 0)
         {
            _loc8_ = this.getUnitSkillByIndex(param1,param3.next_skill);
            if(_loc8_ != null && this.comboSkillCanRunNextTurn(param1,param3.next_skill,param2))
            {
               _loc7_ += Math.min(180,this.estimateActualDamage(param1,_loc8_,param5) / Math.max(1,param5 != null && param5.health_manager != null ? Number(param5.health_manager.getCurrentHP()) : 1) * 160);
            }
         }
      ...
      private function getBestFutureDamage(param1:Object, param2:Object) : Number
      {
         ...
         if(param1.hasOwnProperty("actions_manager") && param1.actions_manager != null)
         {
            ...
            if(Boolean(this.canEvaluateMoreLookahead()) && Boolean(param1.actions_manager.class_skill) && this.willCharacterSkillBeReadyNextTurn(param1.actions_manager.class_skill,5,0,param2))
            {
               ++this.lookaheadEvaluationCount;
      ...
      private function getBestFutureActualDamage(param1:Object, param2:Object, param3:Object) : Number
      {
         var _loc6_:int = 0;
         var _loc4_:Number = 0;
         var _loc5_:Object = this.getUnitInfo(param1);
         if(_loc5_ != null && _loc5_.attacks != null)
         {
            _loc6_ = 0;
      ...
      private function getBestFutureActualDamageTwoTurns(param1:Object, param2:Object, param3:Object) : Number
      {
         ...
         if(param1.hasOwnProperty("actions_manager") && param1.actions_manager != null)
         {
            ...
            if(Boolean(param1.actions_manager.class_skill) && this.willCharacterSkillBeReadyWithinTurns(param1.actions_manager.class_skill,5,0,param2,2))
            {
      ...
      private function willUnitSkillBeReadyNextTurn(param1:Object, param2:int, param3:Object) : Boolean
      {
         ...
         var _loc4_:int = Boolean(param1.curr_skill_cooldowns) && param2 < param1.curr_skill_cooldowns.length ? int(param1.curr_skill_cooldowns[param2]) : 0;
         return _loc4_ <= 1;
      }
      ...
      private function willUnitSkillBeReadyWithinTurns(param1:Object, param2:int, param3:Object, param4:int) : Boolean
      {
         ...
         var _loc5_:int = Boolean(param1.curr_skill_cooldowns) && param2 < param1.curr_skill_cooldowns.length ? int(param1.curr_skill_cooldowns[param2]) : 0;
      ...
      private function getBestDamageInCharacterArray(param1:Array, param2:int, param3:Object) : Number
      {
         var _loc4_:Number = 0;
         var _loc5_:int = 0;
         while(Boolean(param1) && Boolean(_loc5_ < param1.length) && this.canEvaluateMoreLookahead())
         {
      ...
      private function getBestDamageInCharacterArrayWithinTurns(param1:Array, param2:int, param3:Object, param4:int, param5:Object, param6:Object) : Number
      {
         var _loc7_:Number = 0;
         var _loc8_:int = 0;
         while(Boolean(param1) && Boolean(_loc8_ < param1.length) && this.canEvaluateMoreLookahead())
         {
      ...
      private function canKillNextTurnWithSetup(param1:Object, param2:Object, param3:Object, param4:Object, param5:Object, param6:Object) : Boolean
      {
         ...
         if(Boolean(param3.tag_map.damage) && this.canKillTarget(param1,param2,param4))
         {
            return false;
         }
         var _loc7_:Number = 0;
      ...
      private function estimateActualDamage(param1:Object, param2:Object, param3:Object = null) : Number
      {
         ...
         var _loc4_:Number = this.estimateCandidateDamage(param2);
         if(_loc4_ <= 0)
         {
            return 0;
         }
      ...
      private function getBestFutureHighImpactCPCost(param1:Object, param2:Object, param3:Object) : Number
      {
         ...
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
         var _loc6_:Object = this.getUnitInfo(param1);
         if(_loc6_ != null && _loc6_.attacks != null)
         {
            _loc7_ = 0;
            while(_loc7_ < _loc6_.attacks.length && this.canEvaluateMoreLookahead())
            {
               ...
               {
                  ++this.lookaheadEvaluationCount;
                  _loc8_ = this.estimateActualDamage(param1,_loc6_.attacks[_loc7_],param3);
                  if(_loc8_ > _loc5_)
                  {
                     _loc5_ = _loc8_;
      ...
      private function getBestHighImpactCostInCharacterArray(param1:Object, param2:Array, param3:int, param4:Object, param5:Object) : Number
      {
         ...
         var _loc7_:Number = 0;
         var _loc8_:int = 0;
         while(Boolean(param2) && Boolean(_loc8_ < param2.length) && this.canEvaluateMoreLookahead())
         {
            ...
            {
               ++this.lookaheadEvaluationCount;
               _loc9_ = this.estimateActualDamage(param1,param2[_loc8_].skill_info,param5);
               if(_loc9_ > _loc7_)
               {
                  _loc7_ = _loc9_;
      ...
      private function estimateDefensiveExpectedValue(param1:Object, param2:Object) : Number
      {
         ...
         var _loc5_:Number = param2 != null ? Math.max(0.2,1 - param2.self_hp_ratio) : 0.4;
      ...
      private function estimateDeathRisk(param1:Object, param2:Object, param3:Object) : Number
      {
         ...
         if(param1 == null || param2 == null)
         {
            ...
            _loc7_ = param3.self_hp_ratio < 0.25 ? 0.85 : 0;
            _loc7_ = _loc7_ + (param3.enemy_threat > 120 ? 0.25 : 0);
         ...
         _loc6_ = _loc6_ + (param3 != null && param3.self_hp_ratio < 0.25 ? 0.35 : 0);
         _loc6_ = _loc6_ + (param3 != null && param3.enemy_threat > 110 ? 0.2 : 0);
      ...
      private function getBestTeamFutureDamage(param1:Array, param2:Object, param3:Object) : Number
      {
         ...
         while(param1 != null && _loc5_ < param1.length)
         {
            ...
            if(_loc6_ != null && _loc6_ != param2 && _loc6_.health_manager != null && !_loc6_.health_manager.isDead())
            {
      ...
      {
         var _loc2_:Number = param1 != null && "getLevel" in param1 ? Number(param1.getLevel()) : 1;
      ...
      private function hasDamageBoostMetadataEffect(param1:Object) : Boolean
      {
         ...
         while(_loc2_ < param1.effects.length)
         {
            ...
            if(_loc3_ != null && Boolean(DAMAGE_BOOST_EFFECTS[_loc3_.effect]))
            {
               return true;
            }
            _loc2_++;
      ...
      private function hasDefensiveMetadataEffect(param1:Object) : Boolean
      {
         ...
         {
            _loc3_ = param1.effects[_loc2_];
            if(_loc3_ != null && Boolean(DEFENSIVE_BUFF_EFFECTS[_loc3_.effect]))
            {
               return true;
            }
            _loc2_++;
      ...
      private function hasVulnerabilityMetadataEffect(param1:Object) : Boolean
      {
         ...
         {
            _loc3_ = param1.effects[_loc2_];
            if(_loc3_ != null && Boolean(VULNERABILITY_EFFECTS[_loc3_.effect]))
            {
               return true;
            }
            _loc2_++;
      ...
      private function analyzeDotPressure(param1:Object) : Object
      {
         ...
         {
            _loc5_ = param1.effects_manager.dataDebuff[_loc4_];
            if(_loc5_ != null && int(_loc5_.duration) > 0 && this.isPurifiableDotEffect(_loc5_.effect))
            {
               ++_loc2_.count;
      ...
      private function hasActiveMetadataEffect(param1:Object, param2:Object) : Boolean
      {
         ...
         {
            _loc4_ = param2.effects[_loc3_];
            if(_loc4_ != null && Boolean(param1.effects_manager.hadEffect(_loc4_.effect)))
            {
               return true;
            }
            _loc3_++;
      ...
      private function isFriendlyAction(param1:Object) : Boolean
      {
         ...
         if(param1.tag_map != null && Boolean(param1.tag_map.damage))
         {
            return false;
         }
      ...
      {
         if(Boolean(param1.is_self_skill) || this.metadataTargetsSelf(param1))
         {
            return this.getSelfTargetIndex(param4);
         }
         if(Boolean(param1.tag_map.healing) && param3 != null)
         {
            return param3.index;
         }
      ...
      private function metadataTargetsTeam(param1:Object) : Boolean
      {
         ...
         return Boolean(param1.tag_map.aoe) && Boolean(param1.tag_map.buff);
      }
      ...
      private function findRuthlessTarget(param1:Object, param2:Array) : Object
      {
         ...
         var _loc4_:Object = this.findMainPlayerTarget(param2);
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         while(_loc10_ < param2.length && this.evaluatedTargetCount < MAX_EVALUATED_TARGETS)
         {
            ...
            if((Boolean(_loc11_)) && !_loc11_.health_manager.isDead())
            {
               ++this.evaluatedTargetCount;
               _loc12_ = Boolean(_loc11_.effects_manager.hadEffect("sleep")) || Boolean(_loc11_.effects_manager.hadEffect("pet_sleep"));
               _loc13_ = _loc11_.health_manager.getCurrentHP() / _loc11_.health_manager.getMaxHP();
               _loc14_ = Number(_loc11_.health_manager.getCurrentCP());
         ...
         if(_loc5_ == null && param2.length > 0)
         {
            ...
            {
               _loc16_ = param2[_loc15_];
               if(_loc16_ != null && _loc16_.health_manager != null && !_loc16_.health_manager.isDead())
               {
                  _loc5_ = _loc16_;
                  _loc6_ = _loc15_;
                  break;
      ...
      private function findFinishableTarget(param1:Array) : Object
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc7_ != null && _loc7_.health_manager != null && !_loc7_.health_manager.isDead() && _loc7_.health_manager.getMaxHP() > 0)
            {
               _loc8_ = _loc7_.effects_manager != null && (Boolean(_loc7_.effects_manager.hadEffect("sleep")) || Boolean(_loc7_.effects_manager.hadEffect("pet_sleep")));
               if(!((_loc8_) && _loc2_))
               {
                  _loc9_ = Number(_loc7_.health_manager.getCurrentHP());
                  _loc10_ = _loc9_ / _loc7_.health_manager.getMaxHP();
                  _loc11_ = this.previousTargetKey != null && this.getTargetMemoryKey(_loc7_) == this.previousTargetKey && this.previousTargetHP >= 0 && _loc9_ >= this.previousTargetHP;
      ...
      private function analyzeTeamState(param1:Array) : Object
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:Object = param1.length > 0 ? param1[0] : null;
         var _loc8_:Number = (Boolean(_loc7_)) && !_loc7_.health_manager.isDead() ? _loc7_.health_manager.getCurrentHP() / _loc7_.health_manager.getMaxHP() : 1;
         var _loc9_:int = Boolean(_loc7_) && !_loc7_.health_manager.isDead() ? this.getBuffCount(_loc7_) : 0;
         var _loc10_:int = 0;
         while(_loc10_ < param1.length)
         {
            ...
            {
               _loc5_++;
               _loc12_ = _loc11_.health_manager.getCurrentHP() / _loc11_.health_manager.getMaxHP();
               if(_loc12_ < _loc3_)
               {
                  _loc3_ = _loc12_;
                  _loc2_ = _loc10_;
      ...
      private function analyzeTargetState(param1:Object) : Object
      {
         ...
         var _loc2_:Number = param1.health_manager ? param1.health_manager.getCurrentHP() / param1.health_manager.getMaxHP() : 1;
         var _loc3_:Number = param1.health_manager ? Number(param1.health_manager.getCurrentHP()) : 0;
         var _loc4_:Number = param1.health_manager ? Number(param1.health_manager.getCurrentCP()) : 0;
         var _loc5_:Number = param1.health_manager ? Number(param1.health_manager.getMaxCP()) : 0;
         return {
            "hp_ratio":_loc2_,
            "current_hp":_loc3_,
            "cp":_loc4_,
      ...
      private function buildCombatProfile(param1:Object, param2:Object, param3:Object) : Object
      {
         ...
         var _loc5_:Number = Number(param3.hp_ratio);
         var _loc6_:Number = this.getCPRatio(param1);
         var _loc7_:Number = Number(param3.cp_ratio);
         var _loc8_:int = this.getDebuffCount(param1);
         var _loc9_:int = this.getBuffCount(param2);
         var _loc10_:Number = this.previousSelfHP < 0 ? 0 : Math.max(0,this.previousSelfHP - param1.health_manager.getCurrentHP());
         var _loc11_:Number = this.previousTargetHP < 0 ? 0 : Math.max(0,this.previousTargetHP - param2.health_manager.getCurrentHP());
         var _loc12_:Boolean = Boolean(param3.has_debuff_resist) || Boolean(param3.has_flexible);
         var _loc13_:Boolean = this.hasHighValueBuff(param2);
         var _loc14_:Boolean = Boolean(param2.effects_manager.hadEffect("unyielding"));
      ...
      private function selectIntent(param1:Object, param2:Object, param3:Object) : String
      {
         ...
         if(Boolean(param2.is_vulnerable) || param2.hp_ratio <= 0.35)
         {
      ...
      private function resolvePersonality(param1:Object) : String
      {
         ...
         var _loc4_:int = this.stableStringBucket(_loc3_,5);
         if(_loc4_ == 0)
         {
      ...
      private function hasAwakeOpponent(param1:Array) : Boolean
      {
         ...
         while(_loc2_ < param1.length && _loc3_ < MAX_EVALUATED_TARGETS)
         {
            ...
            if((Boolean(_loc4_)) && !_loc4_.health_manager.isDead())
            {
               _loc3_++;
      ...
      private function findReadySkillByType(param1:Object, param2:String, param3:Boolean = false, param4:String = null) : Object
      {
         ...
         if(param1.hasOwnProperty("actions_manager"))
         {
            ...
            _loc8_ = null;
            _loc8_ = this.searchArrayForType(param1,_loc7_.character_skills_mc,param2,2,param3,param4);
            if(_loc8_)
            {
               _loc6_ = this.chooseHigherReadyTypeSkill(_loc6_,_loc8_);
            }
            _loc8_ = this.searchArrayForType(param1,_loc7_.character_talent_skills_mc,param2,3,param3,param4);
            if(_loc8_)
            {
               _loc6_ = this.chooseHigherReadyTypeSkill(_loc6_,_loc8_);
            }
            _loc8_ = this.searchArrayForType(param1,_loc7_.character_senjutsu_skills_mc,param2,4,param3,param4);
            if(_loc8_)
            {
               _loc6_ = this.chooseHigherReadyTypeSkill(_loc6_,_loc8_);
            }
            if(Boolean(_loc7_.class_skill && _loc7_.class_skill.getCurrentCooldown() <= 0) && Boolean(this.canAffordCharacterSkill(param1,_loc7_.class_skill.skill_info,5)) && this.detectTypeFromEffects(_loc7_.class_skill.skill_info.effects,param2,param4))
            {
               _loc9_ = Boolean(_loc7_.class_skill.skill_info.is_aoe) || Boolean(_loc7_.class_skill.skill_info.multi_hit);
         ...
         {
            _loc10_ = this.getUnitInfo(param1);
            if(_loc10_)
            {
               _loc11_ = this.findIndexByType(_loc10_.attacks,_loc10_.curr_skill_cooldowns,param2,param3,param4,_loc10_.skills_available);
               if(_loc11_ != -1)
               {
                  ...
                  _loc6_ = {
                     ...
                     "score":this.scoreReadyTypeChoice(_loc12_,param2,param3,param4,Boolean(_loc12_.multi_hit) || Boolean(_loc12_.is_aoe),_loc11_)
                  };
               }
            }
         }
      ...
      private function searchArrayForType(param1:Object, param2:Array, param3:String, param4:int, param5:Boolean = false, param6:String = null) : Object
      {
         ...
         while(_loc8_ < _loc9_)
         {
            ...
            if(Boolean((_loc10_) && _loc10_.getCurrentCooldown() <= 0) && Boolean(this.canAffordCharacterSkill(param1,_loc10_.skill_info,param4)) && this.detectTypeFromEffects(_loc10_.skill_info.effects,param3,param6))
            {
               _loc11_ = Boolean(_loc10_.skill_info.is_aoe) || Boolean(_loc10_.skill_info.multi_hit);
      ...
      private function findIndexByType(param1:Array, param2:Array, param3:String, param4:Boolean = false, param5:String = null, param6:Array = null) : int
      {
         ...
         while(_loc9_ < _loc10_)
         {
            ...
            else
            {
               ...
               _loc14_ = Boolean(param2) && _loc9_ < param2.length ? int(param2[_loc9_]) : 0;
      ...
      private function scoreReadyTypeChoice(param1:Object, param2:String, param3:Boolean, param4:String, param5:Boolean, param6:int) : Number
      {
         ...
         _loc8_ += this.getMetadataChanceFactor(_loc7_) * 30;
         _loc8_ = _loc8_ + this.getMetadataDurationFactor(_loc7_) * 20;
         return _loc8_ - param6 * 0.001;
      }
      ...
      private function detectTypeFromEffects(param1:Array, param2:String, param3:String = null) : Boolean
      {
         ...
         var _loc4_:Object = EFFECT_TYPE_MAP[param2];
         if(_loc4_ == null)
         {
            return false;
         }
         ...
         while(_loc5_ < _loc6_)
         {
            ...
            else
            {
               ...
               if((!param3 || _loc9_ == param3) && (Boolean(_loc4_[_loc8_]) || Boolean(this.isRegisteredGenericEffectType(_loc8_,param2))))
               {
                  return true;
               }
               _loc5_++;
      ...
      {
         return Boolean(EFFECT_TYPE_MAP.purify[param1]) || Boolean(EFFECT_TYPE_MAP.heal[param1]) || Boolean(EFFECT_TYPE_MAP.resist[param1]) || Boolean(EFFECT_TYPE_MAP.disperse[param1]);
      }
      
      private function isReservedDebuffEffect(param1:String) : Boolean
      {
         return Boolean(EFFECT_TYPE_MAP.stun[param1]) || Boolean(EFFECT_TYPE_MAP.drain[param1]) || Boolean(EFFECT_TYPE_MAP.disperse[param1]);
      }
      ...
      private function targetIsDisabled(param1:Object) : Boolean
      {
         ...
         return Boolean(param1.effects_manager.hadEffect("stun")) || Boolean(param1.effects_manager.hadEffect("pet_stun")) || Boolean(param1.effects_manager.hadEffect("locked")) || Boolean(param1.effects_manager.hadEffect("sleep")) || Boolean(param1.effects_manager.hadEffect("pet_sleep")) || Boolean(param1.effects_manager.hadEffect("internal_injury")) || Boolean(param1.effects_manager.hadEffect("restriction")) || Boolean(param1.effects_manager.hadEffect("pet_restriction")) || Boolean(param1.effects_manager.hadEffect("chaos")) || Boolean(param1.effects_manager.hadEffect("pet_chaos")) || Boolean(param1.effects_manager.hadEffect("frozen")) || Boolean(param1.effects_manager.hadEffect("pet_frozen")) || Boolean(param1.effects_manager.hadEffect("chill")) || Boolean(param1.effects_manager.hadEffect("prison")) || Boolean(param1.effects_manager.hadEffect("pet_prison")) || Boolean(param1.effects_manager.hadEffect("petrify")) || Boolean(param1.effects_manager.hadEffect("pet_petrify")) || Boolean(param1.effects_manager
         .hadEffect("toxic_tooth")) || Boolean(param1.effects_manager.hadEffect("fear")) || Boolean(param1.effects_manager.hadEffect("pet_fear")) || Boolean(param1.effects_manager.hadEffect("time_stop")) || Boolean(param1.effects_manager.hadEffect("barrier"));
      }
      ...
      private function selectBestMove(param1:Object, param2:Object = null) : Object
      {
         ...
         if(param1.hasOwnProperty("actions_manager"))
         {
            _loc4_ = this.selectBestCharacterOffense(param1,param2);
            return _loc4_ != null ? _loc4_ : {
               "type":1,
               "index":0
            };
         }
      ...
      private function selectBestCharacterOffense(param1:Object, param2:Object = null) : Object
      {
         ...
         if(Boolean(_loc3_.class_skill) && Boolean(_loc3_.class_skill.getCurrentCooldown() <= 0) && this.canAffordCharacterSkill(param1,_loc3_.class_skill.skill_info,5))
         {
      ...
      private function findBestSkillInArray(param1:Object, param2:Array, param3:int, param4:Object = null) : Object
      {
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            if(Boolean((_loc8_) && _loc8_.getCurrentCooldown() <= 0) && Boolean(this.canAffordCharacterSkill(param1,_loc8_.skill_info,param3)) && !this.isSupportSkillInfo(_loc8_.skill_info))
            {
      ...
      private function findAvailableOffenseIndex(param1:Array, param2:Array, param3:Object = null, param4:Array = null) : int
      {
         ...
         while(_loc7_ < _loc8_)
         {
            ...
            {
               _loc10_ = Boolean(param2) && _loc7_ < param2.length ? int(param2[_loc7_]) : 0;
               ...
               {
                  _loc11_ = _loc9_.hasOwnProperty("dmg") ? Number(_loc9_.dmg) : 0;
                  if(_loc10_ <= 0 && _loc9_.type != TYPE_PURIFY && _loc9_.type != TYPE_RESIST)
                  {
                     ...
                     _loc14_ = this.scoreSkillChoice(_loc12_,_loc11_,_loc13_,this.getActionKey(-1,_loc7_),param3);
                     if(_loc14_ > _loc6_)
                     {
                        _loc6_ = _loc14_;
                        _loc5_ = _loc7_;
      ...
      private function scoreSkillChoice(param1:Array, param2:Number, param3:Boolean, param4:String, param5:Object = null) : Number
      {
         ...
         if(param5 != null)
         {
            ...
            if(Boolean(param5.enemy_protected) && this.hasEnemyControlEffect(param1))
            {
               _loc6_ -= 180;
            }
         }
         _loc6_ += this.scoreUtilityEffects(param1,param5);
         return _loc6_ - this.getRepeatPenalty(param4);
      }
      ...
      private function scoreUtilityEffects(param1:Array, param2:Object = null) : Number
      {
         ...
         while(_loc4_ < param1.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc3_ += param2 != null && (Boolean(param2.enemy_protected) || Boolean(param2.enemy_buff_count > 0)) ? 140 : 40;
               }
               ...
               else if(_loc7_ == "self" && Boolean(EFFECT_TYPE_MAP.heal[_loc6_]))
               {
                  _loc3_ += param2 != null ? (1 - param2.self_hp_ratio) * 180 + (param2.enemy_threat > 120 ? 35 : 0) : 45;
               }
               else if(_loc7_ == "self" && Boolean(EFFECT_TYPE_MAP.resist[_loc6_]))
               {
                  _loc3_ += param2 != null && param2.enemy_threat > 90 ? 80 : 25;
               }
               else if(_loc7_ == "self" && Boolean(EFFECT_TYPE_MAP.buff[_loc6_]))
               {
      ...
      private function scoreDebuffEffect(param1:String, param2:Object = null) : Number
      {
         ...
         var _loc4_:Boolean = param2 != null && Boolean(param2.enemy_protected);
      ...
      private function detectSingleEffectType(param1:Object, param2:String, param3:String = null) : Boolean
      {
         ...
         return (!param3 || _loc6_ == param3) && (Boolean(_loc4_[_loc5_]) || this.isRegisteredGenericEffectType(_loc5_,param2));
      }
      ...
      {
         var _loc6_:Object = null;
         if(param1 == null || param2 == null || Boolean(param2.hasOwnProperty("is_friendly_target")) && Boolean(param2.is_friendly_target))
         {
            return;
         }
         ...
         {
            _loc6_ = _loc4_.effects[_loc5_];
            if(_loc6_ != null && this.detectSingleEffectType(_loc6_,TYPE_DEBUFF))
            {
      ...
      private function updatePlanningTelemetry(param1:Object, param2:Object) : void
      {
         ...
         if(Boolean(param1.metadata.tag_map.setup) || Boolean(param1.metadata.tag_map.buff) || Boolean(param1.metadata.tag_map.debuff))
         {
            ...
            else if(Boolean(param1.metadata.tag_map.setup || param1.metadata.tag_map.buff) || Boolean(this.hasVulnerabilityMetadataEffect(param1.metadata)) || this.targetHasVulnerability(param2))
            {
      ...
      private function getActorLabel(param1:Object) : String
      {
         ...
         if(param1.hasOwnProperty("player_identification") && Boolean(param1.player_identification))
         {
            return String(param1.player_identification);
         }
         if(Boolean(param1.hasOwnProperty("enemy_info")) && Boolean(param1.enemy_info) && Boolean(param1.enemy_info.hasOwnProperty("enemy_id")))
         {
            return "Enemy#" + String(param1.enemy_info.enemy_id);
         }
         if(Boolean(param1.hasOwnProperty("npc_info")) && Boolean(param1.npc_info) && Boolean(param1.npc_info.hasOwnProperty("npc_id")))
         {
            return "Npc#" + String(param1.npc_info.npc_id);
         }
         if(Boolean(param1.hasOwnProperty("pet_info")) && Boolean(param1.pet_info) && Boolean(param1.pet_info.hasOwnProperty("pet_id")))
         {
      ...
      private function hasDebuffResistEffect(param1:Object) : Boolean
      {
         ...
         return Boolean(param1.effects_manager.hadEffect("debuff_resist")) || Boolean(param1.effects_manager.hadEffect("pet_debuff_resist")) || Boolean(param1.effects_manager.hadEffect("bless")) || Boolean(param1.effects_manager.hadEffect("unyielding")) || Boolean(param1.effects_manager.hadEffect("time_stop"));
      }
      ...
      private function hasAnyActiveEffect(param1:Object, param2:Object) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(_loc5_ != null && Boolean(param2[_loc5_.effect]))
            {
               return true;
            }
            _loc4_++;
      ...
      private function getRepeatPenalty(param1:String) : Number
      {
         ...
         var _loc2_:int = this.usedSkillCounts.hasOwnProperty(param1) ? int(this.usedSkillCounts[param1]) : 0;
      ...
      private function recordActionMemory(param1:Object, param2:Object) : void
      {
         ...
         var _loc4_:Object = this.getRememberedTarget(param2);
         if(_loc4_ != null && _loc4_.health_manager != null)
         {
      ...
      {
         if(param1 == null || Boolean(param1.hasOwnProperty("is_friendly_target")) && Boolean(param1.is_friendly_target))
         {
            return null;
         }
      ...
      private function hasActiveEffectFromAction(param1:Object, param2:Object, param3:Object) : Boolean
      {
         ...
         var _loc4_:Object = this.getSkillFromAction(param2,param3);
         if(_loc4_ == null || _loc4_.effects == null)
         {
            return false;
         }
         for each(_loc5_ in _loc4_.effects)
         {
            if(_loc5_ != null && _loc5_.type == "Buff" && Boolean(param1.effects_manager.hadEffect(_loc5_.effect)))
            {
               return true;
            }
         }
      ...
      {
         var _loc3_:Object = null;
         if(Boolean(param2.type == 2 && param1.character_skills_mc) && Boolean(param2.index >= 0) && param2.index < param1.character_skills_mc.length)
         {
            _loc3_ = param1.character_skills_mc[param2.index];
         }
         else if(Boolean(param2.type == 3 && param1.character_talent_skills_mc) && Boolean(param2.index >= 0) && param2.index < param1.character_talent_skills_mc.length)
         {
            _loc3_ = param1.character_talent_skills_mc[param2.index];
         }
         else if(Boolean(param2.type == 4 && param1.character_senjutsu_skills_mc) && Boolean(param2.index >= 0) && param2.index < param1.character_senjutsu_skills_mc.length)
         {
            _loc3_ = param1.character_senjutsu_skills_mc[param2.index];
         }
         else if(param2.type == 5 && Boolean(param1.class_skill))
         {
