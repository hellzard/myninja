package Combat
{
   ...
   public class EnemyModel
   {
      ...
      public function getAttack(param1:Boolean = true, param2:int = 0) : *
      {
         ...
         var _loc8_:Boolean = !this.enemy_info.hasOwnProperty("enemy_ai") || Boolean(this.enemy_info.enemy_ai);
         if(_loc8_)
         {
         ...
         _loc4_ = int(_loc9_.index);
         if(_loc4_ < 0 || _loc4_ >= this.enemy_info.attacks.length)
         {
            _loc4_ = 0;
         }
         ...
         var _loc14_:Boolean = Boolean(_loc9_.is_friendly_target) && !_loc13_;
         var _loc15_:Array = _loc14_ ? _loc7_ : _loc6_;
         ...
         var _loc20_:Boolean = "is_self_skill" in _loc12_ ? Boolean(_loc12_.is_self_skill) : false;
         var _loc21_:Boolean = this.targetIsSleeping();
         if((_loc21_) && !_loc20_)
         {
         ...
         var _loc23_:int = this.player_team == "player" ? BattleVars.PLAYER_TARGET : BattleVars.ENEMY_TARGET;
      ...
      public function getSkillByPrioritySet(param1:int = 1) : *
      {
         ...
         while(_loc4_.length > 0)
         {
            ...
            if(_loc10_ < 0 || _loc10_ >= this.enemy_info.attacks.length)
            {
      ...
      public function getReactiveForce() : int
      {
         ...
         return BattleManager.modifyChance(_loc3_,"RM",_loc1_,"reactive_force");
      }
      ...
      public function setFrameScript() : void
      {
         ...
         var updateElementAnim:Function;
         var j:int = 0;
      ...
      public function destroy() : *
      {
         ...
         if(_loc1_ != null)
         {
            if(Boolean(_loc1_) && _loc2_ in _loc1_)
            {
               ...
               if(this.object_mc != null && Boolean(_loc1_[_loc2_].charMc.contains(this.object_mc)))
               {
