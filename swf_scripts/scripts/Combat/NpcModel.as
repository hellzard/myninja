package Combat
{
   ...
   public class NpcModel
   {
      ...
      public function getAttack(param1:Boolean = true) : *
      {
         ...
         var _loc8_:Boolean = !this.npc_info.hasOwnProperty("npc_ai") || Boolean(this.npc_info.npc_ai);
         if(_loc8_)
         {
         ...
         if(_loc10_ < 0 || _loc10_ >= this.npc_info.attacks.length)
         {
            _loc10_ = 0;
         }
         ...
         var _loc22_:Boolean = this.targetIsSleeping();
         if((_loc22_) && !_loc21_)
         {
      ...
      public function destroy() : *
      {
         ...
         {
            if(Boolean(_loc2_) && Boolean(_loc1_ in _loc2_) && Boolean(_loc2_[_loc1_].charMc.contains(this.object_mc)))
            {
