package Managers
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol9983")]
   public class LoginManager extends MovieClip
   {
      ...
      internal function navigateLink(param1:TextEvent) : void
      {
         var _loc2_:* = param1.currentTarget.name;
         if(_loc2_ == "txt_tnc")
         {
            navigateToURL(new URLRequest("http://127.0.0.1:800/en/term-condition"));
         }
         else if(_loc2_ == "txt_policy")
         {
            navigateToURL(new URLRequest("http://127.0.0.1:800/en/privacy-policy"));
         }
         else if(_loc2_ == "txt_forgot")
         {
            navigateToURL(new URLRequest("http://127.0.0.1:800/en/forgot-password"));
         }
         else if(_loc2_ == "txt_website")
         {
            navigateToURL(new URLRequest("http://127.0.0.1:800/"));
         }
      ...
      internal function navigate(param1:MouseEvent) : void
      {
         var _loc2_:* = param1.currentTarget.name;
      ...
      internal function logResponse(param1:Object) : *
      {
      ...
      internal function registerUser(param1:*, param2:*, param3:*) : *
      {
         this.main.loading(true);
      ...
      internal function regResponse(param1:Object) : void
      {
         this.main.loading(false);
         if(param1.status == 1)
         {
