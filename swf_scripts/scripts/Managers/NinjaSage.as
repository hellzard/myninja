package Managers
{
   ...
   public class NinjaSage
   {
      ...
      private static function onIconItemLoaded(param1:Event) : void
      {
         ...
         if(!_loc3_ || Boolean(_loc3_.isLoaded))
         {
            return;
         }
      ...
      private static function updateLoadedItems() : void
      {
         ...
         {
            if(!(Boolean(_loc2_.isLoaded) || !loader.hasItem(_loc2_.id,false)))
            {
      ...
      private static function getDefaultIconHolder(param1:*) : *
      {
         ...
         if(Boolean(param1.hasOwnProperty("icon")) && Boolean(param1.icon) && Boolean(param1.icon.hasOwnProperty("iconHolder")))
         {
      ...
      {
         return Boolean(param1) && (param1.indexOf("npc_") >= 0 || param1.indexOf("ene_") >= 0 || param1.indexOf("pet_") >= 0);
      }
      ...
      private static function cleanupIconRequest(param1:*) : void
      {
         ...
         try
         {
            if(Boolean(loader) && Boolean(loader.get(param1)))
            {
      ...
      public static function loadItemIcon(param1:*, param2:*, param3:String = "") : void
      {
         ...
         var loadRewardIcon:Function = function(param1:String, param2:*):void
         {
            ...
            var _loc4_:DisplayObject = holderForCurrency.getChildByName(param1);
            if(!_loc4_)
            {
               _loc4_ = new _loc3_();
               _loc4_.name = param1;
      ...
      public static function addStandByFrameScript(param1:*, param2:String = "standby") : *
      {
         ...
         labelFrame = getLabelFrames(mc,labelName);
      ...
      public static function getLabelFrames(param1:MovieClip, param2:String) : Object
      {
         ...
         {
            _loc6_ = param1.currentLabels[_loc5_];
            if(_loc6_.name == param2)
            {
               _loc3_ = int(_loc6_.frame);
