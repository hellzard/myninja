package Managers
{
   ...
   public class StatManager
   {
      ...
      private static function buildEquippedSets(param1:String, param2:String, param3:String, param4:String = null, param5:String = null) : Array
      {
         ...
         return [Boolean(_loc6_) && Boolean(_loc6_.effects) ? _loc6_.effects : [],Boolean(_loc7_) && Boolean(_loc7_.effects) ? _loc7_.effects : [],Boolean(_loc8_) && Boolean(_loc8_.effects) ? _loc8_.effects : [],_loc9_];
      }
      ...
      public static function calculate_stats_with_data(param1:String, param2:int = 0, param3:int = 0, param4:int = 0, param5:int = 0, param6:int = 0, param7:String = "", param8:String = "", param9:String = "", param10:String = null, param11:String = null, param12:String = null, param13:String = null) : *
      {
         ...
         equippedSets = buildEquippedSets(weaponId,backItemId,accessoryId,_clothingId,_hairId);
         result = 0;
         try
         {
            switch(statType)
         ...
         while(_loc7_ < param2.length)
         {
            ...
            while(_loc8_ < _loc6_.length)
            {
               ...
               if(param3.indexOf(_loc5_.effect) >= 0 || param4.indexOf(_loc5_.effect) >= 0)
               {
                  ...
                  {
                     _loc10_ = _loc5_.calc_type == "number" ? _loc9_ : int(Math.floor(_loc9_ * param1 / 100));
                  }
                  else
                  {
                     _loc10_ = _loc9_;
      ...
      {
         var oldTalent:String;
         var oldSenjutsu:String;
         var level:int = 0;
         var earth:int = 0;
         var water:int = 0;
         var wind:int = 0;
         ...
         var clothing:String = null;
         var hair:String = null;
         var equippedSets:Array = null;
         var maxHp:int = 0;
         var characterManager:CharacterManager = param1;
         if(isOwnPlayer(characterManager) && Character.character_hp != null)
         {
            return int(Character.character_hp);
         }
         oldTalent = temp_talent_skills;
         oldSenjutsu = temp_senjutsu_skills;
         try
         {
            level = characterManager.getLevel();
            earth = characterManager.getEarthAttributes();
            water = characterManager.getWaterAttributes();
            wind = characterManager.getWindAttributes();
            lightning = characterManager.getLightningAttributes();
            weapon = canCheckWpnEffects(characterManager) ? characterManager.getWeapon() : "";
            back = characterManager.getBackItem();
            accessory = characterManager.getAccessory();
            clothing = characterManager.getClothing();
            hair = characterManager.getHair();
            _level = level;
            _earth = earth;
            _water = water;
            _wind = wind;
            ...
            _weaponId = weapon;
            _backItemId = back;
            _accessoryId = accessory;
            _clothingId = clothing != null ? clothing : "";
            _hairId = hair != null ? hair : "";
            temp_talent_skills = characterManager.getTalentSkillsString();
            temp_senjutsu_skills = characterManager.getSenjutsuSkillsString();
            equippedSets = buildEquippedSets(weapon,back,accessory,_clothingId,_hairId);
            maxHp = calculateMaxHpFromModifiers(getBaseHp(level,earth),equippedSets,characterManager);
            if(Boolean(Character.is_clan_war) && Boolean(characterManager.characterClanData))
            {
               maxHp += Math.floor(maxHp * int(characterManager.characterClanData.hot_spring * 30) / 100);
            }
            return maxHp;
         }
         finally
      ...
      private static function getIncreaseMaxHPByTalentData(param1:int, param2:int, param3:CharacterManager = null) : int
      {
         ...
         if(Boolean(param3) && Boolean(param3.character_model) && Boolean(param3.character_model.effects_manager) && Boolean(param3.character_model.effects_manager.hadEffect("disable_passive_talent")))
         {
            return 0;
         }
         for each(_loc4_ in getSkillList("talent"))
         {
            _loc5_ = _loc4_.split(":");
            _loc6_ = _loc5_[0];
            _loc7_ = TalentSkillLevel.getCopy(_loc6_,int(_loc5_[1]));
            if(_loc7_)
            {
      ...
      public static function getCp(param1:CharacterManager) : *
      {
         ...
         var _loc3_:Number = param1.isActionsManagerLoaded() ? Number(param1.character_model.effects_manager.getIncreaseMaxCPByTalent()) : 0;
         if(_loc3_ > 0)
         {
         ...
         if(Boolean(Character.is_clan_war) && Boolean(param1.characterClanData))
         {
      ...
      public static function getAgility(param1:CharacterManager) : Number
      {
         ...
         return BattleManager.modifyChance(_loc11_,"RM",_loc12_);
      }
      ...
      public static function getBlockChance(param1:CharacterManager) : *
      {
         ...
         var _loc8_:int = 0;
         var _loc2_:int = 0;
         var _loc3_:int = int(param1.character_model.health_manager.getCurrentHP());
         var _loc4_:int = int(param1.character_model.health_manager.getMaxHP());
      ...
      public static function getDodgeFromTalent(param1:*) : *
      {
         ...
         {
            _loc4_ = _loc3_.split(":");
            if(_loc4_[0] == "skill_1006")
            {
               _loc5_ = TalentSkillLevel.getCopy(_loc4_[0],_loc4_[1]);
               _loc2_ = (Boolean(_loc5_)) && _loc5_.hasOwnProperty("increase_dodge") ? _loc5_.increase_dodge : _loc4_[1];
            }
         }
      ...
      public static function talentExtraCPByLvl(param1:*, param2:*) : *
      {
         ...
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("increase_charge") ? _loc3_.increase_charge : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("amount_increase") ? _loc3_.amount_increase : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("amount_deduct") ? _loc3_.amount_deduct : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("chance") ? _loc3_.chance : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("amount") ? _loc3_.amount : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("receive_damage_prc") ? _loc3_.receive_damage_prc : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("stun_chance") ? _loc3_.stun_chance : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("reduce_damage_percent") ? int(_loc3_.reduce_damage_percent) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("weaken_chance_data") ? _loc3_.weaken_chance_data : [0,0];
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("recover_hpcp_chance") ? _loc3_.recover_hpcp_chance : [0,0];
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("hp_recover_percent_under_50") ? int(_loc3_.hp_recover_percent_under_50) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("rebound_damage") ? _loc3_.rebound_damage : [0,0];
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("stun_resist_percent") ? int(_loc3_.stun_resist_percent) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("recover_hp_by_attack_percent") ? int(_loc3_.recover_hp_by_attack_percent) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("capture_reduce_dodge_percent") ? int(_loc3_.capture_reduce_dodge_percent) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("chance") ? int(_loc3_.chance) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("increase_critical_chance") ? int(_loc3_.increase_critical_chance) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("increase_accuracy") ? int(_loc3_.increase_accuracy) : 0;
      }
      ...
      public static function getAgilityRateFromTalent(param1:int) : int
      {
         ...
         {
            _loc4_ = _loc3_.split(":");
            if(_loc4_[0] == "skill_1003")
            {
               _loc5_ = TalentSkillLevel.getCopy(_loc4_[0],_loc4_[1]);
               if((Boolean(_loc5_)) && _loc5_.hasOwnProperty("increase_agility"))
               {
      ...
      public static function getAgilityFromPassiveTalent(param1:*) : *
      {
         ...
         for each(_loc2_ in getSkillList("talent"))
         {
            ...
            {
               _loc4_ = TalentSkillLevel.getCopy(_loc3_[0],_loc3_[1]);
               if((Boolean(_loc4_)) && Boolean(_loc4_.hasOwnProperty("max_hp_count")) && _loc4_.hasOwnProperty("increase_agility"))
               {
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(_loc3_) && _loc3_.hasOwnProperty("increase_purify_chance") ? int(_loc3_.increase_purify_chance) : 0;
      }
      ...
      public static function talentPurifyByLvlCP(param1:*, param2:*) : int
      {
         ...
         return param1 == "skill_1051" && _loc3_.hasOwnProperty("purify_chance_on") ? int(_loc3_.purify_chance_on) : 0;
      }
      ...
      {
         var _loc3_:Object = TalentSkillLevel.getCopy(param1,param2);
         return Boolean(param1 == "skill_1102") && Boolean(_loc3_) && _loc3_.hasOwnProperty("purify_chance_on") ? int(_loc3_.purify_chance_on) : 0;
      }
      ...
      public static function talentMaxCPByLvl(param1:*, param2:*) : int
      {
         ...
         var _loc4_:Object = TalentSkillLevel.getCopy(_loc3_[0],_loc3_[1]);
         return (Boolean(_loc4_)) && _loc4_.hasOwnProperty("increase_max_cp") ? int(Math.floor(param2 * _loc4_.increase_max_cp / 100)) : 0;
      }
      ...
      public static function senjutsuMaxHPByLvl(param1:*, param2:*) : int
      {
         ...
         var _loc4_:Object = SenjutsuSkillLevel.getCopy(_loc3_[0],_loc3_[1]);
         return (Boolean(_loc4_)) && _loc4_.hasOwnProperty("increase_max_hp") ? int(Math.floor(param2 * _loc4_.increase_max_hp / 100)) : 0;
      }
