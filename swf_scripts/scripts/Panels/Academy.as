package Panels
{
   ...
   public class Academy extends MovieClip
   {
      ...
      public function completeIcon(param1:Event) : void
      {
         ...
         _loc5_ = this.hasSkill(this.skills_list[this.skills_var_0]);
         if(_loc5_ > 0)
         {
      ...
      public function openSkillInfo(param1:MouseEvent) : void
      {
         ...
         _loc4_ = this.hasSkill(this.skill_id_holder_arr[_loc3_]);
         if(_loc4_ > 0)
         {
      ...
      internal function learnSkill(param1:MouseEvent) : void
      {
         this.main.loading(true);
      ...
      internal function changeListNum(param1:MouseEvent) : void
      {
      ...
      internal function emblemPopup(param1:MouseEvent) : void
      {
         this.main.loadPanel("Popups.EmblemUpgrade");
      }
      ...
      internal function selectSkill(param1:MouseEvent = null) : void
      {
         this.resetAllSkills();
         param1.currentTarget.gotoAndStop(3);
      }
