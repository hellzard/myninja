package Panels
{
   ...
   public dynamic class Animation_Shop extends MovieClip
   {
      ...
      private function initUI() : void
      {
         ...
         _loc1_ = Boolean(_loc2_.anims) && Boolean(_loc2_.anims.hasOwnProperty("standby")) && _loc2_.anims.standby != null ? AnimationLibrary.getAnimation(_loc2_.anims.standby).label : _loc1_;
      ...
      private function renderAnimationList() : void
      {
         ...
         while(_loc1_ < 8)
         {
            ...
            if(this.categoryData.length > _loc2_)
            {
               ...
               if(Boolean(this.categoryData[_loc2_].price > 0) && Boolean(this.categoryData[_loc2_].buyable) && !this.hasAnimation(this.categoryData[_loc2_].id))
               {
      ...
      private function onPlayAnimation(param1:MouseEvent) : void
      {
         ...
         if(_loc2_.hasOwnProperty("loop") && Boolean(_loc2_.loop))
         {
      ...
      private function onBuyAnimation(param1:MouseEvent) : void
      {
         ...
         if(Character.account_type == 0 && Boolean(this.selectedAnimData.premium))
         {
