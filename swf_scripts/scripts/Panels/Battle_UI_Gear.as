package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol7150")]
   public class Battle_UI_Gear extends MovieClip
   {
      ...
      public function displayUsableItems() : void
      {
         ...
         while(_loc6_ < 10)
         {
            ...
            _loc7_ = this.character_usable_items[_loc1_].split(":");
            _loc3_ = _loc7_[0];
            _loc2_ = _loc7_[1];
            _loc4_ = Library.getItemInfo(_loc3_);
            _loc5_ = [_loc4_["item_name"],_loc4_["item_level"],_loc4_["item_description"],_loc4_["item_source"]];
      ...
      internal function toolTiponOver(param1:MouseEvent) : void
      {
         ...
         var _loc4_:Array = this.array_info_holder[_loc3_];
      ...
      public function handleItemUse(param1:MouseEvent) : void
      {
         ...
         _loc4_ = this.character_usable_items[_loc3_].split(":");
         var _loc6_:* = _loc4_[0];
         _loc5_ = Library.getItemInfo(_loc6_);
         var _loc7_:* = _loc5_.effect;
      ...
      public function onUseItem() : void
      {
         ...
         if(_loc1_ == "item_52" || _loc1_ == "item_53" || _loc1_ == "item_58")
         {
            if(this.combat != null)
            {
               _loc3_ = _loc1_ == "item_53" || Boolean(this.combat.checkSealEnemy());
               if(_loc3_)
               {
                  if(this.main != null)
                  {
      ...
      private function recoverWithItem(param1:Array) : void
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            if(_loc4_.hasOwnProperty("recover"))
            {
               _loc5_ = 0;
               ...
               if(_loc5_ > 0)
               {
                  _loc5_ = Number(_loc2_.effects_manager.increaseRecoverByEffects(_loc5_,_loc6_.indexOf("hp") != -1 ? "hp" : (_loc6_.indexOf("cp") != -1 ? "cp" : "sp")));
