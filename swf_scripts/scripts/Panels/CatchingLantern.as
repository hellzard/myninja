package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol10063")]
   public dynamic class CatchingLantern extends MovieClip
   {
      ...
      {
         return this.basketMC != null ? this.basketMC.x : STAGE_W * 0.5;
      }
      
      private function get basketY() : Number
      {
         return this.basketMC != null ? this.basketMC.y : STAGE_H - 160;
      }
      ...
      private function spawnObject() : void
      {
         ...
         var _loc5_:Number = STAGE_W - _loc3_ - SPAWN_EDGE_INSET;
         if(_loc5_ < _loc4_)
         {
            _loc4_ = STAGE_W * 0.5;
            _loc5_ = STAGE_W * 0.5;
      ...
      {
         if(!this.playing || this.ending || param1 == null || Boolean(param1["caught"]))
         {
            return;
         }
      ...
      private function catchObject(param1:MovieClip) : void
      {
         ...
         var _loc3_:int = _loc2_ == CAT_GOLDEN ? SCORE_GOLDEN : SCORE_LANTERN;
      ...
      {
         return this.heartMC != null ? this.heartMC.x : 40;
      }
      ...
      private function restackBuffIcons() : void
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_] as MovieClip;
            if(_loc5_ != null && _loc5_.parent != null)
            {
      ...
      private function spawnFloatingScore(param1:Number, param2:Number, param3:int) : void
      {
         ...
         var _loc5_:uint = param3 >= 0 ? COLOR_SCORE_PLUS : COLOR_SCORE_MINUS;
