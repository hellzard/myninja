package Panels
{
   ...
   public class CharacterCreate extends MovieClip
   {
      ...
      internal function selectElement(param1:MouseEvent) : void
      {
         this.clearAll();
      ...
      internal function colorChangeHandler1(param1:ColorPickerEvent) : void
      {
      ...
      internal function colorChangeHandler2(param1:ColorPickerEvent) : void
      {
         var _loc2_:uint = uint("0x" + param1.target.hexValue);
         this.color_2 = _loc2_;
         var _loc3_:* = this.selected_hair_style_color.split("|");
      ...
      internal function swapHair(param1:MouseEvent) : void
      {
      ...
      internal function addHairColor(param1:int) : void
      {
      ...
      internal function swapGender(param1:MouseEvent) : void
      {
         this.hair_num = 1;
         this.txt_hair.text = this.hair_num + " /18";
         while(this.char_mc["back_hair"].numChildren > 0)
      ...
      internal function changeCharacter(param1:MouseEvent) : void
      {
         this.killEverything();
      }
