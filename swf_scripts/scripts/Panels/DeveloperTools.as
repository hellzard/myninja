   ...
   public dynamic class DeveloperTools extends MovieClip
   {
      ...
      private function handleSpoilerClan(param1:MouseEvent) : void
      {
         ...
         while(_loc3_ < 5)
         {
            ...
            _loc5_ = new OutfitManager();
            _loc5_.fillOutfit(this.spoilerMC["char_mc" + _loc3_],_loc2_[_loc3_].weapon,_loc2_[_loc3_].back,_loc2_[_loc3_].set.replace("%s",_loc4_),_loc2_[_loc3_].hair.replace("%s",_loc4_),"face_01_" + _loc4_);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 5)
         {
            ...
            _loc5_ = new OutfitManager();
            _loc5_.fillOutfit(this.spoilerMC["char_mc" + (_loc3_ + 5)],_loc2_[_loc3_].weapon,_loc2_[_loc3_].back,_loc2_[_loc3_].set.replace("%s",_loc4_),_loc2_[_loc3_].hair.replace("%s",_loc4_),"face_01_" + _loc4_);
            _loc3_++;
         }
      }
      ...
      private function handleSpoilerSW(param1:MouseEvent) : void
      {
         ...
         while(_loc3_ < 4)
         {
            ...
            _loc4_ = "0";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_ab" + _loc3_],_loc2_.all_squad[_loc3_].weapon,_loc2_.all_squad[_loc3_].back,_loc2_.all_squad[_loc3_].set.replace("%s",_loc4_),_loc2_.all_squad[_loc3_].hair.replace("%s",_loc4_),"face_01_" + _loc4_);
            ...
            _loc5_ = "1";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_ag" + _loc3_],_loc2_.all_squad[_loc3_].weapon,_loc2_.all_squad[_loc3_].back,_loc2_.all_squad[_loc3_].set.replace("%s",_loc5_),_loc2_.all_squad[_loc3_].hair.replace("%s",_loc5_),"face_01_" + _loc5_);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 2)
         {
            ...
            _loc4_ = "0";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_wb" + _loc3_],_loc2_.winner_squad[_loc3_].weapon,_loc2_.winner_squad[_loc3_].back,_loc2_.winner_squad[_loc3_].set.replace("%s",_loc4_),_loc2_.winner_squad[_loc3_].hair.replace("%s",_loc4_),"face_01_" + _loc4_);
            ...
            _loc5_ = "1";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_wg" + _loc3_],_loc2_.winner_squad[_loc3_].weapon,_loc2_.winner_squad[_loc3_].back,_loc2_.winner_squad[_loc3_].set.replace("%s",_loc5_),_loc2_.winner_squad[_loc3_].hair.replace("%s",_loc5_),"face_01_" + _loc5_);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 2)
         {
            ...
            _loc4_ = "0";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_gb" + _loc3_],_loc2_.global_rank[_loc3_].weapon,_loc2_.global_rank[_loc3_].back,_loc2_.global_rank[_loc3_].set.replace("%s",_loc4_),_loc2_.global_rank[_loc3_].hair.replace("%s",_loc4_),"face_01_" + _loc4_);
            ...
            _loc5_ = "1";
            _loc6_ = new OutfitManager();
            _loc6_.fillOutfit(this.spoilerSWMC["char_mc_gg" + _loc3_],_loc2_.global_rank[_loc3_].weapon,_loc2_.global_rank[_loc3_].back,_loc2_.global_rank[_loc3_].set.replace("%s",_loc5_),_loc2_.global_rank[_loc3_].hair.replace("%s",_loc5_),"face_01_" + _loc5_);
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < 3)
