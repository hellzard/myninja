package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol3657")]
   public class Encyclopedia_Enemy extends MovieClip
   {
      ...
      private function loadPreviewSwf(param1:MouseEvent) : void
      {
         ...
         _loc4_.addEventListener(BulkLoader.COMPLETE,this.onCompleteEnemyLoaded);
      ...
      private function searchItem(param1:MouseEvent) : void
      {
         ...
         var _loc4_:Array = this.enemyDataOriginal;
         var _loc5_:int = int(_loc4_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_)
         {
            _loc6_ = _loc4_[_loc7_];
            _loc8_ = EnemyInfo.getEnemyStats(_loc6_);
            _loc9_ = _loc8_["enemy_name"].toLowerCase();
