package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol2554")]
   public class Mailbox extends MovieClip
   {
      ...
      public var textPane:TextScrollPane = new TextScrollPane();
      ...
      public function openMailInfo(param1:MouseEvent) : *
      {
         ...
         params = [Character.char_id,Character.sessionkey,this.current_mail.mail_id];
