package Panels
{
   ...
   public class Mission_Room extends MovieClip
   {
      ...
      internal function mOver(param1:MouseEvent) : void
      {
      ...
      internal function mOut(param1:MouseEvent) : void
      {
         if(param1.currentTarget.parent.currentFrame !== 3)
         {
      ...
      internal function selectCategory(param1:MouseEvent) : void
      {
         this.killEverything();
         this.gotoAndStop(2);
      ...
      internal function loadMissionCategory(param1:String) : void
      {
      ...
      internal function loadItems() : void
      {
         ...
         while(_loc5_ < _loc6_)
         {
            if(_loc5_ < int(this.total_items))
            {
               ...
               if(Boolean(_loc2_["msn_premium"]) && Character.account_type == 0)
               {
                  this["msn_" + _loc4_].lockMC.visible = true;
               ...
               else if(Boolean(_loc2_["msn_premium"]) && Character.account_type !== 0)
               {
                  this["msn_" + _loc4_].lockMC.visible = true;
                  this["msn_" + _loc4_].lockMC.gotoAndStop(2);
      ...
      internal function selectMission(param1:MouseEvent) : void
      {
         this.resetSlots();
      ...
      internal function getMissionInfo(param1:int) : void
      {
      ...
      internal function returnToMain(param1:MouseEvent) : void
      {
         this.killEverything();
         this.gotoAndStop(1);
         this.loadBasicData();
      ...
      internal function removeRecruitedSquad(param1:MouseEvent) : *
      {
         this.main.loading(true);
      ...
      internal function removeRecruitedSquadRes(param1:Object) : *
      {
         this.main.loading(false);
         if(param1.status == 1)
         {
