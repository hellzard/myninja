package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol9718")]
   public class NewHUD extends MovieClip
   {
      ...
      {
         var featuredFramesOpen:Object;
         var featuredFramesClose:Object;
         var dailyFramesOpen:Object;
         var dailyFramesClose:Object;
         var seasonalFramesOpen:Object;
         var seasonalFramesClose:Object;
         var rmFramesOpen:Object;
         var rmFramesClose:Object;
         ...
         featuredFramesOpen = NinjaSage.getLabelFrames(this.featuredExpandMC,"open");
         featuredFramesClose = NinjaSage.getLabelFrames(this.featuredExpandMC,"close");
         ...
         dailyFramesOpen = NinjaSage.getLabelFrames(this.dailyExpandMC,"open");
         dailyFramesClose = NinjaSage.getLabelFrames(this.dailyExpandMC,"close");
         ...
         seasonalFramesOpen = NinjaSage.getLabelFrames(this.seasonalExpandMC,"open");
         seasonalFramesClose = NinjaSage.getLabelFrames(this.seasonalExpandMC,"close");
         ...
         rmFramesOpen = NinjaSage.getLabelFrames(this.rmExpandMC,"open");
         rmFramesClose = NinjaSage.getLabelFrames(this.rmExpandMC,"close");
