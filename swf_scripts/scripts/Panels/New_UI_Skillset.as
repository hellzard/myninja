package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol10790")]
   public dynamic class New_UI_Skillset extends MovieClip
   {
      ...
      public function New_UI_Skillset(param1:*)
      {
         super();
      ...
      public function completeIcon(param1:Event) : *
      {
         ...
         this["item_" + this.skillCount].iconMC.rewardIcon.visible = false;
         this["item_" + this.skillCount].iconMC.btn_preview.visible = false;
         this["item_" + this.skillCount].iconMC.amtTxt.visible = false;
         this["item_" + this.skillCount].iconMC.ownedTxt.visible = false;
         this["item_" + this.skillCount].iconMC.skillIcon.iconHolder.addChild(_loc4_);
      ...
      public function showSkillDetail(param1:MouseEvent) : *
      {
         ...
         GF.removeAllChild(this.skillInfoMC.iconMC.skillIcon.iconHolder);
         this.skillInfoMC.iconMC.rewardIcon.visible = false;
         this.skillInfoMC.iconMC.amtTxt.visible = false;
         this.skillInfoMC.iconMC.ownedTxt.visible = false;
         this.skillInfoMC.iconMC.btn_preview.metaData = {"itemId":this.selectedSkill};
         this.eventHandler.addListener(this.skillInfoMC.iconMC.btn_preview,MouseEvent.CLICK,this.main.openPreview);
         NinjaSage.loadItemIcon(this.skillInfoMC.iconMC,this.selectedSkill);
      ...
      public function completeEquipIcon(param1:Event) : *
      {
         ...
         this["skill_" + this.equippedCount].skillIcon.iconHolder.addChild(_loc3_);
         ...
         this.eventHandler.addListener(this["skill_" + this.equippedCount].clickmask,MouseEvent.CLICK,this.selectSwitchingSkill);
         this["skill_" + this.equippedCount].rewardIcon.visible = false;
         this["skill_" + this.equippedCount].amtTxt.visible = false;
         this["skill_" + this.equippedCount].ownedTxt.visible = false;
         this["skill_" + this.equippedCount].btn_preview.visible = true;
         this["skill_" + this.equippedCount].btn_preview.metaData = {"itemId":_loc4_.skill_id};
         this.eventHandler.addListener(this["skill_" + this.equippedCount].btn_preview,MouseEvent.CLICK,this.main.openPreview);
         ++this.equippedCount;
         this.loadEquippedSkills();
      }
      ...
      public function selectSwitchingSkill(param1:MouseEvent) : *
      {
         ...
         this["skill_" + _loc2_].filters = [this.glowFilter];
         if(this["skill_" + _loc2_].selected)
         {
            this.switchSkillIndexHolder = [];
            this["skill_" + _loc2_].selected = false;
            this["skill_" + _loc2_].filters = null;
            return;
         }
         this["skill_" + _loc2_].selected = true;
      ...
      public function equipSkill(param1:MouseEvent) : *
      {
         ...
         var _loc3_:int = _loc2_ + int(int(this.currentPage - 1) * 10);
      ...
      public function resetIconHolder() : *
      {
         ...
         while(_loc1_ < 10)
         {
            GF.removeAllChild(this["item_" + _loc1_].iconMC.skillIcon.iconHolder);
      ...
      public function resetEquippedIconHolder() : *
      {
         ...
         while(_loc1_ < 8)
         {
            GF.removeAllChild(this["skill_" + _loc1_].skillIcon.iconHolder);
            this["skill_" + _loc1_].rewardIcon.visible = false;
            this["skill_" + _loc1_].btn_preview.visible = false;
            this["skill_" + _loc1_].amtTxt.visible = false;
            this["skill_" + _loc1_].ownedTxt.visible = false;
      ...
      {
         param1.currentTarget.metaData = {"itemId":this.selectedSkill};
