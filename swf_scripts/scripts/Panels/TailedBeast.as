package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol7753")]
   public dynamic class TailedBeast extends MovieClip
   {
      ...
      public function displayPets(param1:* = 0) : *
      {
         ...
         cp = display_pet_nr + (int(this.curr_page) - 1) * 10;
      ...
      public function petLoaded(param1:*, param2:*, param3:*) : void
      {
         ...
         var pet_swf:* = petSwf;
         removeEventListener(Event.ENTER_FRAME,this.checkLoading);
         butn = e.target.content["PetStaticFullBody"];
         butn.scaleX = 1.8;
         butn.scaleY = 1.8;
         head = e.target.content["icon"];
         this.pet_icons.push(head);
         holder.visible = true;
         this.pet_mcs.push(butn);
         pet_infos = PetInfo.getPetStats(pet_swf);
      ...
      public function onSelectPet(param1:* = null) : *
      {
         ...
         _loc3_ = this.pets_cost[this.selected_pet_index];
         if(_loc3_.indexOf("token_") >= 0)
         {
      ...
      public function onBuyAMFResponse(param1:Object) : *
      {
         ...
         if(param1.status > 0)
         {
            ...
            _loc2_ = this.pets_cost[this.selected_pet_index];
            if(_loc2_.indexOf("token_") >= 0)
            {
