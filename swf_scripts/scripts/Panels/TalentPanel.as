package Panels
{
   ...
   public class TalentPanel extends MovieClip
   {
      ...
      public function canLvlUP(param1:*, param2:*) : *
      {
         ...
         {
            _loc3_ = this.getCurrentSkillInfo(param1.talent_link_skill_id,param2);
            if((Boolean(_loc3_)) && _loc3_.item_level >= 5)
            {
               _loc5_ = true;
            }
            else
         ...
         if("talent_link_skill_id2" in param1 && Boolean(_loc5_))
         {
            _loc4_ = this.getCurrentSkillInfo(param1.talent_link_skill_id2,param2);
            if((Boolean(_loc4_)) && _loc4_.item_level >= 5)
            {
               _loc5_ = true;
            }
            else
      ...
      internal function toolTipTalent(param1:*) : *
      {
