package Panels
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol7371")]
   public class UI_Option extends MovieClip
   {
      ...
      private function initUI() : void
      {
         ...
         var _loc2_:int = int(this.main.stage.frameRate);
         ...
         var _loc3_:String = this.ns_so.data.hasOwnProperty("option_is_stickman") && Boolean(this.ns_so.data.option_is_stickman) ? "on" : "off";
         this.panel.toggle_stickman.gotoAndStop(_loc3_);
         var _loc4_:String = this.ns_so.data.hasOwnProperty("option_enable_bgm") && Boolean(this.ns_so.data.option_enable_bgm) ? "on" : "off";
         this.panel.toggle_bgm.gotoAndStop(_loc4_);
         var _loc5_:String = this.ns_so.data.hasOwnProperty("option_enable_sfx") && Boolean(this.ns_so.data.option_enable_sfx) ? "on" : "off";
      ...
      {
         var _loc2_:int = int(param1.currentTarget.name.replace("radio_",""));
         var _loc3_:int = 0;
      ...
      {
         var _loc1_:Number = this.ns_so.data.option_volume != null ? Number(this.ns_so.data.option_volume) : 1;
      ...
      private function handleSocial(param1:MouseEvent) : void
      {
         ...
         {
            navigateToURL(new URLRequest("http://127.0.0.1:800/news"));
         }
      }
      ...
      public function destroy() : void
      {
         ...
         if(Boolean(this.main) && Boolean(!this.onBattle) && this.main.combat != null)
         {
