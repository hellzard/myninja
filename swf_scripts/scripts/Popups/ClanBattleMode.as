package Popups
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol7095")]
   public class ClanBattleMode extends MovieClip
   {
      ...
      public function ClanBattleMode(param1:*, param2:*, param3:*)
      {
         ...
         {
            if(this.hasOwnProperty("recruit_id" + _loc4_) && Boolean(Character.clan_recruit_names[_loc4_]))
            {
      ...
      public function destroy(param1:* = true) : *
      {
         ...
         if(Boolean(param1) && Boolean(this._battle_popup))
         {
            this._battle_popup.destroy();
            this._battle_popup = null;
         }
