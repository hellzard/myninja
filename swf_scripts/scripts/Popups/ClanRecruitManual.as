package Popups
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6838")]
   public class ClanRecruitManual extends MovieClip
   {
      ...
      public function displayMembers() : *
      {
         ...
         while(_loc2_ < 11)
         {
            ...
            if(this.members.length > _loc1_)
            {
               ...
               if(this.members[_loc1_].char_id == Character.char_id && Boolean(this["member_" + _loc2_].hasEventListener(MouseEvent.CLICK)))
               {
      ...
      public function destroy(param1:* = true) : *
      {
         ...
         this.main = null;
         this.__parent = null;
         if(Boolean(destroyBattleMode) && Boolean(this.battle_mode))
         {
