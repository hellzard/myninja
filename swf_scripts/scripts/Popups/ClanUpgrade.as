package Popups
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol6665")]
   public class ClanUpgrade extends MovieClip
   {
      ...
      public var pricing:Array = [1000000,1000000,1000000,4000];
      ...
      {
         if(Boolean(param1 != null) && Boolean(param1.hasOwnProperty("clan")) && Boolean(param1.hasOwnProperty("char")) && this.clan_village != null)
         {
