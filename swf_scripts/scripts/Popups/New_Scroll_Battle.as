package Popups
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol9430")]
   public class New_Scroll_Battle extends MovieClip
   {
      ...
      public function New_Scroll_Battle(param1:*)
      {
         super();
      ...
      {
         var _loc2_:String = param1.currentTarget.name.replace("btn_","");
         if(_loc2_ == "HuntingHouse" && int(Character.character_lvl) < 20 && int(Character.character_rank) < 3)
         {
