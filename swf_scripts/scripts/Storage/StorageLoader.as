package Storage
{
   ...
   public class StorageLoader extends EventDispatcher implements ITask
   {
      ...
      private var assetNames:* = ["skills","library","enemy","npc","pet","mission","gamedata","talents","senjutsu","skill-effect","weapon-effect","back_item-effect","accessory-effect","set-effect","arena-effect","animation"];
