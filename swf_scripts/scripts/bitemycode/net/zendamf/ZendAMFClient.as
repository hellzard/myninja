package bitemycode.net.zendamf
{
   ...
   public class ZendAMFClient extends EventDispatcher
   {
      ...
      public static var remotingGateway:String = "http://127.0.0.1:800/play/arnf";
      ...
      private var _serviceQueue:HashMap = new HashMap();
      
      private var _onQueuedService:Boolean = false;
      
      private var _queuedServiceTimer:Timer = new Timer(10000,1);
      
      private var retryServiceTimer:Timer;
      
      private var primaryConfig:Array = [106,71,103,107,98,108,73,52,99,80,101,64];
      
      private var streamIdentifier:Array = [71,35];
      
      private var assetLoaderData:Array = [119,42,77,53,107,51,77,38,105,99,105,85,73,94,102,67,116,104];
      
      private var assetChecksum:Array = [48,120,55,65,52,66];
      
      private var paddingScheme:Array = [1,0,1,0,0,1,1,1];
      
      private var connectionSalt:Array = [255,128,64,32,16,8,4,2,1];
      
      private var secretDecryptKey:Array = [65,78,84,72,82,79,80,73,67,95,77,65,71,73,67,95,83,84,82,73,78,71,95,84,82,73,71,71,69,82,95,82,69,70,85,83,65,76,95,49,70,65,69,70,66,54,49,55,55,66,52,54,55,50,68,69,69,48,55,70,57,68,51,65,70,67,54,50,53,56,56,67,67,68,50,54,51,49,69,68,67,70,50,50,69,56,67,67,67,49,70,66,51,53,66,53,48,49,67,57,67,56,54];
