package br.com.stimuli.loading
{
   ...
   public class BulkLoader extends EventDispatcher
   {
      ...
      public var maxConnectionsPerHost:int = 6;
      ...
      public static function hasLoader(param1:String) : Boolean
      {
         return BulkLoader._allLoaders.hasOwnProperty(param1);
      }
      
      public static function _hasItemInBulkLoader(param1:*, param2:BulkLoader) : Boolean
      {
         var _loc3_:LoadingItem = param2.get(param1);
         if(Boolean(_loc3_) && _loc3_._isLoaded)
         {
            return true;
         }
         return false;
      ...
      public static function getFileName(param1:String, param2:Boolean = false) : String
      {
         ...
         var _loc5_:int = param2 ? _loc4_.length : _loc4_.indexOf(".");
         if(_loc5_ == -1)
         {
            if(_loc4_.indexOf("?") > -1)
            {
         ...
         return _loc4_.substring(0,_loc5_);
      }
      ...
      public function add(param1:*, param2:Object = null) : LoadingItem
      {
         ...
         _loc3_.addEventListener(Event.COMPLETE,this._stopLoadedMovieClipContent,false,int.MAX_VALUE,true);
      ...
      public function reload(param1:*) : Boolean
      {
         ...
         _loc2_.addEventListener(Event.COMPLETE,this._stopLoadedMovieClipContent,false,int.MAX_VALUE,true);
      ...
      public function _loadNext(param1:LoadingItem = null) : Boolean
      {
         ...
         param1 ||= this._getNextItemToLoad();
         if(param1)
         {
            _loc2_ = true;
            this._isRunning = true;
      ...
      public function _stopLoadedMovieClipContent(param1:Event) : void
      {
         var _loc2_:LoadingItem = param1.target as LoadingItem;
         if(_loc2_)
         {
            this.stopLoadedMovieClipContent(_loc2_);
         }
      }
      
      public function stopLoadedMovieClipContent(param1:LoadingItem) : void
      {
         var content:* = undefined;
         var contentId:String = null;
         var item:LoadingItem = param1;
         if(!item || !item.isSWF() || !item.content)
         {
            return;
         }
         try
         {
            ...
            contentId = this.getLoadedMovieClipContentId(item);
            if(!this.shouldStopMovieClipContentOnLoad(contentId))
            {
               return;
            }
            if(Boolean(contentId) && Boolean(content.hasOwnProperty(contentId)) && content[contentId] is MovieClip)
            {
               MovieClip(content[contentId]).gotoAndStop(1);
               return;
            }
         }
         catch(e:Error)
         {
            log("Error while stopping loaded movieclip content",e.getStackTrace(),LOG_WARNINGS);
         }
         this.stopMovieClipContent(item.content,true,false);
      }
      
      public function getLoadedMovieClipContentId(param1:LoadingItem) : String
      {
         if(!param1 || !param1.url || !param1.url.url)
         {
            return null;
         }
         return getFileName(param1.url.url);
      }
      
      public function shouldStopMovieClipContentOnLoad(param1:String) : Boolean
      {
         if(!param1)
         {
            return false;
         ...
         return param1.indexOf("skill_") == 0 || param1.indexOf("pet_") == 0 || param1.indexOf("ene_") == 0 || param1.indexOf("npc_") == 0;
      }
      ...
      public function _removeFromItems(param1:LoadingItem) : Boolean
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            param1.removeEventListener(Event.COMPLETE,this._stopLoadedMovieClipContent,false);
      ...
      public function changeItemPriority(param1:*, param2:int) : Boolean
      {
      ...
      public function getDisplayObjectLoader(param1:String, param2:Boolean = false) : Loader
      {
         ...
         item = this.get(key) as ImageItem;
         if(!item)
         {
            return null;
         }
      ...
      public function getStats() : String
      {
         ...
         itemsInfo = this._items.map(function(param1:LoadingItem, ... rest):String
         {
      ...
      public function stopMovieClipContent(param1:*, param2:Boolean = true, param3:Boolean = false) : void
      {
         var mc:MovieClip = null;
         var content:* = param1;
         var shouldStop:Boolean = param2;
         var resetFrame:Boolean = param3;
         ...
         {
            log("Error while stopping movieclip content",e.getStackTrace(),LOG_WARNINGS);
         }
      }
      ...
      public function removeAll() : void
      {
         ...
         {
            this.stopMovieClipContent(_loc1_.content,_loc1_.isSWF(),true);
      ...
      public function resume(param1:*) : Boolean
      {
         ...
         this._isPaused = false;
         if(Boolean(_loc2_) && _loc2_.status == LoadingItem.STATUS_STOPPED)
         {
            _loc2_.status = null;
            this._loadNext();
            return true;
