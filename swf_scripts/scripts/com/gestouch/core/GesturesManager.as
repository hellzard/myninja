   ...
   public class GesturesManager
   {
      ...
      gestouch_internal function onGestureRecognized(param1:Gesture) : void
      {
         ...
         for(_loc3_ in this._gesturesMap)
         {
            ...
            if(Boolean(_loc4_ != param1 && _loc2_ && _loc5_) && Boolean(_loc4_.enabled) && _loc4_.state == GestureState.POSSIBLE)
            {
         ...
         for each(_loc5_ in _loc7_)
         {
            ...
            if(_loc9_)
            {
               ...
               while(_loc3_-- > 0)
               {
                  ...
                  if(_loc2_.enabled && (Boolean(_loc2_.gestureShouldReceiveTouchCallback == null) || Boolean(_loc2_.gestureShouldReceiveTouchCallback(_loc2_,param1))))
                  {
