package com.pnwrain.flashsocket
{
   ...
   public class FlashSocket extends EventEmitter
   {
      ...
      {
         return Boolean(this.engine) && Boolean(this.engine.transport) ? this.engine.transport.name : null;
      }
      ...
      public function emit(param1:String, param2:Object, param3:Function = null) : void
      {
         ...
         var _loc5_:Number = this.hasBin(param2) ? Number(Parser.BINARY_EVENT) : Number(Parser.EVENT);
         var _loc6_:Object = {
            "type":_loc5_,
            "data":param2,
            "nsp":this.opts.channel
