package fl.controls
{
   ...
   public class LabelButton extends BaseButton implements IFocusManagerComponent
   {
      ...
      override protected function drawLayout() : void
      {
         ...
         var _loc7_:Number = this.icon == null ? Number(0) : Number(this.icon.width + _loc3_);
         var _loc8_:Number = this.icon == null ? Number(0) : Number(this.icon.height + _loc3_);
         ...
         else if(_loc4_ == ButtonLabelPlacement.BOTTOM || _loc4_ == ButtonLabelPlacement.TOP)
         {
            ...
            if(this.icon != null)
            {
               this.icon.y = Math.round(_loc4_ == ButtonLabelPlacement.BOTTOM ? Number(this.textField.y - _loc8_) : Number(this.textField.y + this.textField.height + _loc3_));
            }
         }
         else
         {
            ...
            if(this.icon != null)
            {
               this.icon.x = Math.round(_loc4_ != ButtonLabelPlacement.LEFT ? Number(this.textField.x - _loc7_) : Number(this.textField.x + _loc5_ + _loc3_));
            }
         }
         super.drawLayout();
      }
