package id.ninjasage
{
   ...
   public class GradientText
   {
      ...
      private function init(param1:*, param2:* = null) : void
      {
         ...
         var _loc6_:* = param2 != null ? Character.rgb_data[param2] : null;
         if(_loc6_ is Array && _loc6_.length > 1)
         {
            _loc5_ = [];
            _loc14_ = 0;
         ...
         var _loc12_:Number = Number(_loc3_.x);
         while(_loc12_ < _loc3_.x + _loc11_)
         {
            _loc15_ = new Matrix();
            _loc15_.createGradientBox(_loc10_,_loc3_.height,0,_loc12_,_loc3_.y);
         ...
         var _loc13_:int = int(param1.parent.getChildIndex(param1));
