package id.ninjasage.features
{
   ...
   public dynamic class AnniversaryGacha extends MovieClip
   {
      
      private static const MATERIAL_GACHA:String = "material_2236";
      ...
      public function AnniversaryGacha(param1:*, param2:*)
      {
         var _loc3_:* = GameData.get("anniv2026");
      ...
      private function getEventData() : void
      {
         ...
         this.main.amf_manager.service("zy8Ztqe05vkpqNx0.Onqkq5l0qsrZ",[Character.char_id,Character.sessionkey,Character.account_id],this.eventDataResponse);
      }
      ...
      private function sendAmf() : *
      {
         ...
         this.main.amf_manager.service("zy8Ztqe05vkpqNx0.8IQN7dVLZeuG",[Character.char_id,Character.sessionkey,this.playType,this.playQty],this.getGachaRewardsRes);
      }
      ...
      {
         this.main.giveReward(1,this.obtainedGachaRewards,"anniversary");
      }
      
      private function openBonusRewards(param1:MouseEvent) : void
      {
         this.main.loading(true);
         this.main.amf_manager.service("zy8Ztqe05vkpqNx0.WegwljyXxZxk",[Character.char_id,Character.sessionkey,Character.account_id],this.openBonusRewardsRes);
      }
      ...
      private function onClaimBonusRequest(param1:MouseEvent) : void
      {
         ...
         this.main.amf_manager.service("zy8Ztqe05vkpqNx0.MNS4gNKKxmfg",[Character.char_id,Character.sessionkey,_loc2_],this.onClaimBonusResponse);
      }
      ...
      private function onClaimBonusResponse(param1:Object) : void
      {
         if(param1.status > 0)
         {
            if(param1.status == 1)
            {
               ...
               this.main.giveReward(1,param1.reward,"anniversary");
               this.panelMC.tokenTxt.text = String(Character.account_tokens);
      ...
      private function openHistory(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ == "personalBtn")
         {
            ...
            this.main.amf_manager.service("zy8Ztqe05vkpqNx0.Io4ykIZdchRF",[Character.char_id,Character.sessionkey],this.historyResponse);
         }
         else
         {
            this.panelMC.historyMC.titleTxt.text = "Global Prize History";
            this.main.amf_manager.service("zy8Ztqe05vkpqNx0.e3bdcbkFju8s",[Character.char_id,Character.sessionkey],this.historyResponse);
         }
      }
