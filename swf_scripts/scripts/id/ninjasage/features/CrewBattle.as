package id.ninjasage.features
{
   ...
   public dynamic class CrewBattle extends MovieClip
   {
      ...
      private function onCastleData(param1:* = null, param2:* = null) : *
      {
         ...
         if(Boolean(param1 != null) && Boolean(param1.hasOwnProperty("castles")) && param1.castles != null)
         {
         ...
         else if(Boolean(!this.init && !this.timeoutGetCastle && param1 != null) && Boolean(param1.hasOwnProperty("code")) && param1.code == 429)
         {
      ...
      private function startPhaseOneBattle(param1:MouseEvent) : void
      {
         ...
         _loc4_.h = Hex.fromArray(Crypto.getHash("md5").hash(Hex.toArray(Hex.fromString([Character.char_id,_loc4_.b,_loc4_.t,_loc4_.c,_loc4_.e].join("|")))));
      ...
      {
         if(Boolean(param1 != null && param1.hasOwnProperty("castles")) && Boolean(param1.castles != null) && param1.castles.length > 0)
         {
      ...
      private function updateTimeleft() : void
      {
         ...
         var _loc4_:int = Math.floor((_loc1_ - _loc2_ * 86400 - _loc3_ * 3600) / 60);
         if(_loc4_ >= 30)
         {
