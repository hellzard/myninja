package id.ninjasage.features
{
   ...
   public dynamic class CrewHall extends MovieClip
   {
      ...
      private function selectRequestMember(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(param1.currentTarget.name.replace("request_",""));
      ...
      private function onDonated(param1:*, param2:* = null) : void
      {
         ...
         if(param1 !== null && (Boolean(param1.hasOwnProperty("t")) || Boolean(param1.hasOwnProperty("g"))))
         {
            if(this.selectedDonation == "gold")
            {
      ...
      private function selectCrewMember(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(param1.currentTarget.name.replace("member_",""));
      ...
      {
         if(Boolean(this.crewVillage) && Boolean(this.crewVillage.panelMC))
         {
