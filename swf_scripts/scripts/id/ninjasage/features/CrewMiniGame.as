package id.ninjasage.features
{
   ...
   public class CrewMiniGame extends MovieClip
   {
      ...
      {
         if(Boolean(param1 != null) && Boolean(param1.hasOwnProperty("r")) && param1.r != "")
         {
      ...
      private function onStartRes(param1:* = null, param2:* = null) : *
      {
         ...
         else if(param1 != null && Boolean(param1.hasOwnProperty("errorMessage")))
         {
...
class EnergyRefillSystem
{
   ...
   public function EnergyRefillSystem()
   {
      super();
   }
