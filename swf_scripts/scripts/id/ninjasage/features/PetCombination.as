   ...
   public dynamic class PetCombination extends MovieClip
   {
      ...
      public function completeIcon(param1:Event) : void
      {
         ...
         while(_loc9_ < _loc8_["attacks"].length)
         {
            ...
            _loc10_ = this.ownedPet[this.petIndex].pet_skills.split(",");
            if(_loc10_[_loc9_] == 0)
            {
      ...
      {
         var _loc2_:int = int(param1.currentTarget.name.replace("pet_selectInnerFrame",""));
         var _loc3_:* = 0;
         while(_loc3_ < 4)
         {
      ...
      private function confirmPetSelect(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(PetInfo.getPetStats(this.selectedPetLeft.pet_swf).pet_combine_gold);
         var _loc3_:int = int(PetInfo.getPetStats(this.selectedPetRight.pet_swf).pet_combine_gold);
      ...
      {
         var _loc2_:int = int(param1.currentTarget.parent.name.replace("iconMc_",""));
