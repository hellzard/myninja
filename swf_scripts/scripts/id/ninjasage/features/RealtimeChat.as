package id.ninjasage.features
{
   ...
   public dynamic class RealtimeChat extends MovieClip
   {
      ...
      {
         if(Boolean(this.nicknameColors) && Boolean(this.nicknameColors.hasOwnProperty(param1)))
         {
      ...
      public function onDisconnect(param1:*) : *
      {
         ...
         if(Boolean(this.manualClosePanel) && this.reconnectTries < this.maxReconnect)
         {
            this.reconnect();
         }
         else
