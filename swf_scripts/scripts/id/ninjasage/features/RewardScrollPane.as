package id.ninjasage.features
{
   ...
   public class RewardScrollPane extends MovieClip
   {
      ...
      public function updateRewardPane(param1:Object) : void
      {
         ...
         {
            _loc7_ = getDefinitionByName("IconReward") as Class;
            _loc8_ = new _loc7_();
         ...
         this.scrollPane.horizontalScrollPolicy = this.paneData.hasOwnProperty("scroll_visible") && Boolean(this.paneData.scroll_visible) ? "auto" : this.paneData.scroll_visible;
         this.scrollPane.verticalScrollPolicy = this.paneData.hasOwnProperty("scroll_visible") && Boolean(this.paneData.scroll_visible) ? "auto" : this.paneData.scroll_visible;
