   ...
   public dynamic class SenjutsuProfile extends MovieClip
   {
      ...
      private function loadSkillTree() : *
      {
         ...
         while(_loc1_ < 10)
         {
            ...
            _loc4_ = this.getCurrentSkillInfo(_loc3_.id,Character.character_senjutsu);
            if(_loc4_)
            {
      ...
      private function setUpgradeInfo() : *
      {
         ...
         var _loc4_:* = SenjutsuLevelLearnRequirements.getSkillRequirements(this.upgradeBtnData.level == 0 ? 1 : int(this.upgradeSkillLevel + 1));
         ...
         if(this.upgradeSkillLevel < 10)
         {
            ...
            _loc5_ = SenjutsuSkillLevel.getSenjutsuSkillLevels(this.upgradeBtnData.id,this.isMax ? this.upgradeSkillLevel : int(this.upgradeSkillLevel + 1));
            _loc6_ = _loc5_.cooldown == 0 ? "(Passive Skill)" : "(Active Skill)";
      ...
      public function canLvlUP(param1:*, param2:*) : *
      {
         ...
         if("link1" in param1)
         {
            _loc3_ = this.getCurrentSkillInfo(param1.link1,param2);
            if((Boolean(_loc3_)) && _loc3_.level >= 5)
            {
               _loc5_ = true;
            }
            else
         ...
         if("link2" in param1 && Boolean(_loc5_))
         {
            _loc4_ = this.getCurrentSkillInfo(param1.link2,param2);
            if((Boolean(_loc4_)) && _loc4_.level >= 5)
            {
               _loc5_ = true;
            }
            else
      ...
      private function getSenjutsuSkillOrder(param1:String, param2:String) : int
      {
         ...
         while(_loc4_ < 11)
         {
            ...
            _loc6_ = SenjutsuSkillDescriptions.getSenjutsuSkillDescriptions(_loc5_);
            if(_loc6_.id == param1)
            {
               return _loc4_;
            }
      ...
      {
         var _loc2_:int = int(param1.currentTarget.name.replace("learnedSenjutsu_",""));
      ...
      private function equipSkill(param1:MouseEvent) : *
      {
         ...
         var _loc2_:int = int(param1.currentTarget.parent.name.replace("learnedSenjutsu_",""));
         var _loc3_:int = _loc2_ + int(int(this.currentPage - 1) * 8);
