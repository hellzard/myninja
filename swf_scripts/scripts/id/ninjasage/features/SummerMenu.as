package id.ninjasage.features
{
   ...
   public class SummerMenu extends MovieClip
   {
      ...
      private var lanternCatch:CatchingLantern;
      
      public function SummerMenu(param1:*, param2:*)
      {
         var _loc3_:Object = GameData.get("summer2026");
      ...
      private function getEventData() : void
      {
         ...
         this.main.amf_manager.service("urUACOuL6PahuoEd.khrFVSqSD3ps",[Character.char_id,Character.sessionkey],this.onGetEventData);
      }
      ...
      private function initEscapeKey() : void
      {
         ...
         this.escapeKey.addListener(this.panelMC.minigameCoverMC,this.closeMinigame);
      }
      ...
      private function selectBoss(param1:MouseEvent) : void
      {
         ...
         this.panelMC.battleMC["enemy_2"].filters = null;
      ...
      public function refillAmf(param1:MouseEvent) : *
      {
         ...
         {
            this.main.amf_manager.service("urUACOuL6PahuoEd.5EtU9OY4JBFh",[Character.char_id,Character.sessionkey],this.refillResponse);
         }
         else
         {
            this.main.amf_manager.service("urUACOuL6PahuoEd.jO6077PCUT0k",[Character.char_id,Character.sessionkey],this.refillResponse);
         }
      }
      ...
      private function startBattle(param1:MouseEvent) : void
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.MTpVa9K3yFwo",[Character.char_id,_loc6_,_loc2_,_loc5_,_loc4_,Character.sessionkey],this.onStartEventAmf);
      }
      ...
      private function openMilestone(param1:MouseEvent) : *
      {
         ...
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.4nI6yGEvtUni",[Character.char_id,Character.sessionkey],this.openMilestoneRewards);
         var _loc2_:* = 0;
         while(_loc2_ < 8)
         {
      ...
      private function onClaimBonusRequest(param1:MouseEvent) : *
      {
         ...
         this.main.amf_manager.service("urUACOuL6PahuoEd.nmK7E89f4JsD",[Character.char_id,Character.sessionkey,_loc2_],this.onClaimBonusResponse);
      }
      ...
      private function openRewardList(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Object = GameData.get("summer2026");
      ...
      private function buySkill(param1:MouseEvent) : void
      {
         ...
         this.confirmation = null;
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.ipS0sz7Izoyu",[Character.char_id,Character.sessionkey,this.selectedBuySkill],this.buyResponse);
      }
      ...
      private function buyResponse(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            this.main.giveReward(1,this.skillData[this.selectedBuySkill].skillId,"summer");
      ...
      {
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.vcx81Tk10da9",[Character.char_id,Character.sessionkey],this.onGetMinigameData);
      }
      ...
      private function openMinigameUI() : void
      {
         ...
         this.panelMC.minigameCoverMC.tutorialMC.visible = false;
         this.eventHandler.addListener(this.panelMC.minigameCoverMC.btn_close,MouseEvent.CLICK,this.closeMinigame);
         this.eventHandler.addListener(this.panelMC.minigameCoverMC.tutorialMC.btn_close,MouseEvent.CLICK,this.closeTutorialMinigame);
         ...
         this.eventHandler.addListener(this.panelMC.minigameCoverMC.btn_tutorial,MouseEvent.CLICK,this.openMinigameTutorial);
         ...
         while(_loc1_ < 4)
         {
            ...
            if(this.minigameData[_loc1_] != null)
            {
      ...
      private function openMinigameTutorial(param1:MouseEvent) : void
      {
         this.panelMC.minigameCoverMC.tutorialMC.visible = true;
      }
      
      private function startMinigame(param1:MouseEvent) : void
      {
         this.main.loading(true);
         this.main.amf_manager.service("urUACOuL6PahuoEd.swP4z80ragAZ",[Character.char_id,Character.sessionkey],this.onStartMinigame);
      }
      ...
      private function onStartMinigame(param1:Object) : void
      {
         ...
         if(param1.status == 1)
         {
            if(this.lanternCatch)
            {
               GF.removeAllChild(this.lanternCatch);
               this.lanternCatch.destroy();
               this.lanternCatch = null;
            }
            this.minigameResponse.energy = param1.energy;
            Character.battle_code = param1.battle_code;
            this.lanternCatch = new CatchingLantern(this.main,this);
            this.main.loader.addChild(this.lanternCatch);
            this.updateMinigameEnergy();
            this.hideThisPanel();
         }
         else
      ...
      private function closeTutorialMinigame(param1:MouseEvent) : void
      {
         this.panelMC.minigameCoverMC.tutorialMC.visible = false;
      }
      ...
      private function openMaterialMarket(param1:MouseEvent) : void
      {
         ...
         var _loc3_:* = new _loc2_(this.main,"summer2026");
