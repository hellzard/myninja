package id.ninjasage.features
{
   ...
   public class TextScrollPane extends MovieClip
   {
      ...
      public function updatePane(param1:Object) : void
      {
         ...
         var _loc3_:Number = this.paneData.hasOwnProperty("text_width") ? Number(this.paneData.text_width) : 280;
         var _loc4_:Number = this.paneData.hasOwnProperty("height") ? Number(this.paneData.height) : 400;
         var _loc5_:Number = this.paneData.hasOwnProperty("font_size") ? Number(this.paneData.font_size) : 12;
         var _loc6_:String = this.paneData.hasOwnProperty("font_name") ? String(this.paneData.font_name) : "_sans";
         var _loc7_:uint = this.paneData.hasOwnProperty("font_color") ? uint(this.paneData.font_color) : 16777215;
         var _loc8_:String = this.paneData.hasOwnProperty("align") ? String(this.paneData.align) : "left";
         var _loc9_:Number = this.paneData.hasOwnProperty("x") ? Number(this.paneData.x) : 0;
         var _loc10_:Number = this.paneData.hasOwnProperty("y") ? Number(this.paneData.y) : 0;
         var _loc11_:String = this.paneData.hasOwnProperty("scroll_visible") ? String(this.paneData.scroll_visible) : "off";
         var _loc12_:TextFormat = new TextFormat(_loc6_,_loc5_,_loc7_,false,false,false);
         _loc12_.align = _loc8_;
         var _loc13_:Object = this.parseLinks(_loc2_);
         var _loc14_:String = _loc13_.bodyText;
         var _loc15_:Array = _loc13_.links;
         var _loc16_:Number = _loc10_;
         if(_loc14_.length > 0)
         {
            _loc19_ = this.createBaseTextField(_loc3_);
            _loc19_.defaultTextFormat = _loc12_;
         ...
         while(_loc17_ < _loc15_.length)
         {
            ...
            _loc21_ = _loc20_.color != null ? uint(_loc20_.color) : _loc7_;
            _loc22_ = new TextFormat(_loc6_,_loc5_,_loc21_,_loc20_.bold,_loc20_.italic,_loc20_.underline);
            _loc22_.align = _loc8_;
            _loc23_ = this.createBaseTextField(_loc3_);
         ...
         var _loc18_:Number = this.paneData.hasOwnProperty("width") && this.paneData.width != null ? Number(this.paneData.width) : Number(_loc9_ + _loc3_ + 20);
      ...
      private function parseLinks(param1:String) : Object
      {
         ...
         while(true)
         {
            ...
            _loc10_ = _loc7_.match(/href\s*=\s*['"]([^'"]+)['"]/i);
            _loc11_ = _loc10_ ? String(_loc10_[1]) : "";
            if(_loc11_.indexOf("event:") == 0)
            {
               _loc11_ = _loc11_.substr(6);
            }
            _loc12_ = null;
            _loc13_ = _loc7_.match(/style\s*=\s*['"]([^'"]+)['"]/i);
            if(_loc13_)
            {
               _loc14_ = String(_loc13_[1]).match(/color\s*:\s*([^;]+)/i);
               if(_loc14_)
               {
