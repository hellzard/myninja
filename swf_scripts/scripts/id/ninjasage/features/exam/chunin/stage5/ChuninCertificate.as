package id.ninjasage.features.exam.chunin.stage5
{
   ...
   public dynamic class ChuninCertificate extends MovieClip
   {
      ...
      public function ChuninCertificate(param1:*, param2:*, param3:*)
      {
         super();
         this.main = param1;
      ...
      public function finishThis(param1:MouseEvent) : *
      {
         ...
         this._parent.finishStage5();
         GF.removeAllChild(this.panelMC);
      }
      
      public function frame80() : *
      {
         this.panelMC["nameTxt"].text = Character.character_name;
         this.panelMC["rankTxt"].text = "Chunin";
      ...
      {
         this.panelMC.addFrameScript(79,null,102,null);
         this.panelMC.removeEventListener(MouseEvent.CLICK,this.finishThis);
         GF.removeAllChild(this.panelMC);
         this.panelMC = null;
         this._parent = null;
