package id.ninjasage.features.exam.jounin.stage2
{
   ...
   public dynamic class Map_2 extends MovieClip
   {
      ...
      public function Map_2(param1:*, param2:*, param3:*)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.enterMc)) && Boolean(this.parent_mc.map2_enemy_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
