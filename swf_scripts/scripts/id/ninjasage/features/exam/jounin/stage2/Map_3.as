package id.ninjasage.features.exam.jounin.stage2
{
   ...
   public dynamic class Map_3 extends MovieClip
   {
      ...
      public function Map_3(param1:*, param2:*, param3:*)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function initMap() : void
      {
         ...
         if(!this.parent_mc.map3_enemy_killed)
         {
            this.parent_mc.getMap3Enemies(this.map_mc.enemy_mc);
         }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.enterMc)) && Boolean(this.parent_mc.map3_enemy_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc)) && Boolean(this.parent_mc.map2_enemy_killed))
         {
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startJouninStage2(2);
         }
         if(_loc4_)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
