package id.ninjasage.features.exam.ninjatutor.stage2.chapter2
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function showDialogue2() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue3,this.parent_mc.getAsset("npcLoli"));
      }
      
      public function showDialogue3() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[3]];
         this.main.showDialogueNew(_loc1_,this.showDialogue4,this.parent_mc.getAsset("npcPain2"));
      }
      
      public function showDialogue4() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[4]];
         this.main.showDialogueNew(_loc1_,this.showDialogue5,this.parent_mc.getAsset("npcPain2"));
      }
      
      public function showDialogue5() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[5]];
         this.main.showDialogueNew(_loc1_,this.showDialogue6,this.parent_mc.getAsset("npcWhitePuppet"));
      }
      ...
      public function showDialogue10() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.showDialogue11,this.parent_mc.getAsset("npcPain2"));
      }
      ...
      public function showDialogue12() : *
      {
         ...
         this.main.showDialogueNew(_loc1_,this.main.startNinjaTutorS2C2Battle(2),this.parent_mc.getAsset("npcMonsterBlue"));
      }
      
      public function showFinalDialog() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[13]];
         this.main.showDialogueNew(_loc1_,this.finishStageS2C2,this.parent_mc.getAsset("npcPain2"));
      }
      
      public function finishStageS2C2() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("NinjaTutorExam.finishStage",[Character.char_id,Character.sessionkey,27,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startNinjaTutorS2C2Battle(1);
