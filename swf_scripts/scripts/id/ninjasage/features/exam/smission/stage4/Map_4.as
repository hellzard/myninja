package id.ninjasage.features.exam.smission.stage4
{
   ...
   public dynamic class Map_4 extends MovieClip
   {
      ...
      public function Map_4(param1:* = null, param2:* = null, param3:* = null)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function initMap() : void
      {
         ...
         if(Boolean(this.parent_mc.enemy5_killed) && !this.parent_mc.enemy6_killed)
         {
            this.parent_mc.getMapEnemies(this.map_mc.enemy_mc,6);
         }
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         var _loc4_:* = _loc2_ > -10 && _loc2_ < 10;
         _loc4_ = (_loc4_) && (_loc3_ > -10 && _loc3_ < 10);
         if(_loc2_ < 0)
         {
            this.parent_mc.player_mc.scaleX = 1;
         }
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage4GradeSBattle(6);
            this.main.removeAllChild(this.map_mc.enemy_mc);
         }
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1)) && Boolean(this.parent_mc.enemy6_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
            this.parent_mc.classMap8.initMap();
         }
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_2))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
            this.parent_mc.classMap3.initMap();
         }
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_3))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
            this.parent_mc.classMap7.initMap();
         }
         if(_loc4_)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
