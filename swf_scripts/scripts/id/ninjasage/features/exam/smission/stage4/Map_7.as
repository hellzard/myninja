package id.ninjasage.features.exam.smission.stage4
{
   ...
   public dynamic class Map_7 extends MovieClip
   {
      ...
      public function Map_7(param1:* = null, param2:* = null, param3:* = null)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage4GradeSBattle(4);
            this.main.removeAllChild(this.map_mc.enemy_mc);
         }
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_2)) && Boolean(this.parent_mc.enemy4_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
            this.parent_mc.classMap4.initMap();
         }
         if(_loc4_)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
