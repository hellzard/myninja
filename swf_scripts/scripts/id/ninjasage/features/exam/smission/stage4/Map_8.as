package id.ninjasage.features.exam.smission.stage4
{
   ...
   public dynamic class Map_8 extends MovieClip
   {
      ...
      public function Map_8(param1:* = null, param2:* = null, param3:* = null)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function initMap() : void
      {
         ...
         if(!this.parent_mc.enemy7_killed)
         {
            this.parent_mc.getMapEnemies(this.map_mc.enemy_mc,7);
         }
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage4GradeSBattle(7);
