package id.ninjasage.features.exam.smission.stage5
{
   ...
   public dynamic class Map_1 extends MovieClip
   {
      ...
      public function initMap() : void
      {
         ...
         while(_loc1_ <= 3)
         {
            if(!this.parent_mc["enemy" + _loc1_ + "_killed"])
            {
               this.parent_mc.getMapEnemies(this.map_mc["enemy_mc" + (_loc1_ - 1)],_loc1_);
            }
            _loc1_++;
         }
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc0))
         {
            ...
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage5GradeSBattle(1);
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc1))
         {
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage5GradeSBattle(2);
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc2))
         {
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startStage5GradeSBattle(3);
            this.main.removeAllChild(this.map_mc.enemy_mc2);
         }
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1)) && Boolean(this.parent_mc.enemy1_killed) && Boolean(this.parent_mc.enemy2_killed) && Boolean(this.parent_mc.enemy3_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
