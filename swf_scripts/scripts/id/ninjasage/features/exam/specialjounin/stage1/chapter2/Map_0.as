package id.ninjasage.features.exam.specialjounin.stage1.chapter2
{
   ...
   public dynamic class Map_0 extends MovieClip
   {
      ...
      public function Map_0(param1:* = null, param2:* = null, param3:* = null)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function showDialogue() : *
      {
         ...
         this.main.showDialogue(_loc1_,null,"npc_class");
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc)) && !this.parent_mc.map1_enemy_killed)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
