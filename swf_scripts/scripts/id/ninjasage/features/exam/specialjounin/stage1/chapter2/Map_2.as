package id.ninjasage.features.exam.specialjounin.stage1.chapter2
{
   ...
   public dynamic class Map_2 extends MovieClip
   {
      ...
      public function initMap() : void
      {
         ...
         if(!this.parent_mc.map2_enemy_killed)
         {
            this.parent_mc.getMap2Enemies(this.map_mc.enemy_mc);
         }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_2)) && Boolean(this.parent_mc.map2_enemy_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
            this.parent_mc.classMap1.initMap();
         }
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc.link_1)) && Boolean(this.parent_mc.map2_enemy_killed))
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.map_mc.removeEventListener(Event.ENTER_FRAME,this.onCharMove);
            this.parent_mc.hideMaps();
         ...
         if(this.map_mc.char_mc.hitTestObject(this.map_mc.enemy_mc))
         {
            ...
            this.map_mc.enemy_mc.visible = false;
            this.parent_mc.player_mc.gotoAndStop("stand");
            this.main.startSpecialJouninS1C2Battle2();
         }
         if(_loc4_)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
