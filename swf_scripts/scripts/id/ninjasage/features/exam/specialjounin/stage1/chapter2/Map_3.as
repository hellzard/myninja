package id.ninjasage.features.exam.specialjounin.stage1.chapter2
{
   ...
   public dynamic class Map_3 extends MovieClip
   {
      ...
      public function Map_3(param1:* = null, param2:* = null, param3:* = null)
      {
         super();
         this.main = param1;
         this.map_mc = param2;
      ...
      public function showDialog() : *
      {
         ...
         this.main.showDialogue(_loc1_,this.showDialog1,"darkninja");
      }
      
      public function showDialog1() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[2]];
         this.main.showDialogue(_loc1_,this.main.startSpecialJouninS1C2Battle3,"genan");
      }
      
      public function showFinalDialog() : *
      {
         var _loc1_:* = [this.parent_mc.langFile.textArr[3]];
         this.main.showDialogue(_loc1_,this.finishStageS1C2,"blackops");
      }
      
      public function finishStageS1C2() : *
      {
         this.main.loading(true);
         this.main.amf_manager.service("SpecialJouninExam.finishStage",[Character.sessionkey,Character.char_id,12,[]],this.onFinishStageRes);
      }
      ...
      public function onCharMove(param1:Event) : *
      {
         ...
         if(Boolean(this.map_mc.char_mc.hitTestObject(this.map_mc.linkAreaMc)) && !this.parent_mc.map3_enemy_killed)
         {
            this.parent_mc.player_mc.gotoAndStop("stand");
         ...
         {
            this.map_mc.char_mc.visible = false;
