package id.ninjasage.multiplayer.battle
{
   ...
   public class CharacterModel extends CharacterModelBase
   {
      ...
      private function onHpAnimationTick(param1:TimerEvent) : void
      {
         ...
         var _loc4_:* = this._hpAnimData.battle.getObjectHolder(this.getPlayerTeam(),this.getPlayerNumber());
         _loc4_.hpBar.scaleX = Math.max(Math.min(_loc3_ / this._hpAnimData.maxHp,1),0);
      ...
      public function attackWithWeapon(param1:CharacterManager) : *
      {
         ...
         var _loc4_:int = this.getPlayerTeam() == "player" ? PvPBattleManager.BATTLE_VARS.playerTarget : PvPBattleManager.BATTLE_VARS.enemyTarget;
         var _loc5_:Array = [];
