package id.ninjasage.pvp
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol8296")]
   public class BattleRoom extends MovieClip
   {
      ...
      public var autoStartTime:int = 6;
      ...
      public function activate() : void
      {
         ...
         this.loadBackground();
         this.hideAllTeam();
         if(Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["host"]) && Boolean(this.pvp.character))
         {
      ...
      {
         var _loc1_:Boolean = this.pvp.isMatchMaking();
         var _loc2_:Boolean = Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["host"]);
         if(_loc1_)
         {
            if(this.btn_close)
            {
         ...
         if(Boolean(this.roomInfoMC.btn_start) && _loc2_)
         {
            this.eventHandler.addListener(this.roomInfoMC.btn_start,MouseEvent.CLICK,this.startMatch);
         }
         if(Boolean(this.roomInfoMC.btn_ready) && !_loc2_)
         {
            this.eventHandler.addListener(this.roomInfoMC.btn_ready,MouseEvent.CLICK,this.sendReady);
         }
         if(Boolean(_loc2_) && Boolean(this.teamB_0) && Boolean(this.teamB_0.userInfoMc) && Boolean(this.teamB_0.userInfoMc.btn_kick))
         {
      ...
      private function setupChat() : void
      {
         ...
         if(this.roomInfoMC.hasOwnProperty("chatBoxMc") && Boolean(this.roomInfoMC.chatBoxMc))
         {
            _loc1_ = this.roomInfoMC.chatBoxMc;
            if(Boolean(_loc1_.hasOwnProperty("chatInputMc")) || Boolean(_loc1_.hasOwnProperty("chatInputTxt")))
            {
      ...
      {
         if(Boolean(this.pvp.isMatchMaking()) && this.autoStartCount > 0)
         {
            this.clearAutoStart();
      ...
      private function setupRoomAsHost() : void
      {
         ...
         if(Boolean(_loc3_.userInfoMc) && Boolean(_loc3_.userInfoMc.hasOwnProperty("btn_kick")))
         {
            _loc3_.userInfoMc.btn_kick.visible = false;
         }
         if(!Character.is_stickman && _loc3_.hasOwnProperty("char_mc"))
         {
            _loc5_ = Boolean(_loc2_.character) && Boolean(_loc2_.character.character_sets) ? _loc2_.character.character_sets.hair_color : "";
            _loc6_ = Boolean(_loc2_.character) && Boolean(_loc2_.character.character_sets) ? _loc2_.character.character_sets.skin_color : "";
            _loc7_ = new OutfitManager(false);
            _loc7_.fillOutfit(_loc3_.char_mc,_loc2_.getWeapon(),_loc2_.getBackItem(),_loc2_.getClothing(),_loc2_.getHair(),_loc2_.getFace(),_loc5_,_loc6_);
         ...
         if(this.teamB_0)
         {
            ...
            if(Boolean(this.teamB_0.userInfoMc) && Boolean(this.teamB_0.userInfoMc.hasOwnProperty("btn_kick")))
            {
      ...
      private function setElementDisplay(param1:MovieClip, param2:*) : void
      {
         ...
         {
            _loc4_ = param2.getElementType(3);
            if(_loc4_ > 0)
            {
      ...
      public function loadBackground() : void
      {
         ...
         var _loc1_:Object = this.pvp.roomInfo;
         var _loc2_:* = "stage" in _loc1_ && _loc1_.stage != null ? _loc1_["stage"] : (Boolean(this.pvp.missionIDs) && this.pvp.missionIDs.length > 0 ? this.pvp.missionIDs[0] : null);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onBackgroundLoaded(param1:*) : void
      {
         ...
         var _loc4_:* = "stage" in _loc3_ && _loc3_.stage != null ? _loc3_["stage"] : (Boolean(this.pvp.missionIDs) && this.pvp.missionIDs.length > 0 ? this.pvp.missionIDs[0] : null);
         if(!_loc4_)
         {
            return;
         }
         var _loc5_:* = this.pvp.loaderSwf.get(_loc4_);
         if(_loc5_)
         {
            _loc5_.removeEventListener(Event.COMPLETE,this.onBackgroundLoaded);
            _loc6_ = _loc5_.content["BattleBG"];
            if((Boolean(_loc6_)) && Boolean(this.bgHolder))
            {
               _loc6_.scaleX = 1;
               _loc6_.scaleY = 1;
               _loc6_.width += 100;
      ...
      private function onGetEnemyInfo(param1:Object) : void
      {
         ...
         if(this.teamB_0.hasOwnProperty("char_mc"))
         {
            ...
            if(!Character.is_stickman && Boolean(_loc4_))
            {
               _loc6_ = new OutfitManager(false);
               _loc6_.fillOutfit(this.teamB_0.char_mc,_loc4_.weapon,_loc4_.back_item,_loc4_.clothing,_loc4_.hairstyle,_loc4_.face,_loc4_.hair_color,_loc4_.skin_color);
      ...
      public function setupRoomAsEnemy() : void
      {
         ...
         if(Boolean(this.pvp.character) && Boolean(this.teamB_0))
         {
            ...
            {
               _loc4_ = Boolean(_loc2_.character) && Boolean(_loc2_.character.character_sets) ? _loc2_.character.character_sets.hair_color : "";
               _loc5_ = Boolean(_loc2_.character) && Boolean(_loc2_.character.character_sets) ? _loc2_.character.character_sets.skin_color : "";
               _loc6_ = new OutfitManager(false);
               _loc6_.fillOutfit(this.teamB_0.char_mc,_loc2_.getWeapon(),_loc2_.getBackItem(),_loc2_.getClothing(),_loc2_.getHair(),_loc2_.getFace(),_loc4_,_loc5_);
               this.outfits.push(_loc6_);
            }
            if(this.teamB_0.hasOwnProperty("char_mc"))
            {
         ...
         if(Boolean(this.teamB_0.userInfoMc) && Boolean(this.teamB_0.userInfoMc.btn_kick))
         {
      ...
      private function onGetHostInfo(param1:Object) : void
      {
         ...
         if(Boolean(!Character.is_stickman) && Boolean(_loc4_) && this.teamA_0.hasOwnProperty("char_mc"))
         {
            _loc6_ = new OutfitManager(false);
            _loc6_.fillOutfit(this.teamA_0.char_mc,_loc4_.weapon,_loc4_.back_item,_loc4_.clothing,_loc4_.hairstyle,_loc4_.face,_loc4_.hair_color,_loc4_.skin_color);
            this.outfits.push(_loc6_);
         }
      ...
      private function setElementDisplayFromData(param1:MovieClip, param2:Object) : void
      {
         ...
         if(param1.hasOwnProperty("element_3"))
         {
            _loc4_ = param2.character_element_3;
            if(_loc4_ > 0)
            {
               param1.element_3.gotoAndStop(_loc4_);
               param1.element_3.visible = true;
      ...
      public function enemyReady(param1:* = null) : void
      {
         ...
         if(Boolean(this.teamB_0) && this.teamB_0.hasOwnProperty("readyTxt"))
         {
            this.teamB_0.readyTxt.text = "Ready!";
         }
         if(Boolean(this.pvp.roomInfo && this.pvp.roomInfo["host"]) && Boolean(!_loc2_) && Boolean(this.roomInfoMC.btn_start))
         {
      ...
      public function clearEnemyUI(param1:Boolean = false) : void
      {
         ...
         if(Boolean(this.pvp) && Boolean(this.pvp.roomInfo) && !this.pvp.roomInfo["host"])
         {
            if(param1)
            {
               this.exitRoom();
      ...
      {
         if(Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["room_id"]) && Boolean(param1.target.metaData.id))
         {
      ...
      {
         if(Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["room_id"]) && Boolean(this.pvp.character))
         {
      ...
      {
         if(Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["room_id"]))
         {
      ...
      private function checkAutoStart() : void
      {
         ...
         if(this.visible && this.autoStartCount <= 0)
         {
            ...
            _loc2_ = Boolean(this.pvp.roomInfo) && Boolean(this.pvp.roomInfo["host"]);
            if(_loc2_)
            {
               if(this.roomInfoMC.hasOwnProperty("startCountdown"))
               {
         ...
         else
         {
            ...
            if(Boolean(this.skillSelection) && Boolean(this.skillSelection.hasOwnProperty("txt_timer")))
            {
      ...
      private function stopAllEffects(param1:*) : void
      {
         ...
         if(Boolean(param1.hasOwnProperty("head")) && Boolean(param1.head.hasOwnProperty("hair")))
         {
      ...
      private function closePanel(param1:MouseEvent) : void
      {
         ...
         this.deactivate();
         this.exitRoom();
         if(this.roomInfoMC.hasOwnProperty("chatBoxMc") && Boolean(this.roomInfoMC.chatBoxMc.hasOwnProperty("pvp_room_chat_outputMC")))
         {
      ...
      public function deactivate() : void
      {
         ...
         if(!this.destroyed)
         {
            ...
            for each(_loc2_ in _loc1_)
            {
               ...
               {
                  _loc3_ = this[_loc2_];
                  if(Boolean(_loc3_) && Boolean(_loc3_.hasOwnProperty("char_mc")))
                  {
         ...
         {
            _loc4_ = this.roomInfoMC.chatBoxMc;
            if(_loc4_.hasOwnProperty("chatInputMc"))
            {
         ...
         this.clearAutoStart();
         this.autoStartCount = this.autoStartTime;
         if(Boolean(this.outfits) && this.outfits.length > 0)
         {
      ...
      public function destroy() : void
      {
         ...
         this.destroyed = true;
         if(Boolean(this.teamA_0) && this.teamA_0.hasOwnProperty("char_mc"))
         {
            GF.removeAllChild(this.teamA_0.char_mc);
         }
         if(Boolean(this.teamB_0) && this.teamB_0.hasOwnProperty("char_mc"))
         {
