package id.ninjasage.pvp
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol8773")]
   public class CreateRoom extends MovieClip
   {
      ...
      public function createRoom(param1:MouseEvent) : *
      {
         ...
         var _loc3_:String = Boolean(_loc2_) && _loc2_.toLowerCase().indexOf("rank") >= 0 ? "ranked" : "casual";
         var _loc4_:String = this.password.text;
         var _loc5_:* = (Boolean(_loc4_)) && _loc4_.length > 0 ? _loc4_ : "";
