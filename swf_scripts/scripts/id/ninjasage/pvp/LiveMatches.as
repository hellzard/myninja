package id.ninjasage.pvp
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol8688")]
   public dynamic class LiveMatches extends MovieClip
   {
      ...
      public function destroy() : void
      {
         ...
         if(this.eventHandler)
         {
            ...
            while(_loc1_ < 4)
            {
               if(Boolean(this["matchMC" + _loc1_]) && Boolean(this["matchMC" + _loc1_].hasOwnProperty("btn_watch")))
               {
      ...
      public function initUI() : *
      {
         ...
         {
            _loc2_ = this["matchMC" + _loc1_];
            if(Boolean(_loc2_) && Boolean(_loc2_.hasOwnProperty("btn_watch")))
            {
         ...
         while(_loc1_ < 4)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.visible = false;
               if(Boolean(this.matches) && this.matches.length > _loc3_)
               {
                  _loc4_ = this.matches[_loc3_];
                  if(_loc4_)
                  {
                     _loc2_.visible = true;
                     ...
                     if(Boolean(_loc4_.players) && _loc4_.players.length > 0)
                     {
                     ...
                     if(Boolean(_loc4_.players) && _loc4_.players.length > 1)
                     {
      ...
      public function closePanel(param1:MouseEvent = null) : *
      {
         ...
         while(_loc2_ < 4)
         {
            if(Boolean(this["matchMC" + _loc2_]) && Boolean(this["matchMC" + _loc2_].hasOwnProperty("btn_watch")))
            {
