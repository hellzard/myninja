package id.ninjasage.pvp
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol8873")]
   public class PvP extends MovieClip
   {
      ...
      public var missionIDs:Array = ["mission_1011","mission_1055","mission_1050","mission_1048","mission_1039","mission_1030"];
      ...
      private function initEscapeKey() : void
      {
         ...
         if(Boolean(this.chatBoxMc) && this.chatBoxMc.hasOwnProperty("bg_close"))
         {
      ...
      private function initStatsUI() : void
      {
         ...
         if(Boolean(this.response.data.hasOwnProperty("show_news")) && Boolean(this.response.data.show_news))
         {
      ...
      private function initButtons() : void
      {
         ...
         if(Boolean(this.chatBoxMc) && this.chatBoxMc.hasOwnProperty("clickmask"))
         {
      ...
      private function onSocketConnect() : void
      {
         ...
         if(Boolean(this.noticeMC) && this.noticeMC.visible)
         {
            this.closeNotice();
         }
         this.connectedState();
      ...
      public function getMissionIDs() : Array
      {
         ...
         return Boolean(_loc1_) && Boolean(_loc1_.hasOwnProperty("background")) ? _loc1_.background : this.missionIDs;
      }
      ...
      private function onSpectatorJoinError(param1:Object) : void
      {
         ...
         if(Boolean(param1) && param1.hasOwnProperty("message"))
         {
            _loc2_ = param1.message;
         }
         else if(Boolean(param1) && param1.hasOwnProperty("error"))
         {
            _loc2_ = param1.error;
         }
