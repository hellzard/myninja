package id.ninjasage.pvp
{
   ...
   public class PvPLobby
   {
      ...
      public static function formatLobbyMessage(param1:Object) : *
      {
         ...
         try
         {
            charName = Boolean(data) && Boolean(data.character) && Boolean(data.character.name) ? String(data.character.name) : "?";
            charId = Boolean(data) && Boolean(data.character) && data.character.id != null ? String(data.character.id) : "?";
            message = Boolean(data) && Boolean(data.message) ? String(data.message) : "";
      ...
      private function onCharacterInfo(param1:Object) : void
      {
         ...
         var _loc4_:CharacterManager = new CharacterManager(_loc2_.character);
         _loc4_.setModel(_loc3_);
         ...
         {
            _loc6_ = this.pvp.main.getPlayerHead();
            _loc6_.scaleX = 2;
            _loc6_.scaleY = 2;
            if(this.pvp.hasOwnProperty("headMc") && Boolean(this.pvp["headMc"].hasOwnProperty("headHolder")))
            {
