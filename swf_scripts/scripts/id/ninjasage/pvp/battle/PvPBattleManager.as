package id.ninjasage.pvp.battle
{
   ...
   public class PvPBattleManager
   {
      ...
      public static function init(param1:PvP, param2:String) : void
      {
         ...
         if(!_effectOverlay && Boolean(_battle))
         {
      ...
      public static function initiateBattle(param1:PvP, param2:Object) : void
      {
         ...
         if(!_isSpectator)
         {
            _loc4_ = param2.hostId || param2.host_char_id;
            if((Boolean(_loc4_)) && Boolean(param1.character))
            {
         ...
         {
            _isHost = false;
            _loc5_ = param2.hostId || param2.host_char_id;
            if((Boolean(_loc5_)) && Boolean(param1.character))
            {
      ...
      private static function setupTeams(param1:Object) : void
      {
         ...
         if(Boolean(param1.playerTeam) && param1.playerTeam is Array)
         {
         ...
         if(Boolean(param1.enemyTeam) && param1.enemyTeam is Array)
         {
      ...
      {
         return _battleVars ? _battleVars.elapsedMs : 0;
      }
      ...
      {
         return Boolean(_battleVars) && _battleVars.matchMode === "ranked";
      }
      ...
      public static function getCharacterManagerByID(param1:String) : CharacterManager
      {
         ...
         {
            _loc4_ = _loc3_[_loc5_] as CharacterManager;
            if((Boolean(_loc4_)) && _loc4_.getID() == _loc2_)
            {
               return _loc4_;
            }
            _loc5_++;
      ...
      public static function getPetManagerByID(param1:String) : PetManager
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            _loc4_ = _loc3_[_loc5_] as PetManager;
            if((Boolean(_loc4_)) && _loc4_.getID() == _loc2_)
            {
               return _loc4_;
            }
      ...
      {
         if(Boolean(_main) && Boolean(_main.hasOwnProperty("loading")))
         {
      ...
      public static function destroyBattle() : void
      {
         ...
         if(Boolean(_main) && Boolean(_main.loader.contains(_battle)))
         {
            try
            {
         ...
         if(Boolean(_pvp) && Boolean(_pvp.character) && _isSpectator)
         {
